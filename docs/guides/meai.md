...
The Vercel SDK provides integration with [Microsoft.Extensions.AI](https://learn.microsoft.com/en-us/dotnet/ai/microsoft-extensions-ai), enabling seamless interoperability with the unified .NET AI abstractions.

## Installation

```bash
dotnet add package Vercel
```
...
using var client = new VercelClient(
    apiKey: Environment.GetEnvironmentVariable("VERCEL_API_KEY")!);
