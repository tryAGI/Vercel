...
namespace Vercel
{
    ...
    public sealed partial class CreateProjectResponseLatestDeploymentOidcTokenClaims
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateProjectResponseLatestDeploymentOidcTokenClaims" /> class.
        /// </summary>
...
#endif
        public CreateProjectResponseLatestDeploymentOidcTokenClaims(
            string iss,
            string sub,
            string scope,
            string aud,
