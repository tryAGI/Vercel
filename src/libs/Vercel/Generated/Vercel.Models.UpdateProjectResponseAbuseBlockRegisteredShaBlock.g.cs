...
namespace Vercel
{
    ...
    public sealed partial class UpdateProjectResponseAbuseBlockRegisteredShaBlock
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateProjectResponseAbuseBlockRegisteredShaBlock" /> class.
        /// </summary>
...
#endif
        public UpdateProjectResponseAbuseBlockRegisteredShaBlock(
            string createdAt,
            string createdBy,
            string sha)
        {
