...
namespace Vercel
{
    ...
    public sealed partial class CreateSandboxesV4RequestNetworkPolicyVariant2AllowItem
    {
        ...
        public global::Vercel.CreateSandboxesV4RequestNetworkPolicyVariant2AllowItemMatch? Match { get; set; }

        /// <summary>
        ///
        /// </summary>
        [global::System.Text.Json.Serialization.JsonPropertyName("transform")]
        public global::System.Collections.Generic.IList<global::Vercel.CreateSandboxesV4RequestNetworkPolicyVariant2AllowItemTransformItem>? Transform { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateSandboxesV4RequestNetworkPolicyVariant2AllowItem" /> class.
        /// </summary>
        /// <param name="match">
        /// Optional L7 match. When provided, the injection rule only applies to requests that satisfy every specified dimension. When multiple injection rules target the same domain they are evaluated in order and the first match wins; a rule without `match` matches any request and shadows later rules for the same domain.
        /// </param>
