...
namespace Vercel
{
    public partial class MarketplaceClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_RotateInstallationCredentialSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_RotateInstallationCredentialSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_RotateInstallationCredentialSecurityRequirement0,
            };
        partial void PrepareRotateInstallationCredentialArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string integrationConfigurationId,
            global::Vercel.RotateInstallationCredentialRequest request);
        partial void PrepareRotateInstallationCredentialRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string integrationConfigurationId,
            global::Vercel.RotateInstallationCredentialRequest request);
        partial void ProcessRotateInstallationCredentialResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessRotateInstallationCredentialResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.RotateInstallationCredentialResponse> RotateInstallationCredentialAsync(
            string integrationConfigurationId,
        ...
        {
            var __response = await RotateInstallationCredentialAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.RotateInstallationCredentialResponse>> RotateInstallationCredentialAsResponseAsync(
            string integrationConfigurationId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareRotateInstallationCredentialArguments(
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_RotateInstallationCredentialSecurityRequirements,
                operationName: "RotateInstallationCredentialAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareRotateInstallationCredentialRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "RotateInstallationCredential",
                                methodName: "RotateInstallationCredentialAsync",
                                pathTemplate: "$\"/v1/installations/{integrationConfigurationId}/credentials/rotate\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessRotateInstallationCredentialResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessRotateInstallationCredentialResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vercel.RotateInstallationCredentialResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vercel.AutoSDKHttpResponse<global::Vercel.RotateInstallationCredentialResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vercel.RotateInstallationCredentialResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.RotateInstallationCredentialResponse> RotateInstallationCredentialAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Vercel.RotateInstallationCredentialRequest
            {
                ClientSecret = clientSecret,
                ClientId = clientId,
            };

            return await RotateInstallationCredentialAsync(
                integrationConfigurationId: integrationConfigurationId,
                request: __request,
                requestOptions: requestOptions,
