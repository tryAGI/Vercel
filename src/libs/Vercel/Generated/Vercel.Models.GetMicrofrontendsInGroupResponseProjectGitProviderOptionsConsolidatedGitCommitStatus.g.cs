...
namespace Vercel
{
    ...
    public sealed partial class GetMicrofrontendsInGroupResponseProjectGitProviderOptionsConsolidatedGitCommitStatus
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetMicrofrontendsInGroupResponseProjectGitProviderOptionsConsolidatedGitCommitStatus" /> class.
        /// </summary>
        /// <param name="enabled">
        /// Whether consolidated commit status is enabled.
        /// </param>
...
#endif
        public GetMicrofrontendsInGroupResponseProjectGitProviderOptionsConsolidatedGitCommitStatus(
            bool enabled,
