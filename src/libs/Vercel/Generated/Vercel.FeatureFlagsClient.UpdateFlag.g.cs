            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::Vercel.OneOf<global::Vercel.UpdateFlagResponse2, global::Vercel.Flag>.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::Vercel.OneOf<global::Vercel.UpdateFlagResponse2, global::Vercel.Flag>.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
