...
namespace Vercel
{
    ...
    public sealed partial class ListKmsIssuersResponseIssuerSigningKeyPublicKey
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ListKmsIssuersResponseIssuerSigningKeyPublicKey" /> class.
        /// </summary>
...
#endif
        public ListKmsIssuersResponseIssuerSigningKeyPublicKey(
            string? kty,
            string? kid,
            string? alg,
            string? use,
