...
namespace Vercel
{
    ...
    public sealed partial class GetRollingReleaseResponseRollingReleaseNextStage
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetRollingReleaseResponseRollingReleaseNextStage" /> class.
        /// </summary>
        /// <param name="index">
        /// The zero-based index of the stage<br/>
        /// Example: 0
...
#endif
        public GetRollingReleaseResponseRollingReleaseNextStage(
            double index,
            bool isFinalStage,
