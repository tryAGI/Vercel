...
namespace Vercel
{
    public partial class NetworkingClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_CreatePrivateLinkEndpointSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_CreatePrivateLinkEndpointSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_CreatePrivateLinkEndpointSecurityRequirement0,
            };
        partial void PrepareCreatePrivateLinkEndpointArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? teamId,
            ref string? slug,
            global::Vercel.CreatePrivateLinkEndpointRequest request);
        partial void PrepareCreatePrivateLinkEndpointRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? teamId,
            string? slug,
            global::Vercel.CreatePrivateLinkEndpointRequest request);
        partial void ProcessCreatePrivateLinkEndpointResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreatePrivateLinkEndpointResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.PrivateLinkEndpoint> CreatePrivateLinkEndpointAsync(
        ...
        {
            var __response = await CreatePrivateLinkEndpointAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.PrivateLinkEndpoint>> CreatePrivateLinkEndpointAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreatePrivateLinkEndpointArguments(
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreatePrivateLinkEndpointSecurityRequirements,
                operationName: "CreatePrivateLinkEndpointAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreatePrivateLinkEndpointRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "CreatePrivateLinkEndpointAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreatePrivateLinkEndpointResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreatePrivateLinkEndpointResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.PrivateLinkEndpoint> CreatePrivateLinkEndpointAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Vercel.CreatePrivateLinkEndpointRequest
            {
                ProjectId = projectId,
                Name = name,
            ...
            return await CreatePrivateLinkEndpointAsync(
                teamId: teamId,
                slug: slug,
                request: __request,
                requestOptions: requestOptions,
