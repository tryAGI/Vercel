...
namespace Vercel
{
    ...
    public sealed partial class CreateSandboxesV2RequestNetworkPolicyVariant2AllowItemMatchHeaderValue
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateSandboxesV2RequestNetworkPolicyVariant2AllowItemMatchHeaderValue" /> class.
        /// </summary>
        /// <param name="exact">
        /// Match the value exactly. Case-sensitive for paths, header values, and methods; case-insensitive for domains and header keys.
        /// </param>
...
#endif
        public CreateSandboxesV2RequestNetworkPolicyVariant2AllowItemMatchHeaderValue(
            string? exact,
            string? startsWith)
        {
            this.Exact = exact;
