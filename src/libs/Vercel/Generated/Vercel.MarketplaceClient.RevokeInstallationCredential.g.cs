...
namespace Vercel
{
    public partial class MarketplaceClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_RevokeInstallationCredentialSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_RevokeInstallationCredentialSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_RevokeInstallationCredentialSecurityRequirement0,
            };
        partial void PrepareRevokeInstallationCredentialArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string integrationConfigurationId,
            global::Vercel.RevokeInstallationCredentialRequest request);
        partial void PrepareRevokeInstallationCredentialRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string integrationConfigurationId,
            global::Vercel.RevokeInstallationCredentialRequest request);
        partial void ProcessRevokeInstallationCredentialResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessRevokeInstallationCredentialResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.RevokeInstallationCredentialResponse> RevokeInstallationCredentialAsync(
            string integrationConfigurationId,
        ...
        {
            var __response = await RevokeInstallationCredentialAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.RevokeInstallationCredentialResponse>> RevokeInstallationCredentialAsResponseAsync(
            string integrationConfigurationId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareRevokeInstallationCredentialArguments(
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_RevokeInstallationCredentialSecurityRequirements,
                operationName: "RevokeInstallationCredentialAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareRevokeInstallationCredentialRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "RevokeInstallationCredential",
                                methodName: "RevokeInstallationCredentialAsync",
                                pathTemplate: "$\"/v1/installations/{integrationConfigurationId}/credentials/revoke\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessRevokeInstallationCredentialResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessRevokeInstallationCredentialResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vercel.RevokeInstallationCredentialResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vercel.AutoSDKHttpResponse<global::Vercel.RevokeInstallationCredentialResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vercel.RevokeInstallationCredentialResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.RevokeInstallationCredentialResponse> RevokeInstallationCredentialAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Vercel.RevokeInstallationCredentialRequest
            {
                Token = token,
            ...
            return await RevokeInstallationCredentialAsync(
                integrationConfigurationId: integrationConfigurationId,
                request: __request,
                requestOptions: requestOptions,
