...
namespace Vercel
{
    ...
    public sealed partial class GetMicrofrontendsInGroupResponseProjectTargetsOidcTokenClaims
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetMicrofrontendsInGroupResponseProjectTargetsOidcTokenClaims" /> class.
        /// </summary>
...
#endif
        public GetMicrofrontendsInGroupResponseProjectTargetsOidcTokenClaims(
            string iss,
            string sub,
            string scope,
            string aud,
