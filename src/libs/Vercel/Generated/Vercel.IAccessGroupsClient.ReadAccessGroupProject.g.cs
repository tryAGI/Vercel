...
namespace Vercel
{
    public partial interface IAccessGroupsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.ReadAccessGroupProjectResponse>> ReadAccessGroupProjectAsResponseAsync(
            string accessGroupIdOrName,
            string projectId,
            string? teamId = default,
            string? slug = default,
