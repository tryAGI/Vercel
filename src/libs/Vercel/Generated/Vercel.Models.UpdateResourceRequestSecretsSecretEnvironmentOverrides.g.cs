...
namespace Vercel
{
    ...
    public sealed partial class UpdateResourceRequestSecretsSecretEnvironmentOverrides
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateResourceRequestSecretsSecretEnvironmentOverrides" /> class.
        /// </summary>
...
#endif
        public UpdateResourceRequestSecretsSecretEnvironmentOverrides(
            string? development,
            string? preview,
            string? production)
        {
