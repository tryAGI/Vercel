...
namespace Vercel
{
    public partial class ProjectRoutesClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_EditRouteSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_EditRouteSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_EditRouteSecurityRequirement0,
            };
        partial void PrepareEditRouteArguments(
        ...
        partial void PrepareEditRouteRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? slug,
            global::Vercel.EditRouteRequest request);
        partial void ProcessEditRouteResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessEditRouteResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.EditRouteResponse> EditRouteAsync(
            string projectId,
            string routeId,
        ...
        {
            var __response = await EditRouteAsResponseAsync(
                projectId: projectId,
                routeId: routeId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.EditRouteResponse>> EditRouteAsResponseAsync(
            string projectId,
            string routeId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_EditRouteSecurityRequirements,
                operationName: "EditRouteAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "EditRouteAsync",
                                pathTemplate: "$\"/v1/projects/{projectId}/routes/{routeId}\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessEditRouteResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vercel.EditRouteResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vercel.AutoSDKHttpResponse<global::Vercel.EditRouteResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vercel.EditRouteResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.EditRouteResponse> EditRouteAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Vercel.EditRouteRequest
            {
                Route = route,
                Restore = restore,
            };

            return await EditRouteAsync(
                projectId: projectId,
                routeId: routeId,
                teamId: teamId,
                slug: slug,
