...
namespace Vercel
{
    ...
    public sealed partial class GetProjectResponseCreatorVariant1ViaVariant1App
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetProjectResponseCreatorVariant1ViaVariant1App" /> class.
        /// </summary>
        /// <param name="id">
        /// The internal ID of the Vercel App backing this principal.
        /// </param>
...
#endif
        public GetProjectResponseCreatorVariant1ViaVariant1App(
            string id,
            string? clientId)
        {
