    ...
    public static class GetFirewallConfigResponseRuleVariant2ConditionGroupItemConditionTypeExtensions
    {
        ...
        public static string ToValueString(this GetFirewallConfigResponseRuleVariant2ConditionGroupItemConditionType value)
        {
            return value switch
            {
                ...
                GetFirewallConfigResponseRuleVariant2ConditionGroupItemConditionType.BotProtection => "bot_protection",
                GetFirewallConfigResponseRuleVariant2ConditionGroupItemConditionType.BotStatus => "bot_status",
                GetFirewallConfigResponseRuleVariant2ConditionGroupItemConditionType.Cookie => "cookie",
                GetFirewallConfigResponseRuleVariant2ConditionGroupItemConditionType.DomainEnvironment => "domain_environment",
                ...
                GetFirewallConfigResponseRuleVariant2ConditionGroupItemConditionType.Ruleset => "ruleset",
                ...
                GetFirewallConfigResponseRuleVariant2ConditionGroupItemConditionType.SharedCondition => "shared_condition",
                GetFirewallConfigResponseRuleVariant2ConditionGroupItemConditionType.TargetPath => "target_path",
                GetFirewallConfigResponseRuleVariant2ConditionGroupItemConditionType.TrafficSource => "traffic_source",
        ...
        public static GetFirewallConfigResponseRuleVariant2ConditionGroupItemConditionType? ToEnum(string value)
        {
            return value switch
            {
                ...
                "bot_protection" => GetFirewallConfigResponseRuleVariant2ConditionGroupItemConditionType.BotProtection,
                "bot_status" => GetFirewallConfigResponseRuleVariant2ConditionGroupItemConditionType.BotStatus,
                "cookie" => GetFirewallConfigResponseRuleVariant2ConditionGroupItemConditionType.Cookie,
                "domain_environment" => GetFirewallConfigResponseRuleVariant2ConditionGroupItemConditionType.DomainEnvironment,
                ...
                "ruleset" => GetFirewallConfigResponseRuleVariant2ConditionGroupItemConditionType.Ruleset,
                ...
                "shared_condition" => GetFirewallConfigResponseRuleVariant2ConditionGroupItemConditionType.SharedCondition,
                "target_path" => GetFirewallConfigResponseRuleVariant2ConditionGroupItemConditionType.TargetPath,
                "traffic_source" => GetFirewallConfigResponseRuleVariant2ConditionGroupItemConditionType.TrafficSource,
