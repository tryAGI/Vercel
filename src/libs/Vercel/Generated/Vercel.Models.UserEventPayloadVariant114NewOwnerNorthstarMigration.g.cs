...
namespace Vercel
{
    ...
    public sealed partial class UserEventPayloadVariant114NewOwnerNorthstarMigration
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UserEventPayloadVariant114NewOwnerNorthstarMigration" /> class.
        /// </summary>
        /// <param name="teamId">
        /// The ID of the team we created for this user.
        /// </param>
...
#endif
        public UserEventPayloadVariant114NewOwnerNorthstarMigration(
            string teamId,
            double projects,
            double stores,
