...
namespace Vercel
{
    ...
    public sealed partial class CreateSandboxRequestNetworkPolicyInjectionRuleMatchQueryStringItemValue
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateSandboxRequestNetworkPolicyInjectionRuleMatchQueryStringItemValue" /> class.
        /// </summary>
        /// <param name="exact">
        /// Match the value exactly. Case-sensitive for paths, header values, and methods; case-insensitive for domains and header keys.
        /// </param>
...
#endif
        public CreateSandboxRequestNetworkPolicyInjectionRuleMatchQueryStringItemValue(
            string? exact,
            string? startsWith)
        {
            this.Exact = exact;
