...
namespace Vercel
{
    public partial class DeploymentsClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_GetDeploymentFileContentsSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_GetDeploymentFileContentsSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_GetDeploymentFileContentsSecurityRequirement0,
            };
        partial void PrepareGetDeploymentFileContentsArguments(
            ...
            ref string? teamId,
            ref string? slug);
        partial void PrepareGetDeploymentFileContentsRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? teamId,
            string? slug);
        partial void ProcessGetDeploymentFileContentsResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task GetDeploymentFileContentsAsync(
            string id,
            string fileId,
            string? path = default,
        ...
        {
            await GetDeploymentFileContentsAsResponseAsync(
                id: id,
                fileId: fileId,
                path: path,
                teamId: teamId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse> GetDeploymentFileContentsAsResponseAsync(
            string id,
            string fileId,
            string? path = default,
            string? teamId = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetDeploymentFileContentsArguments(
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetDeploymentFileContentsSecurityRequirements,
                operationName: "GetDeploymentFileContentsAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetDeploymentFileContentsAsync",
                                pathTemplate: "$\"/v8/deployments/{id}/files/{fileId}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetDeploymentFileContentsResponse(
                    httpClient: HttpClient,
