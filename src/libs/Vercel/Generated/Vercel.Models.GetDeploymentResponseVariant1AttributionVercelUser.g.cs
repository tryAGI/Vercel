...
namespace Vercel
{
    ...
    public sealed partial class GetDeploymentResponseVariant1AttributionVercelUser
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetDeploymentResponseVariant1AttributionVercelUser" /> class.
        /// </summary>
        /// <param name="id">
        /// Vercel user ID
        /// </param>
...
#endif
        public GetDeploymentResponseVariant1AttributionVercelUser(
            string id,
            string username,
