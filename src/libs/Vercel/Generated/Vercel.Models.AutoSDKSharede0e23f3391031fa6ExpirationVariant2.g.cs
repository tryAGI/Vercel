...
namespace Vercel
{
    ...
    public sealed partial class AutoSDKSharede0e23f3391031fa6ExpirationVariant2
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AutoSDKSharede0e23f3391031fa6ExpirationVariant2" /> class.
        /// </summary>
        /// <param name="lockedAt">
        /// Unix ms timestamp when the project was locked.
        /// </param>
...
#endif
        public AutoSDKSharede0e23f3391031fa6ExpirationVariant2(
            double lockedAt,
            string lockedBy)
        {
