...
namespace Vercel
{
    ...
    public sealed partial class GetProjectsResponseVariant3ProjectExpirationVariant2
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetProjectsResponseVariant3ProjectExpirationVariant2" /> class.
        /// </summary>
        /// <param name="lockedAt">
        /// Unix ms timestamp when the project was locked.
        /// </param>
...
#endif
        public GetProjectsResponseVariant3ProjectExpirationVariant2(
            double lockedAt,
            string lockedBy)
        {
