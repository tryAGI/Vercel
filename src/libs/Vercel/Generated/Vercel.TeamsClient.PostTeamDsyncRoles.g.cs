...
namespace Vercel
{
    public partial class TeamsClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_PostTeamDsyncRolesSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_PostTeamDsyncRolesSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_PostTeamDsyncRolesSecurityRequirement0,
            };
        partial void PreparePostTeamDsyncRolesArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string teamId,
            ref string? slug,
            global::Vercel.PostTeamDsyncRolesRequest request);
        partial void PreparePostTeamDsyncRolesRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string teamId,
            string? slug,
            global::Vercel.PostTeamDsyncRolesRequest request);
        partial void ProcessPostTeamDsyncRolesResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPostTeamDsyncRolesResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.PostTeamDsyncRolesResponse> PostTeamDsyncRolesAsync(
            string teamId,
        ...
        {
            var __response = await PostTeamDsyncRolesAsResponseAsync(
                teamId: teamId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.PostTeamDsyncRolesResponse>> PostTeamDsyncRolesAsResponseAsync(
            string teamId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PreparePostTeamDsyncRolesArguments(
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_PostTeamDsyncRolesSecurityRequirements,
                operationName: "PostTeamDsyncRolesAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "PostTeamDsyncRolesAsync",
                                pathTemplate: "$\"/v1/teams/{teamId}/dsync-roles\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessPostTeamDsyncRolesResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPostTeamDsyncRolesResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vercel.PostTeamDsyncRolesResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vercel.AutoSDKHttpResponse<global::Vercel.PostTeamDsyncRolesResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vercel.PostTeamDsyncRolesResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.PostTeamDsyncRolesResponse> PostTeamDsyncRolesAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Vercel.PostTeamDsyncRolesRequest
            {
                Roles = roles,
            };

            return await PostTeamDsyncRolesAsync(
                teamId: teamId,
                slug: slug,
                request: __request,
                requestOptions: requestOptions,
