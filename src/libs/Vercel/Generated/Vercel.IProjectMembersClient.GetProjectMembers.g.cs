...
namespace Vercel
{
    public partial interface IProjectMembersClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.OneOf<object, global::Vercel.GetProjectMembersResponseVariant2>>> GetProjectMembersAsResponseAsync(
            string idOrName,
            int? limit = default,
            int? since = default,
            int? until = default,
