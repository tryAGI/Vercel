...
namespace Vercel
{
    ...
    public sealed partial class CreateSandboxesByNameForkRequestNetworkPolicyVariant1InjectionRuleMatchPath
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateSandboxesByNameForkRequestNetworkPolicyVariant1InjectionRuleMatchPath" /> class.
        /// </summary>
        /// <param name="exact">
        /// Match the value exactly. Case-sensitive for paths, header values, and methods; case-insensitive for domains and header keys.
        /// </param>
...
#endif
        public CreateSandboxesByNameForkRequestNetworkPolicyVariant1InjectionRuleMatchPath(
            string? exact,
            string? startsWith)
        {
            this.Exact = exact;
