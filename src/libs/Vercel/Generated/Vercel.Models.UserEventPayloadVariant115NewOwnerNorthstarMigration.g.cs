...
namespace Vercel
{
    ...
    public sealed partial class UserEventPayloadVariant115NewOwnerNorthstarMigration
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UserEventPayloadVariant115NewOwnerNorthstarMigration" /> class.
        /// </summary>
        /// <param name="teamId">
        /// The ID of the team we created for this user.
        /// </param>
...
#endif
        public UserEventPayloadVariant115NewOwnerNorthstarMigration(
            string teamId,
            double projects,
            double stores,
