...
namespace Vercel
{
    public partial class KmsClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_UpdateKmsIssuerSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_UpdateKmsIssuerSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_UpdateKmsIssuerSecurityRequirement0,
            };
        partial void PrepareUpdateKmsIssuerArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string issuerId,
            ref string? teamId,
            ref string? slug,
            global::Vercel.UpdateKmsIssuerRequest request);
        partial void PrepareUpdateKmsIssuerRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? slug,
            global::Vercel.UpdateKmsIssuerRequest request);
        partial void ProcessUpdateKmsIssuerResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUpdateKmsIssuerResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKShared02b3ab4a1bf599af> UpdateKmsIssuerAsync(
            string issuerId,
        ...
        {
            var __response = await UpdateKmsIssuerAsResponseAsync(
                issuerId: issuerId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.AutoSDKShared02b3ab4a1bf599af>> UpdateKmsIssuerAsResponseAsync(
            string issuerId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUpdateKmsIssuerArguments(
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UpdateKmsIssuerSecurityRequirements,
                operationName: "UpdateKmsIssuerAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "UpdateKmsIssuerAsync",
                                pathTemplate: "$\"/v1/kms/issuers/{issuerId}\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUpdateKmsIssuerResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUpdateKmsIssuerResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKShared02b3ab4a1bf599af> UpdateKmsIssuerAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Vercel.UpdateKmsIssuerRequest
            {
                Name = name,
                ClaimsSchema = claimsSchema,
            };

            return await UpdateKmsIssuerAsync(
                issuerId: issuerId,
                teamId: teamId,
                slug: slug,
                request: __request,
