...
namespace Vercel
{
    ...
    public sealed partial class GetProjectResponseAbuseBlockHistoryItemVariant1RegisteredShaBlock
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetProjectResponseAbuseBlockHistoryItemVariant1RegisteredShaBlock" /> class.
        /// </summary>
...
#endif
        public GetProjectResponseAbuseBlockHistoryItemVariant1RegisteredShaBlock(
            string createdAt,
            string createdBy,
            string sha)
        {
