...
namespace Vercel
{
    public partial class FeatureFlagsClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_CreateFlagSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_CreateFlagSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_CreateFlagSecurityRequirement0,
            };
        partial void PrepareCreateFlagArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string projectIdOrName,
            ref string? teamId,
            ref string? slug,
            global::Vercel.CreateFlagRequest request);
        partial void PrepareCreateFlagRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? slug,
            global::Vercel.CreateFlagRequest request);
        partial void ProcessCreateFlagResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateFlagResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateFlagSecurityRequirements,
                operationName: "CreateFlagAsync");
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateFlagResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::Vercel.CreateFlagResponse.FromJson(__content, JsonSerializerContext) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::Vercel.CreateFlagResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
