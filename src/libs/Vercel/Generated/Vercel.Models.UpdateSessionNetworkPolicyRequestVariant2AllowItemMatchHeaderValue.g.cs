...
namespace Vercel
{
    ...
    public sealed partial class UpdateSessionNetworkPolicyRequestVariant2AllowItemMatchHeaderValue
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateSessionNetworkPolicyRequestVariant2AllowItemMatchHeaderValue" /> class.
        /// </summary>
        /// <param name="exact">
        /// Match the value exactly. Case-sensitive for paths, header values, and methods; case-insensitive for domains and header keys.
        /// </param>
...
#endif
        public UpdateSessionNetworkPolicyRequestVariant2AllowItemMatchHeaderValue(
            string? exact,
            string? startsWith)
        {
            this.Exact = exact;
