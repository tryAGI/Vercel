...
namespace Vercel
{
    public partial class NetworkingClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_UpdatePrivateLinkEndpointSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_UpdatePrivateLinkEndpointSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_UpdatePrivateLinkEndpointSecurityRequirement0,
            };
        partial void PrepareUpdatePrivateLinkEndpointArguments(
        ...
        partial void PrepareUpdatePrivateLinkEndpointRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? slug,
            global::Vercel.UpdatePrivateLinkEndpointRequest request);
        partial void ProcessUpdatePrivateLinkEndpointResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUpdatePrivateLinkEndpointResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.PrivateLinkEndpoint> UpdatePrivateLinkEndpointAsync(
            string projectId,
            string endpointId,
        ...
        {
            var __response = await UpdatePrivateLinkEndpointAsResponseAsync(
                projectId: projectId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.PrivateLinkEndpoint>> UpdatePrivateLinkEndpointAsResponseAsync(
            string projectId,
            string endpointId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUpdatePrivateLinkEndpointArguments(
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UpdatePrivateLinkEndpointSecurityRequirements,
                operationName: "UpdatePrivateLinkEndpointAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareUpdatePrivateLinkEndpointRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "UpdatePrivateLinkEndpointAsync",
                                pathTemplate: "$\"/v1/networking/privatelink/endpoints/{endpointId}\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUpdatePrivateLinkEndpointResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUpdatePrivateLinkEndpointResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vercel.PrivateLinkEndpoint.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vercel.AutoSDKHttpResponse<global::Vercel.PrivateLinkEndpoint>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vercel.PrivateLinkEndpoint.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.PrivateLinkEndpoint> UpdatePrivateLinkEndpointAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Vercel.UpdatePrivateLinkEndpointRequest
            {
                Name = name,
                EnablePrivateDns = enablePrivateDns,
            };

            return await UpdatePrivateLinkEndpointAsync(
                projectId: projectId,
                endpointId: endpointId,
                teamId: teamId,
                slug: slug,
