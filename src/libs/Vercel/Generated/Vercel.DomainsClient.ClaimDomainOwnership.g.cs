...
namespace Vercel
{
    public partial class DomainsClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_ClaimDomainOwnershipSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_ClaimDomainOwnershipSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_ClaimDomainOwnershipSecurityRequirement0,
            };
        partial void PrepareClaimDomainOwnershipArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string domain,
            ref string? teamId,
            ref string? slug);
        partial void PrepareClaimDomainOwnershipRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string domain,
            string? teamId,
            string? slug);
        partial void ProcessClaimDomainOwnershipResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessClaimDomainOwnershipResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.ClaimDomainOwnershipResponse> ClaimDomainOwnershipAsync(
            string domain,
        ...
        {
            var __response = await ClaimDomainOwnershipAsResponseAsync(
                domain: domain,
                teamId: teamId,
                slug: slug,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.ClaimDomainOwnershipResponse>> ClaimDomainOwnershipAsResponseAsync(
            string domain,
            string? teamId = default,
            string? slug = default,
            global::Vercel.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareClaimDomainOwnershipArguments(
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ClaimDomainOwnershipSecurityRequirements,
                operationName: "ClaimDomainOwnershipAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareClaimDomainOwnershipRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "ClaimDomainOwnershipAsync",
                                pathTemplate: "$\"/v9/domains/{domain}/claim\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessClaimDomainOwnershipResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessClaimDomainOwnershipResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vercel.ClaimDomainOwnershipResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vercel.AutoSDKHttpResponse<global::Vercel.ClaimDomainOwnershipResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vercel.ClaimDomainOwnershipResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
