...
namespace Vercel
{
    public partial class TeamsClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_DeleteTeamSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_DeleteTeamSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_DeleteTeamSecurityRequirement0,
            };
        partial void PrepareDeleteTeamArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? newDefaultTeamId,
            ref string teamId,
            ref string? slug,
        ...
        partial void ProcessDeleteTeamResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.DeleteTeamResponse> DeleteTeamAsync(
            string teamId,
        ...
        {
            var __response = await DeleteTeamAsResponseAsync(
                teamId: teamId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.DeleteTeamResponse>> DeleteTeamAsResponseAsync(
            string teamId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareDeleteTeamArguments(
                ...
                newDefaultTeamId: ref newDefaultTeamId,
                teamId: ref teamId,
                slug: ref slug,
                request: request);
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            __pathBuilder
                                .AddOptionalParameter("newDefaultTeamId", newDefaultTeamId)
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessDeleteTeamResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vercel.DeleteTeamResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vercel.AutoSDKHttpResponse<global::Vercel.DeleteTeamResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vercel.DeleteTeamResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.DeleteTeamResponse> DeleteTeamAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Vercel.DeleteTeamRequest
            {
                Reasons = reasons,
            };

            return await DeleteTeamAsync(
                newDefaultTeamId: newDefaultTeamId,
                teamId: teamId,
                slug: slug,
                request: __request,
