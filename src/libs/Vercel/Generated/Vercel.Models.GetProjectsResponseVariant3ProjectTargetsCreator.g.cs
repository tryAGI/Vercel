...
namespace Vercel
{
    ...
    public sealed partial class GetProjectsResponseVariant3ProjectTargetsCreator
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetProjectsResponseVariant3ProjectTargetsCreator" /> class.
        /// </summary>
...
#endif
        public GetProjectsResponseVariant3ProjectTargetsCreator(
            string email,
            string uid,
            string username,
            string? githubLogin,
