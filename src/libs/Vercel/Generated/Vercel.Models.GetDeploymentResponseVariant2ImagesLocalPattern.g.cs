...
namespace Vercel
{
    ...
    public sealed partial class GetDeploymentResponseVariant2ImagesLocalPattern
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetDeploymentResponseVariant2ImagesLocalPattern" /> class.
        /// </summary>
        /// <param name="pathname">
        /// Can be literal or wildcard. Single `*` matches a single path segment. Double `**` matches any number of path segments.
        /// </param>
...
#endif
        public GetDeploymentResponseVariant2ImagesLocalPattern(
            string? pathname,
            string? search)
        {
