...
namespace Vercel
{
    ...
    public sealed partial class GetMicrofrontendsConfigResponseConfigApplicationsVariant2RoutingItem
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetMicrofrontendsConfigResponseConfigApplicationsVariant2RoutingItem" /> class.
        /// </summary>
        /// <param name="paths">
        /// A list of path expressions that are routed to this application. See https://vercel.com/docs/microfrontends/path-routing#supported-path-expressions.
        /// </param>
...
#endif
        public GetMicrofrontendsConfigResponseConfigApplicationsVariant2RoutingItem(
