...
namespace Vercel
{
    ...
    public sealed partial class CertsSourceGenerationContext : global::System.Text.Json.Serialization.JsonSerializerContext
    {
        ...
        ///
        /// </summary>
        public static CertsSourceGenerationContext Default { get; } = new(DefaultOptions);

        private CertsSourceGenerationContext(global::System.Text.Json.JsonSerializerOptions options)
            : base(options)
        {
        }
