...
namespace Vercel
{
    public partial class GlobalConfigClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_CreateEdgeConfigTokenSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_CreateEdgeConfigTokenSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_CreateEdgeConfigTokenSecurityRequirement0,
            };
        partial void PrepareCreateEdgeConfigTokenArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string edgeConfigId,
            ref string? teamId,
            ref string? slug,
            global::Vercel.CreateEdgeConfigTokenRequest request);
        partial void PrepareCreateEdgeConfigTokenRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? slug,
            global::Vercel.CreateEdgeConfigTokenRequest request);
        partial void ProcessCreateEdgeConfigTokenResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateEdgeConfigTokenResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Create a Global Config token<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.CreateEdgeConfigTokenResponse> CreateEdgeConfigTokenAsync(
            string edgeConfigId,
        ...
        {
            var __response = await CreateEdgeConfigTokenAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.CreateEdgeConfigTokenResponse>> CreateEdgeConfigTokenAsResponseAsync(
            string edgeConfigId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateEdgeConfigTokenArguments(
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateEdgeConfigTokenSecurityRequirements,
                operationName: "CreateEdgeConfigTokenAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Vercel.PathBuilder(
                                path: $"/v1/global-config/{edgeConfigId}/token",
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "CreateEdgeConfigTokenAsync",
                                pathTemplate: "$\"/v1/global-config/{edgeConfigId}/token\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateEdgeConfigTokenResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateEdgeConfigTokenResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vercel.CreateEdgeConfigTokenResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vercel.AutoSDKHttpResponse<global::Vercel.CreateEdgeConfigTokenResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vercel.CreateEdgeConfigTokenResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.CreateEdgeConfigTokenResponse> CreateEdgeConfigTokenAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Vercel.CreateEdgeConfigTokenRequest
            {
                Label = label,
            };

            return await CreateEdgeConfigTokenAsync(
                edgeConfigId: edgeConfigId,
                teamId: teamId,
                slug: slug,
                request: __request,
