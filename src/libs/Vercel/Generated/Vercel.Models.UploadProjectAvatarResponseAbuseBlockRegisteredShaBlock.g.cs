...
namespace Vercel
{
    ...
    public sealed partial class UploadProjectAvatarResponseAbuseBlockRegisteredShaBlock
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UploadProjectAvatarResponseAbuseBlockRegisteredShaBlock" /> class.
        /// </summary>
...
#endif
        public UploadProjectAvatarResponseAbuseBlockRegisteredShaBlock(
            string createdAt,
            string createdBy,
            string sha)
        {
