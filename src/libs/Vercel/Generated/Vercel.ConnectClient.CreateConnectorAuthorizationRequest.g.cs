...
namespace Vercel
{
    public partial class ConnectClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_CreateConnectorAuthorizationRequestSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_CreateConnectorAuthorizationRequestSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_CreateConnectorAuthorizationRequestSecurityRequirement0,
            };
        partial void PrepareCreateConnectorAuthorizationRequestArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string connector,
            global::Vercel.CreateConnectorAuthorizationRequestRequest request);
        partial void PrepareCreateConnectorAuthorizationRequestRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string connector,
            global::Vercel.CreateConnectorAuthorizationRequestRequest request);
        partial void ProcessCreateConnectorAuthorizationRequestResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateConnectorAuthorizationRequestResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await CreateConnectorAuthorizationRequestAsResponseAsync(
                connector: connector,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.CreateConnectorAuthorizationRequestResponse>> CreateConnectorAuthorizationRequestAsResponseAsync(
            string connector,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateConnectorAuthorizationRequestArguments(
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateConnectorAuthorizationRequestSecurityRequirements,
                operationName: "CreateConnectorAuthorizationRequestAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateConnectorAuthorizationRequestRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "CreateConnectorAuthorizationRequestAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateConnectorAuthorizationRequestResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateConnectorAuthorizationRequestResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vercel.CreateConnectorAuthorizationRequestResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vercel.AutoSDKHttpResponse<global::Vercel.CreateConnectorAuthorizationRequestResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vercel.CreateConnectorAuthorizationRequestResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.CreateConnectorAuthorizationRequestResponse> CreateConnectorAuthorizationRequestAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Vercel.CreateConnectorAuthorizationRequestRequest
            {
                Subject = subject,
            ...
            return await CreateConnectorAuthorizationRequestAsync(
                connector: connector,
                request: __request,
                requestOptions: requestOptions,
