...
namespace Vercel
{
    ...
    public static class UpdateProjectResponseFrameworkExtensions
    {
        ...
        public static string ToValueString(this UpdateProjectResponseFramework value)
        {
            return value switch
            {
                UpdateProjectResponseFramework.ActixWeb => "actix-web",
                UpdateProjectResponseFramework.Angular => "angular",
                UpdateProjectResponseFramework.Ash => "ash",
                UpdateProjectResponseFramework.Astro => "astro",
                UpdateProjectResponseFramework.Axum => "axum",
                UpdateProjectResponseFramework.Blitzjs => "blitzjs",
                UpdateProjectResponseFramework.Brunch => "brunch",
                UpdateProjectResponseFramework.Bun => "bun",
                UpdateProjectResponseFramework.Container => "container",
                ...
                UpdateProjectResponseFramework.Eve => "eve",
                UpdateProjectResponseFramework.Express => "express",
                UpdateProjectResponseFramework.FactoryEve => "factory-eve",
                ...
                UpdateProjectResponseFramework.Mastra => "mastra",
                ...
                UpdateProjectResponseFramework.TanstackStartLovable => "tanstack-start-lovable",
        ...
        public static UpdateProjectResponseFramework? ToEnum(string value)
        {
            return value switch
            {
                "actix-web" => UpdateProjectResponseFramework.ActixWeb,
                "angular" => UpdateProjectResponseFramework.Angular,
                "ash" => UpdateProjectResponseFramework.Ash,
                "astro" => UpdateProjectResponseFramework.Astro,
                "axum" => UpdateProjectResponseFramework.Axum,
                "blitzjs" => UpdateProjectResponseFramework.Blitzjs,
                "brunch" => UpdateProjectResponseFramework.Brunch,
                "bun" => UpdateProjectResponseFramework.Bun,
                "container" => UpdateProjectResponseFramework.Container,
                ...
                "eve" => UpdateProjectResponseFramework.Eve,
                "express" => UpdateProjectResponseFramework.Express,
                "factory-eve" => UpdateProjectResponseFramework.FactoryEve,
                ...
                "mastra" => UpdateProjectResponseFramework.Mastra,
                ...
                "tanstack-start-lovable" => UpdateProjectResponseFramework.TanstackStartLovable,
