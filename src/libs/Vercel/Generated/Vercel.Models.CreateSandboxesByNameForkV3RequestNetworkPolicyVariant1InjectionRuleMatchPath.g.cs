...
namespace Vercel
{
    ...
    public sealed partial class CreateSandboxesByNameForkV3RequestNetworkPolicyVariant1InjectionRuleMatchPath
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateSandboxesByNameForkV3RequestNetworkPolicyVariant1InjectionRuleMatchPath" /> class.
        /// </summary>
        /// <param name="exact">
        /// Match the value exactly. Case-sensitive for paths, header values, and methods; case-insensitive for domains and header keys.
        /// </param>
...
#endif
        public CreateSandboxesByNameForkV3RequestNetworkPolicyVariant1InjectionRuleMatchPath(
            string? exact,
            string? startsWith)
        {
            this.Exact = exact;
