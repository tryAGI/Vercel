...
namespace Vercel
{
    public partial class MarketplaceClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_SubmitInvoiceSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_SubmitInvoiceSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_SubmitInvoiceSecurityRequirement0,
            };
        partial void PrepareSubmitInvoiceArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string integrationConfigurationId,
            global::Vercel.SubmitInvoiceRequest request);
        partial void PrepareSubmitInvoiceRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string integrationConfigurationId,
            global::Vercel.SubmitInvoiceRequest request);
        partial void ProcessSubmitInvoiceResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessSubmitInvoiceResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.SubmitInvoiceResponse> SubmitInvoiceAsync(
            string integrationConfigurationId,
        ...
        {
            var __response = await SubmitInvoiceAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.SubmitInvoiceResponse>> SubmitInvoiceAsResponseAsync(
            string integrationConfigurationId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_SubmitInvoiceSecurityRequirements,
                operationName: "SubmitInvoiceAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "SubmitInvoiceAsync",
                                pathTemplate: "$\"/v1/installations/{integrationConfigurationId}/billing/invoices\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessSubmitInvoiceResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vercel.SubmitInvoiceResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vercel.AutoSDKHttpResponse<global::Vercel.SubmitInvoiceResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vercel.SubmitInvoiceResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.SubmitInvoiceResponse> SubmitInvoiceAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Vercel.SubmitInvoiceRequest
            {
            ...
            return await SubmitInvoiceAsync(
                integrationConfigurationId: integrationConfigurationId,
                request: __request,
                requestOptions: requestOptions,
