...
namespace Vercel
{
    ...
    public sealed partial class ApproveRollingReleaseStageResponseRollingReleaseNextStage
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ApproveRollingReleaseStageResponseRollingReleaseNextStage" /> class.
        /// </summary>
        /// <param name="index">
        /// The zero-based index of the stage<br/>
        /// Example: 0
...
#endif
        public ApproveRollingReleaseStageResponseRollingReleaseNextStage(
            double index,
            bool isFinalStage,
