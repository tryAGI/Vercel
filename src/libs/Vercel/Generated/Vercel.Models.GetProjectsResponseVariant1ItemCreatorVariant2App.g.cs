...
namespace Vercel
{
    ...
    public sealed partial class GetProjectsResponseVariant1ItemCreatorVariant2App
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetProjectsResponseVariant1ItemCreatorVariant2App" /> class.
        /// </summary>
        /// <param name="id">
        /// The internal ID of the Vercel App backing this principal.
        /// </param>
...
#endif
        public GetProjectsResponseVariant1ItemCreatorVariant2App(
            string id,
            string? clientId)
        {
