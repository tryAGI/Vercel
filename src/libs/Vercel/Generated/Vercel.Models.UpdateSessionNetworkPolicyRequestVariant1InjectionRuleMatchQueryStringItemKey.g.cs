...
namespace Vercel
{
    ...
    public sealed partial class UpdateSessionNetworkPolicyRequestVariant1InjectionRuleMatchQueryStringItemKey
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateSessionNetworkPolicyRequestVariant1InjectionRuleMatchQueryStringItemKey" /> class.
        /// </summary>
        /// <param name="exact">
        /// Match the value exactly. Case-sensitive for paths, header values, and methods; case-insensitive for domains and header keys.
        /// </param>
...
#endif
        public UpdateSessionNetworkPolicyRequestVariant1InjectionRuleMatchQueryStringItemKey(
            string? exact,
            string? startsWith)
        {
            this.Exact = exact;
