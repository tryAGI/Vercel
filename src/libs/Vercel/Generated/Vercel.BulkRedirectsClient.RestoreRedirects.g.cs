...
namespace Vercel
{
    public partial class BulkRedirectsClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_RestoreRedirectsSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_RestoreRedirectsSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_RestoreRedirectsSecurityRequirement0,
            };
        partial void PrepareRestoreRedirectsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string projectId,
            ref string? teamId,
            ref string? slug,
            global::Vercel.RestoreRedirectsRequest request);
        partial void PrepareRestoreRedirectsRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? slug,
            global::Vercel.RestoreRedirectsRequest request);
        partial void ProcessRestoreRedirectsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessRestoreRedirectsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.RestoreRedirectsResponse> RestoreRedirectsAsync(
            string projectId,
        ...
        {
            var __response = await RestoreRedirectsAsResponseAsync(
                projectId: projectId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.RestoreRedirectsResponse>> RestoreRedirectsAsResponseAsync(
            string projectId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareRestoreRedirectsArguments(
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_RestoreRedirectsSecurityRequirements,
                operationName: "RestoreRedirectsAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "RestoreRedirectsAsync",
                                pathTemplate: "\"/v1/bulk-redirects/restore\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessRestoreRedirectsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessRestoreRedirectsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vercel.RestoreRedirectsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vercel.AutoSDKHttpResponse<global::Vercel.RestoreRedirectsResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vercel.RestoreRedirectsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.RestoreRedirectsResponse> RestoreRedirectsAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Vercel.RestoreRedirectsRequest
            {
                Name = name,
                Redirects = redirects,
            };

            return await RestoreRedirectsAsync(
                projectId: projectId,
                teamId: teamId,
                slug: slug,
                request: __request,
