...
namespace Vercel
{
    ...
    public sealed partial class GetProjectsResponseVariant1ItemSecurityFirewallRouteMissingItemValue
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetProjectsResponseVariant1ItemSecurityFirewallRouteMissingItemValue" /> class.
        /// </summary>
        /// <param name="re"></param>
        /// <param name="eq"></param>
...
#endif
        public GetProjectsResponseVariant1ItemSecurityFirewallRouteMissingItemValue(
            string? re,
            string? eq,
            string? neq,
