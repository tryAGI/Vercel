...
namespace Vercel
{
    ...
    public sealed partial class UserEventPayloadVariant116NewOwnerAbuseHistoryItem
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UserEventPayloadVariant116NewOwnerAbuseHistoryItem" /> class.
        /// </summary>
...
#endif
        public UserEventPayloadVariant116NewOwnerAbuseHistoryItem(
            string scanner,
            string reason,
            string by,
            string byId,
