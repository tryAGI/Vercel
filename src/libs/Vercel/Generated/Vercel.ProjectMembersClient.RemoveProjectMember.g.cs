...
namespace Vercel
{
    public partial class ProjectMembersClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_RemoveProjectMemberSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_RemoveProjectMemberSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_RemoveProjectMemberSecurityRequirement0,
            };
        partial void PrepareRemoveProjectMemberArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string idOrName,
            ref string uid,
            ref string? teamId,
            ref string? slug);
        partial void PrepareRemoveProjectMemberRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? teamId,
            string? slug);
        partial void ProcessRemoveProjectMemberResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessRemoveProjectMemberResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.RemoveProjectMemberResponse> RemoveProjectMemberAsync(
            string idOrName,
            string uid,
        ...
        {
            var __response = await RemoveProjectMemberAsResponseAsync(
                idOrName: idOrName,
                uid: uid,
                teamId: teamId,
                slug: slug,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.RemoveProjectMemberResponse>> RemoveProjectMemberAsResponseAsync(
            string idOrName,
            string uid,
            string? teamId = default,
            string? slug = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareRemoveProjectMemberArguments(
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_RemoveProjectMemberSecurityRequirements,
                operationName: "RemoveProjectMemberAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "RemoveProjectMemberAsync",
                                pathTemplate: "$\"/v1/projects/{idOrName}/members/{uid}\"",
                                httpMethod: "DELETE",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessRemoveProjectMemberResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessRemoveProjectMemberResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vercel.RemoveProjectMemberResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vercel.AutoSDKHttpResponse<global::Vercel.RemoveProjectMemberResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vercel.RemoveProjectMemberResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
