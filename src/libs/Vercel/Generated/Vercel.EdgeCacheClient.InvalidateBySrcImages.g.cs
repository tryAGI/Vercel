...
namespace Vercel
{
    public partial class EdgeCacheClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_InvalidateBySrcImagesSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_InvalidateBySrcImagesSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_InvalidateBySrcImagesSecurityRequirement0,
            };
        partial void PrepareInvalidateBySrcImagesArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string projectIdOrName,
            ref string? teamId,
            ref string? slug,
            global::Vercel.InvalidateBySrcImagesRequest request);
        partial void PrepareInvalidateBySrcImagesRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? slug,
            global::Vercel.InvalidateBySrcImagesRequest request);
        partial void ProcessInvalidateBySrcImagesResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task InvalidateBySrcImagesAsync(
            string projectIdOrName,
        ...
        {
            await InvalidateBySrcImagesAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse> InvalidateBySrcImagesAsResponseAsync(
            string projectIdOrName,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareInvalidateBySrcImagesArguments(
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_InvalidateBySrcImagesSecurityRequirements,
                operationName: "InvalidateBySrcImagesAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareInvalidateBySrcImagesRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "InvalidateBySrcImagesAsync",
                                pathTemplate: "\"/v1/edge-cache/invalidate-by-src-images\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessInvalidateBySrcImagesResponse(
                    httpClient: HttpClient,
        ...
        public async global::System.Threading.Tasks.Task InvalidateBySrcImagesAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Vercel.InvalidateBySrcImagesRequest
            {
                SrcImages = srcImages,
            };

            await InvalidateBySrcImagesAsync(
                projectIdOrName: projectIdOrName,
                teamId: teamId,
                slug: slug,
                request: __request,
