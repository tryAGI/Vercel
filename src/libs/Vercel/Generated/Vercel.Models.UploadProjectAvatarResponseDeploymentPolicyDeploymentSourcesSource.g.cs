...
namespace Vercel
{
    ...
    /// </summary>
    public enum UploadProjectAvatarResponseDeploymentPolicyDeploymentSourcesSource
    {
        /// <summary>
    ...
    /// </summary>
    public static class UploadProjectAvatarResponseDeploymentPolicyDeploymentSourcesSourceExtensions
    {
        /// <summary>
        /// Converts an enum to a string.
        /// </summary>
        public static string ToValueString(this UploadProjectAvatarResponseDeploymentPolicyDeploymentSourcesSource value)
        {
            return value switch
            {
                UploadProjectAvatarResponseDeploymentPolicyDeploymentSourcesSource.Cli => "cli",
                UploadProjectAvatarResponseDeploymentPolicyDeploymentSourcesSource.DeployHook => "deploy-hook",
                UploadProjectAvatarResponseDeploymentPolicyDeploymentSourcesSource.Git => "git",
                UploadProjectAvatarResponseDeploymentPolicyDeploymentSourcesSource.Integration => "integration",
                UploadProjectAvatarResponseDeploymentPolicyDeploymentSourcesSource.RestApi => "rest-api",
        ...
        /// </summary>
        public static UploadProjectAvatarResponseDeploymentPolicyDeploymentSourcesSource? ToEnum(string value)
        {
            return value switch
            {
                "cli" => UploadProjectAvatarResponseDeploymentPolicyDeploymentSourcesSource.Cli,
                "deploy-hook" => UploadProjectAvatarResponseDeploymentPolicyDeploymentSourcesSource.DeployHook,
                "git" => UploadProjectAvatarResponseDeploymentPolicyDeploymentSourcesSource.Git,
                "integration" => UploadProjectAvatarResponseDeploymentPolicyDeploymentSourcesSource.Integration,
                "rest-api" => UploadProjectAvatarResponseDeploymentPolicyDeploymentSourcesSource.RestApi,
                _ => null,
            };
        }
    }
