...
namespace Vercel
{
    ...
    public sealed partial class CreateSandboxesRequestNetworkPolicyVariant1InjectionRuleMatchPath
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateSandboxesRequestNetworkPolicyVariant1InjectionRuleMatchPath" /> class.
        /// </summary>
        /// <param name="exact">
        /// Match the value exactly. Case-sensitive for paths, header values, and methods; case-insensitive for domains and header keys.
        /// </param>
...
#endif
        public CreateSandboxesRequestNetworkPolicyVariant1InjectionRuleMatchPath(
            string? exact,
            string? startsWith)
        {
            this.Exact = exact;
