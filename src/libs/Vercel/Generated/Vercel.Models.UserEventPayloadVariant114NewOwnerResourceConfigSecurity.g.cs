...
namespace Vercel
{
    ...
    public sealed partial class UserEventPayloadVariant114NewOwnerResourceConfigSecurity
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UserEventPayloadVariant114NewOwnerResourceConfigSecurity" /> class.
        /// </summary>
...
#endif
        public UserEventPayloadVariant114NewOwnerResourceConfigSecurity(
            double? customRules,
            double? ipBlocks,
            double? ipBypass,
            double? rateLimit)
