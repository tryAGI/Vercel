...
namespace Vercel
{
    public partial class SandboxesClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_ReadSessionFileSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_ReadSessionFileSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_ReadSessionFileSecurityRequirement0,
            };
        partial void PrepareReadSessionFileArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string sessionId,
            ref string? teamId,
            ref string? slug,
            global::Vercel.ReadSessionFileRequest request);
        partial void PrepareReadSessionFileRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? slug,
            global::Vercel.ReadSessionFileRequest request);
        partial void ProcessReadSessionFileResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessReadSessionFileResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref byte[] content);
        ...
        public async global::System.Threading.Tasks.Task<byte[]> ReadSessionFileAsync(
            string sessionId,
        ...
        {
            var __response = await ReadSessionFileAsResponseAsync(
                sessionId: sessionId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::System.IO.Stream> ReadSessionFileAsStreamAsync(
            string sessionId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareReadSessionFileArguments(
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ReadSessionFileSecurityRequirements,
                operationName: "ReadSessionFileAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "ReadSessionFileAsync",
                                pathTemplate: "$\"/v2/sandboxes/sessions/{sessionId}/fs/read\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessReadSessionFileResponse(
                    httpClient: HttpClient,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<byte[]>> ReadSessionFileAsResponseAsync(
            string sessionId,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessReadSessionFileResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
        ...
        public async global::System.Threading.Tasks.Task<byte[]> ReadSessionFileAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Vercel.ReadSessionFileRequest
            {
                Cwd = cwd,
                Path = path,
            };

            return await ReadSessionFileAsync(
                sessionId: sessionId,
                teamId: teamId,
                slug: slug,
                request: __request,
