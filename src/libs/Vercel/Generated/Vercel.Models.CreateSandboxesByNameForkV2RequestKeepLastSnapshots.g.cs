...
namespace Vercel
{
    ...
    public sealed partial class CreateSandboxesByNameForkV2RequestKeepLastSnapshots
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateSandboxesByNameForkV2RequestKeepLastSnapshots" /> class.
        /// </summary>
        /// <param name="count">
        /// Number of most recent snapshots to keep.
        /// </param>
...
#endif
        public CreateSandboxesByNameForkV2RequestKeepLastSnapshots(
            int count,
