...
namespace Vercel
{
    public partial class GlobalConfigClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_RestoreEdgeConfigBackupSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_RestoreEdgeConfigBackupSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_RestoreEdgeConfigBackupSecurityRequirement0,
            };
        partial void PrepareRestoreEdgeConfigBackupArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string edgeConfigId,
            ref string edgeConfigBackupVersionId,
            ref string? teamId,
            ref string? slug);
        partial void PrepareRestoreEdgeConfigBackupRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? teamId,
            string? slug);
        partial void ProcessRestoreEdgeConfigBackupResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessRestoreEdgeConfigBackupResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Restore Global Config backup<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.RestoreEdgeConfigBackupResponse> RestoreEdgeConfigBackupAsync(
            string edgeConfigId,
            string edgeConfigBackupVersionId,
        ...
        {
            var __response = await RestoreEdgeConfigBackupAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.RestoreEdgeConfigBackupResponse>> RestoreEdgeConfigBackupAsResponseAsync(
            string edgeConfigId,
            string edgeConfigBackupVersionId,
            string? teamId = default,
            string? slug = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareRestoreEdgeConfigBackupArguments(
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_RestoreEdgeConfigBackupSecurityRequirements,
                operationName: "RestoreEdgeConfigBackupAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Vercel.PathBuilder(
                                path: $"/v1/global-config/{edgeConfigId}/backups/{edgeConfigBackupVersionId}/restore",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareRestoreEdgeConfigBackupRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "RestoreEdgeConfigBackupAsync",
                                pathTemplate: "$\"/v1/global-config/{edgeConfigId}/backups/{edgeConfigBackupVersionId}/restore\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessRestoreEdgeConfigBackupResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessRestoreEdgeConfigBackupResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vercel.RestoreEdgeConfigBackupResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vercel.AutoSDKHttpResponse<global::Vercel.RestoreEdgeConfigBackupResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vercel.RestoreEdgeConfigBackupResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
