...
namespace Vercel
{
    ...
    public sealed partial class UpdateResourceSecretsRequestSecretEnvironmentOverrides
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateResourceSecretsRequestSecretEnvironmentOverrides" /> class.
        /// </summary>
...
#endif
        public UpdateResourceSecretsRequestSecretEnvironmentOverrides(
            string? development,
            string? preview,
            string? production)
        {
