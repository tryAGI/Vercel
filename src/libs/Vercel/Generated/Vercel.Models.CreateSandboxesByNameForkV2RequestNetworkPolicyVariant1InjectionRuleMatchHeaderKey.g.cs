...
namespace Vercel
{
    ...
    public sealed partial class CreateSandboxesByNameForkV2RequestNetworkPolicyVariant1InjectionRuleMatchHeaderKey
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateSandboxesByNameForkV2RequestNetworkPolicyVariant1InjectionRuleMatchHeaderKey" /> class.
        /// </summary>
        /// <param name="exact">
        /// Match the value exactly. Case-sensitive for paths, header values, and methods; case-insensitive for domains and header keys.
        /// </param>
...
#endif
        public CreateSandboxesByNameForkV2RequestNetworkPolicyVariant1InjectionRuleMatchHeaderKey(
            string? exact,
            string? startsWith)
        {
            this.Exact = exact;
