    ...
    public static class GetFirewallConfigResponseRuleVariant1ConditionGroupItemConditionTypeExtensions
    {
        ...
        public static string ToValueString(this GetFirewallConfigResponseRuleVariant1ConditionGroupItemConditionType value)
        {
            return value switch
            {
                ...
                GetFirewallConfigResponseRuleVariant1ConditionGroupItemConditionType.BotProtection => "bot_protection",
                GetFirewallConfigResponseRuleVariant1ConditionGroupItemConditionType.BotStatus => "bot_status",
                GetFirewallConfigResponseRuleVariant1ConditionGroupItemConditionType.Cookie => "cookie",
                GetFirewallConfigResponseRuleVariant1ConditionGroupItemConditionType.DomainEnvironment => "domain_environment",
                ...
                GetFirewallConfigResponseRuleVariant1ConditionGroupItemConditionType.Ruleset => "ruleset",
                ...
                GetFirewallConfigResponseRuleVariant1ConditionGroupItemConditionType.SharedCondition => "shared_condition",
                GetFirewallConfigResponseRuleVariant1ConditionGroupItemConditionType.TargetPath => "target_path",
                GetFirewallConfigResponseRuleVariant1ConditionGroupItemConditionType.TrafficSource => "traffic_source",
                GetFirewallConfigResponseRuleVariant1ConditionGroupItemConditionType.TrustedSource => "trusted_source",
        ...
        public static GetFirewallConfigResponseRuleVariant1ConditionGroupItemConditionType? ToEnum(string value)
        {
            return value switch
            {
                ...
                "bot_protection" => GetFirewallConfigResponseRuleVariant1ConditionGroupItemConditionType.BotProtection,
                "bot_status" => GetFirewallConfigResponseRuleVariant1ConditionGroupItemConditionType.BotStatus,
                "cookie" => GetFirewallConfigResponseRuleVariant1ConditionGroupItemConditionType.Cookie,
                "domain_environment" => GetFirewallConfigResponseRuleVariant1ConditionGroupItemConditionType.DomainEnvironment,
                ...
                "ruleset" => GetFirewallConfigResponseRuleVariant1ConditionGroupItemConditionType.Ruleset,
                ...
                "shared_condition" => GetFirewallConfigResponseRuleVariant1ConditionGroupItemConditionType.SharedCondition,
                "target_path" => GetFirewallConfigResponseRuleVariant1ConditionGroupItemConditionType.TargetPath,
                "traffic_source" => GetFirewallConfigResponseRuleVariant1ConditionGroupItemConditionType.TrafficSource,
                "trusted_source" => GetFirewallConfigResponseRuleVariant1ConditionGroupItemConditionType.TrustedSource,
