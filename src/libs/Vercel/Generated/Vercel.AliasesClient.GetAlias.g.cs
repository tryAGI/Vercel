...
namespace Vercel
{
    public partial class AliasesClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_GetAliasSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_GetAliasSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_GetAliasSecurityRequirement0,
            };
        partial void PrepareGetAliasArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref double? from,
            ref string idOrAlias,
            ref string? projectId,
            ref double? since,
            ref double? until,
            ref string? teamId,
            ref string? slug);
        partial void PrepareGetAliasRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? teamId,
            string? slug);
        partial void ProcessGetAliasResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetAliasResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.GetAliasResponse> GetAliasAsync(
            string idOrAlias,
            double? from = default,
        ...
        {
            var __response = await GetAliasAsResponseAsync(
                idOrAlias: idOrAlias,
                from: from,
                projectId: projectId,
                since: since,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.GetAliasResponse>> GetAliasAsResponseAsync(
            string idOrAlias,
            double? from = default,
            string? projectId = default,
            double? since = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetAliasArguments(
                httpClient: HttpClient,
                from: ref from,
                idOrAlias: ref idOrAlias,
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetAliasSecurityRequirements,
                operationName: "GetAliasAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetAliasAsync",
                                pathTemplate: "$\"/v4/aliases/{idOrAlias}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetAliasResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vercel.GetAliasResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vercel.AutoSDKHttpResponse<global::Vercel.GetAliasResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vercel.GetAliasResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
