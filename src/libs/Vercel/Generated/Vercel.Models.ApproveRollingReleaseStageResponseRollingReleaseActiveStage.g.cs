...
namespace Vercel
{
    ...
    public sealed partial class ApproveRollingReleaseStageResponseRollingReleaseActiveStage
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ApproveRollingReleaseStageResponseRollingReleaseActiveStage" /> class.
        /// </summary>
        /// <param name="index">
        /// The zero-based index of the stage<br/>
        /// Example: 0
...
#endif
        public ApproveRollingReleaseStageResponseRollingReleaseActiveStage(
            double index,
            bool isFinalStage,
