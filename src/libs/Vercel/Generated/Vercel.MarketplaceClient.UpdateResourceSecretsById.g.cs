...
namespace Vercel
{
    public partial class MarketplaceClient
    {
        ...
        partial void PrepareUpdateResourceSecretsByIdRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string integrationConfigurationId,
            string resourceId,
            global::Vercel.UpdateResourceSecretsByIdRequest request);
        partial void ProcessUpdateResourceSecretsByIdResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task UpdateResourceSecretsByIdAsync(
            string integrationConfigurationId,
            string resourceId,
        ...
        {
            await UpdateResourceSecretsByIdAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse> UpdateResourceSecretsByIdAsResponseAsync(
            string integrationConfigurationId,
            string resourceId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUpdateResourceSecretsByIdArguments(
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "UpdateResourceSecretsById",
                                methodName: "UpdateResourceSecretsByIdAsync",
                                pathTemplate: "$\"/v1/installations/{integrationConfigurationId}/resources/{resourceId}/secrets\"",
                                httpMethod: "PUT",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUpdateResourceSecretsByIdResponse(
                    httpClient: HttpClient,
        ...
        public async global::System.Threading.Tasks.Task UpdateResourceSecretsByIdAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Vercel.UpdateResourceSecretsByIdRequest
            {
                Secrets = secrets,
                Partial = partial,
            };

            await UpdateResourceSecretsByIdAsync(
                integrationConfigurationId: integrationConfigurationId,
                resourceId: resourceId,
                request: __request,
                requestOptions: requestOptions,
