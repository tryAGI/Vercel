...
namespace Vercel
{
    ...
    public sealed partial class AutoSDKShared061b01d29a72e8d7ExpirationVariant2
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AutoSDKShared061b01d29a72e8d7ExpirationVariant2" /> class.
        /// </summary>
        /// <param name="lockedAt">
        /// Unix ms timestamp when the project was locked.
        /// </param>
...
#endif
        public AutoSDKShared061b01d29a72e8d7ExpirationVariant2(
            double lockedAt,
            string lockedBy)
        {
