...
namespace Vercel
{
    ...
    public sealed partial class UpdateSessionNetworkPolicyRequestVariant1InjectionRuleMatchHeaderValue
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateSessionNetworkPolicyRequestVariant1InjectionRuleMatchHeaderValue" /> class.
        /// </summary>
        /// <param name="exact">
        /// Match the value exactly. Case-sensitive for paths, header values, and methods; case-insensitive for domains and header keys.
        /// </param>
...
#endif
        public UpdateSessionNetworkPolicyRequestVariant1InjectionRuleMatchHeaderValue(
            string? exact,
            string? startsWith)
        {
            this.Exact = exact;
