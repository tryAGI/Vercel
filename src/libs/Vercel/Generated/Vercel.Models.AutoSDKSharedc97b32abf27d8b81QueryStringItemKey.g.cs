...
namespace Vercel
{
    ...
    public sealed partial class AutoSDKSharedc97b32abf27d8b81QueryStringItemKey
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AutoSDKSharedc97b32abf27d8b81QueryStringItemKey" /> class.
        /// </summary>
        /// <param name="exact">
        /// Match the value exactly. Case-sensitive for paths, header values, and methods; case-insensitive for domains and header keys.
        /// </param>
...
#endif
        public AutoSDKSharedc97b32abf27d8b81QueryStringItemKey(
            string? exact,
            string? startsWith)
        {
            this.Exact = exact;
