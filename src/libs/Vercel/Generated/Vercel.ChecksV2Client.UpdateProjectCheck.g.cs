...
namespace Vercel
{
    public partial class ChecksV2Client
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_UpdateProjectCheckSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_UpdateProjectCheckSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_UpdateProjectCheckSecurityRequirement0,
            };
        partial void PrepareUpdateProjectCheckArguments(
        ...
        partial void PrepareUpdateProjectCheckRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? slug,
            global::Vercel.UpdateProjectCheckRequest request);
        partial void ProcessUpdateProjectCheckResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUpdateProjectCheckResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.UpdateProjectCheckResponse> UpdateProjectCheckAsync(
            string projectIdOrName,
            string checkId,
        ...
        {
            var __response = await UpdateProjectCheckAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.UpdateProjectCheckResponse>> UpdateProjectCheckAsResponseAsync(
            string projectIdOrName,
            string checkId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUpdateProjectCheckArguments(
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UpdateProjectCheckSecurityRequirements,
                operationName: "UpdateProjectCheckAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareUpdateProjectCheckRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "UpdateProjectCheckAsync",
                                pathTemplate: "$\"/v2/projects/{projectIdOrName}/checks/{checkId}\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUpdateProjectCheckResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUpdateProjectCheckResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vercel.UpdateProjectCheckResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vercel.AutoSDKHttpResponse<global::Vercel.UpdateProjectCheckResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vercel.UpdateProjectCheckResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.UpdateProjectCheckResponse> UpdateProjectCheckAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Vercel.UpdateProjectCheckRequest
            {
                Name = name,
            ...
            return await UpdateProjectCheckAsync(
                projectIdOrName: projectIdOrName,
                checkId: checkId,
                teamId: teamId,
                slug: slug,
