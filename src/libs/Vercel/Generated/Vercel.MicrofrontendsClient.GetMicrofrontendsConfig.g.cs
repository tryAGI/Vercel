...
namespace Vercel
{
    public partial class MicrofrontendsClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_GetMicrofrontendsConfigSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_GetMicrofrontendsConfigSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_GetMicrofrontendsConfigSecurityRequirement0,
            };
        partial void PrepareGetMicrofrontendsConfigArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string deploymentId,
            ref string? teamId,
            ref string? slug);
        partial void PrepareGetMicrofrontendsConfigRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string deploymentId,
            string? teamId,
            string? slug);
        partial void ProcessGetMicrofrontendsConfigResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetMicrofrontendsConfigResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.GetMicrofrontendsConfigResponse> GetMicrofrontendsConfigAsync(
            string deploymentId,
        ...
        {
            var __response = await GetMicrofrontendsConfigAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.GetMicrofrontendsConfigResponse>> GetMicrofrontendsConfigAsResponseAsync(
            string deploymentId,
            string? teamId = default,
            string? slug = default,
            global::Vercel.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetMicrofrontendsConfigArguments(
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetMicrofrontendsConfigSecurityRequirements,
                operationName: "GetMicrofrontendsConfigAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetMicrofrontendsConfigAsync",
                                pathTemplate: "$\"/v1/microfrontends/{deploymentId}/config\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetMicrofrontendsConfigResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetMicrofrontendsConfigResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vercel.GetMicrofrontendsConfigResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vercel.AutoSDKHttpResponse<global::Vercel.GetMicrofrontendsConfigResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vercel.GetMicrofrontendsConfigResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
