...
namespace Vercel
{
    public partial class SandboxesClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_CreateSandboxesV4SecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_CreateSandboxesV4SecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_CreateSandboxesV4SecurityRequirement0,
            };
        partial void PrepareCreateSandboxesV4Arguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? teamId,
            ref string? slug,
            global::Vercel.CreateSandboxesV4Request request);
        partial void PrepareCreateSandboxesV4Request(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? teamId,
            string? slug,
            global::Vercel.CreateSandboxesV4Request request);
        partial void ProcessCreateSandboxesV4Response(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateSandboxesV4ResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await CreateSandboxesV4AsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.CreateSandboxesV4Response>> CreateSandboxesV4AsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateSandboxesV4Arguments(
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateSandboxesV4SecurityRequirements,
                operationName: "CreateSandboxesV4Async");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateSandboxesV4Request(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CreateSandboxesV4",
                                methodName: "CreateSandboxesV4Async",
                                pathTemplate: "\"/v4/sandboxes\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateSandboxesV4Response(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateSandboxesV4ResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vercel.CreateSandboxesV4Response.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vercel.AutoSDKHttpResponse<global::Vercel.CreateSandboxesV4Response>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vercel.CreateSandboxesV4Response.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.CreateSandboxesV4Response> CreateSandboxesV4Async(
            ...
            global::System.Collections.Generic.Dictionary<string, global::Vercel.CreateSandboxesV4RequestMounts2>? mounts = default,
            global::Vercel.CreateSandboxesV4RequestRegion? region = default,
            global::System.Collections.Generic.IList<global::Vercel.CreateSandboxesV4RequestFailoverRegion>? failoverRegions = default,
            string? name = default,
            bool? persistent = default,
            global::Vercel.OneOf<object, int?>? snapshotExpiration = default,
            global::Vercel.OneOf<string, global::Vercel.CreateSandboxesV4RequestKeepLastSnapshots>? keepLastSnapshots = default,
            global::System.Collections.Generic.Dictionary<string, string>? tags = default,
            global::Vercel.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Vercel.CreateSandboxesV4Request
            {
            ...
            return await CreateSandboxesV4Async(
                teamId: teamId,
                slug: slug,
                request: __request,
                requestOptions: requestOptions,
