...
namespace Vercel
{
    ...
    public sealed partial class UpdateSandboxRequestNetworkPolicyVariant2AllowItemMatchQueryStringItemValue
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateSandboxRequestNetworkPolicyVariant2AllowItemMatchQueryStringItemValue" /> class.
        /// </summary>
        /// <param name="exact">
        /// Match the value exactly. Case-sensitive for paths, header values, and methods; case-insensitive for domains and header keys.
        /// </param>
...
#endif
        public UpdateSandboxRequestNetworkPolicyVariant2AllowItemMatchQueryStringItemValue(
            string? exact,
            string? startsWith)
        {
            this.Exact = exact;
