...
namespace Vercel
{
    public partial class RollingReleaseClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_GetRollingReleaseSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_GetRollingReleaseSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_GetRollingReleaseSecurityRequirement0,
            };
        partial void PrepareGetRollingReleaseArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string idOrName,
            ref global::Vercel.GetRollingReleaseState? state,
            ref string? teamId,
            ref string? slug);
        partial void PrepareGetRollingReleaseRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string idOrName,
            global::Vercel.GetRollingReleaseState? state,
            string? teamId,
            string? slug);
        partial void ProcessGetRollingReleaseResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetRollingReleaseResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.GetRollingReleaseResponse> GetRollingReleaseAsync(
            string idOrName,
        ...
        {
            var __response = await GetRollingReleaseAsResponseAsync(
                idOrName: idOrName,
                state: state,
                teamId: teamId,
                slug: slug,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.GetRollingReleaseResponse>> GetRollingReleaseAsResponseAsync(
            string idOrName,
            global::Vercel.GetRollingReleaseState? state = default,
            string? teamId = default,
            string? slug = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetRollingReleaseArguments(
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetRollingReleaseSecurityRequirements,
                operationName: "GetRollingReleaseAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetRollingReleaseAsync",
                                pathTemplate: "$\"/v1/projects/{idOrName}/rolling-release\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetRollingReleaseResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetRollingReleaseResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vercel.GetRollingReleaseResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vercel.AutoSDKHttpResponse<global::Vercel.GetRollingReleaseResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vercel.GetRollingReleaseResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
