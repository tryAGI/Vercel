...
namespace Vercel
{
    public partial class IntegrationsClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_GetBillingPlansSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_GetBillingPlansSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_GetBillingPlansSecurityRequirement0,
            };
        partial void PrepareGetBillingPlansArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string integrationIdOrSlug,
            ref string? integrationConfigurationId,
            ref string productIdOrSlug,
            ref string? metadata,
            ref global::Vercel.GetBillingPlansSource? source,
            ref string? teamId,
            ref string? slug);
        partial void PrepareGetBillingPlansRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? metadata,
            global::Vercel.GetBillingPlansSource? source,
            string? teamId,
            string? slug);
        partial void ProcessGetBillingPlansResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetBillingPlansResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.GetBillingPlansResponse> GetBillingPlansAsync(
            string integrationIdOrSlug,
            string productIdOrSlug,
        ...
        {
            var __response = await GetBillingPlansAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.GetBillingPlansResponse>> GetBillingPlansAsResponseAsync(
            string integrationIdOrSlug,
            string productIdOrSlug,
            string? integrationConfigurationId = default,
            string? metadata = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetBillingPlansSecurityRequirements,
                operationName: "GetBillingPlansAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            __pathBuilder
                                .AddOptionalParameter("integrationConfigurationId", integrationConfigurationId)
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetBillingPlansAsync",
                                pathTemplate: "$\"/v1/integrations/integration/{integrationIdOrSlug}/products/{productIdOrSlug}/plans\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetBillingPlansResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetBillingPlansResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vercel.GetBillingPlansResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vercel.AutoSDKHttpResponse<global::Vercel.GetBillingPlansResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vercel.GetBillingPlansResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
