...
namespace Vercel
{
    ...
    public sealed partial class GetProjectResponseLatestDeploymentOidcTokenClaims
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetProjectResponseLatestDeploymentOidcTokenClaims" /> class.
        /// </summary>
...
#endif
        public GetProjectResponseLatestDeploymentOidcTokenClaims(
            string iss,
            string sub,
            string scope,
            string aud,
