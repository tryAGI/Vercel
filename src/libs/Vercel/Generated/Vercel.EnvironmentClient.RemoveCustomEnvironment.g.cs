...
namespace Vercel
{
    public partial class EnvironmentClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_RemoveCustomEnvironmentSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_RemoveCustomEnvironmentSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_RemoveCustomEnvironmentSecurityRequirement0,
            };
        partial void PrepareRemoveCustomEnvironmentArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string idOrName,
            ref string environmentSlugOrId,
            ref string? teamId,
            ref string? slug,
            global::Vercel.RemoveCustomEnvironmentRequest request);
        partial void PrepareRemoveCustomEnvironmentRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? slug,
            global::Vercel.RemoveCustomEnvironmentRequest request);
        partial void ProcessRemoveCustomEnvironmentResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessRemoveCustomEnvironmentResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.RemoveCustomEnvironmentResponse> RemoveCustomEnvironmentAsync(
            string idOrName,
            string environmentSlugOrId,
        ...
        {
            var __response = await RemoveCustomEnvironmentAsResponseAsync(
                idOrName: idOrName,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.RemoveCustomEnvironmentResponse>> RemoveCustomEnvironmentAsResponseAsync(
            string idOrName,
            string environmentSlugOrId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareRemoveCustomEnvironmentArguments(
                httpClient: HttpClient,
                idOrName: ref idOrName,
                environmentSlugOrId: ref environmentSlugOrId,
                teamId: ref teamId,
                slug: ref slug,
                request: request);
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_RemoveCustomEnvironmentSecurityRequirements,
                operationName: "RemoveCustomEnvironmentAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareRemoveCustomEnvironmentRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "RemoveCustomEnvironmentAsync",
                                pathTemplate: "$\"/v9/projects/{idOrName}/custom-environments/{environmentSlugOrId}\"",
                                httpMethod: "DELETE",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessRemoveCustomEnvironmentResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessRemoveCustomEnvironmentResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vercel.RemoveCustomEnvironmentResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vercel.AutoSDKHttpResponse<global::Vercel.RemoveCustomEnvironmentResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vercel.RemoveCustomEnvironmentResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.RemoveCustomEnvironmentResponse> RemoveCustomEnvironmentAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Vercel.RemoveCustomEnvironmentRequest
            {
                DeleteUnassignedEnvironmentVariables = deleteUnassignedEnvironmentVariables,
            };

            return await RemoveCustomEnvironmentAsync(
                idOrName: idOrName,
                environmentSlugOrId: environmentSlugOrId,
                teamId: teamId,
                slug: slug,
