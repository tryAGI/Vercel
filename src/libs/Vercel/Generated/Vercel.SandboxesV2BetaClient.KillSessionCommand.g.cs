...
namespace Vercel
{
    public partial class SandboxesV2BetaClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_KillSessionCommandSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_KillSessionCommandSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_KillSessionCommandSecurityRequirement0,
            };
        partial void PrepareKillSessionCommandArguments(
        ...
        partial void PrepareKillSessionCommandRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? slug,
            global::Vercel.KillSessionCommandRequest request);
        partial void ProcessKillSessionCommandResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessKillSessionCommandResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.KillSessionCommandResponse> KillSessionCommandAsync(
            string cmdId,
            string sessionId,
        ...
        {
            var __response = await KillSessionCommandAsResponseAsync(
                cmdId: cmdId,
                sessionId: sessionId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.KillSessionCommandResponse>> KillSessionCommandAsResponseAsync(
            string cmdId,
            string sessionId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareKillSessionCommandArguments(
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_KillSessionCommandSecurityRequirements,
                operationName: "KillSessionCommandAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareKillSessionCommandRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                pathTemplate: "$\"/v2/sandboxes/sessions/{sessionId}/cmd/{cmdId}/kill\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessKillSessionCommandResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessKillSessionCommandResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vercel.KillSessionCommandResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vercel.AutoSDKHttpResponse<global::Vercel.KillSessionCommandResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vercel.KillSessionCommandResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.KillSessionCommandResponse> KillSessionCommandAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Vercel.KillSessionCommandRequest
            {
                Signal = signal,
            };

            return await KillSessionCommandAsync(
                cmdId: cmdId,
                sessionId: sessionId,
                teamId: teamId,
                slug: slug,
