...
namespace Vercel
{
    public partial interface IDnsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.OneOf<string, global::Vercel.GetRecordsResponseVariant2, global::Vercel.GetRecordsResponseVariant3>>> GetRecordsAsResponseAsync(
            string domain,
            string? limit = default,
            string? since = default,
            string? until = default,
