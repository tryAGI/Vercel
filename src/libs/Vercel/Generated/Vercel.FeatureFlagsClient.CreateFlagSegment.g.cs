...
namespace Vercel
{
    public partial class FeatureFlagsClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_CreateFlagSegmentSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_CreateFlagSegmentSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_CreateFlagSegmentSecurityRequirement0,
            };
        partial void PrepareCreateFlagSegmentArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string projectIdOrName,
            ref string? teamId,
            ref string? slug,
            global::Vercel.CreateFlagSegmentRequest request);
        partial void PrepareCreateFlagSegmentRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? slug,
            global::Vercel.CreateFlagSegmentRequest request);
        partial void ProcessCreateFlagSegmentResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateFlagSegmentResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKSharedd2d51fdc45c5e627> CreateFlagSegmentAsync(
            string projectIdOrName,
        ...
        {
            var __response = await CreateFlagSegmentAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.AutoSDKSharedd2d51fdc45c5e627>> CreateFlagSegmentAsResponseAsync(
            string projectIdOrName,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateFlagSegmentArguments(
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateFlagSegmentSecurityRequirements,
                operationName: "CreateFlagSegmentAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateFlagSegmentRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "CreateFlagSegmentAsync",
                                pathTemplate: "$\"/v1/projects/{projectIdOrName}/feature-flags/segments\"",
                                httpMethod: "PUT",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateFlagSegmentResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateFlagSegmentResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vercel.AutoSDKSharedd2d51fdc45c5e627.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vercel.AutoSDKHttpResponse<global::Vercel.AutoSDKSharedd2d51fdc45c5e627>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vercel.AutoSDKSharedd2d51fdc45c5e627.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKSharedd2d51fdc45c5e627> CreateFlagSegmentAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Vercel.CreateFlagSegmentRequest
            {
                Slug = requestSlug,
                CreatedBy = createdBy,
                Label = label,
            ...
            return await CreateFlagSegmentAsync(
                projectIdOrName: projectIdOrName,
                teamId: teamId,
                slug: slug,
                request: __request,
