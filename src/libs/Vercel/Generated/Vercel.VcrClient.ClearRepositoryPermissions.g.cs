...
namespace Vercel
{
    public partial class VcrClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_ClearRepositoryPermissionsSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_ClearRepositoryPermissionsSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_ClearRepositoryPermissionsSecurityRequirement0,
            };
        partial void PrepareClearRepositoryPermissionsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string projectId,
            ref string idOrName,
            ref string? teamId,
            ref string? slug);
        partial void PrepareClearRepositoryPermissionsRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? teamId,
            string? slug);
        partial void ProcessClearRepositoryPermissionsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessClearRepositoryPermissionsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Clear all repository permissions<br/>
        ...
        public async global::System.Threading.Tasks.Task<string> ClearRepositoryPermissionsAsync(
            string projectId,
            string idOrName,
        ...
        {
            var __response = await ClearRepositoryPermissionsAsResponseAsync(
                projectId: projectId,
                idOrName: idOrName,
                teamId: teamId,
                slug: slug,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<string>> ClearRepositoryPermissionsAsResponseAsync(
            string projectId,
            string idOrName,
            string? teamId = default,
            string? slug = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareClearRepositoryPermissionsArguments(
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ClearRepositoryPermissionsSecurityRequirements,
                operationName: "ClearRepositoryPermissionsAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Vercel.PathBuilder(
                                path: $"/v1/vcr/repository/{idOrName}/permissions/all",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareClearRepositoryPermissionsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "ClearRepositoryPermissionsAsync",
                                pathTemplate: "$\"/v1/vcr/repository/{idOrName}/permissions/all\"",
                                httpMethod: "DELETE",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessClearRepositoryPermissionsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessClearRepositoryPermissionsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
