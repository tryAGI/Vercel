...
namespace Vercel
{
    ...
    public sealed partial class ConnectConnectorUpdateDataTypeOauthClientAssertion
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ConnectConnectorUpdateDataTypeOauthClientAssertion" /> class.
        /// </summary>
        /// <param name="type">
        /// OAuth client assertion type. Defaults to urn:ietf:params:oauth:client-assertion-type:jwt-bearer. An empty string clears the configured type.
        /// </param>
...
#endif
        public ConnectConnectorUpdateDataTypeOauthClientAssertion(
            string? type,
            double? ttl,
            object? claims)
        {
