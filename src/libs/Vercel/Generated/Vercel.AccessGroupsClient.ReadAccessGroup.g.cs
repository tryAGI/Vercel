...
namespace Vercel
{
    public partial class AccessGroupsClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_ReadAccessGroupSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_ReadAccessGroupSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_ReadAccessGroupSecurityRequirement0,
            };
        partial void PrepareReadAccessGroupArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string idOrName,
            ref string? teamId,
            ref string? slug);
        partial void PrepareReadAccessGroupRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string idOrName,
            string? teamId,
            string? slug);
        partial void ProcessReadAccessGroupResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessReadAccessGroupResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Reads an access group<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.ReadAccessGroupResponse> ReadAccessGroupAsync(
            string idOrName,
        ...
        {
            var __response = await ReadAccessGroupAsResponseAsync(
                idOrName: idOrName,
                teamId: teamId,
                slug: slug,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.ReadAccessGroupResponse>> ReadAccessGroupAsResponseAsync(
            string idOrName,
            string? teamId = default,
            string? slug = default,
            global::Vercel.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareReadAccessGroupArguments(
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ReadAccessGroupSecurityRequirements,
                operationName: "ReadAccessGroupAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "ReadAccessGroupAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessReadAccessGroupResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessReadAccessGroupResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vercel.ReadAccessGroupResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vercel.AutoSDKHttpResponse<global::Vercel.ReadAccessGroupResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vercel.ReadAccessGroupResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
