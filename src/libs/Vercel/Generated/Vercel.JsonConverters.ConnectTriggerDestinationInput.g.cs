...
{
    /// <inheritdoc />
    public class ConnectTriggerDestinationInputJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Vercel.ConnectTriggerDestinationInput>
    {
        /// <inheritdoc />
        public override global::Vercel.ConnectTriggerDestinationInput Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var __score1 = 0;
            if (__jsonProps.Contains("branch")) __score1++;
            if (__jsonProps.Contains("path")) __score1++;
            if (__jsonProps.Contains("projectId")) __score1++;
            var __score2 = 0;
            if (__jsonProps.Contains("customEnvironmentId")) __score2++;
            if (__jsonProps.Contains("path")) __score2++;
            if (__jsonProps.Contains("projectId")) __score2++;
            var __bestScore = 0;
            var __bestIndex = -1;
            ...
            global::Vercel.ConnectTriggerDestinationInputDefaultDeployment? defaultDeployment = default;
            global::Vercel.ConnectTriggerDestinationInputBranch? branch = default;
            global::Vercel.ConnectTriggerDestinationInputCustomEnvironment? customEnvironment = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                    try
                    {
                        ...
                        defaultDeployment = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                ...
                else if (__bestIndex == 2)
                {
                    try
                    {
                        ...
                        customEnvironment = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
            ...
            if (defaultDeployment == null && branch == null && customEnvironment == null)
            {
                try
                {
            ...
            var __value = new global::Vercel.ConnectTriggerDestinationInput(
                defaultDeployment,
        ...
        public override void Write(
            ...
            global::Vercel.ConnectTriggerDestinationInput value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");

            if (value.IsDefaultDeployment)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Vercel.ConnectTriggerDestinationInputDefaultDeployment), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Vercel.ConnectTriggerDestinationInputDefaultDeployment?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::Vercel.ConnectTriggerDestinationInputDefaultDeployment).Name}");
