...
namespace Vercel
{
    public partial class TeamsClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_UpdateTeamMemberSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_UpdateTeamMemberSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_UpdateTeamMemberSecurityRequirement0,
            };
        partial void PrepareUpdateTeamMemberArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string uid,
            ref string teamId,
            global::Vercel.UpdateTeamMemberRequest request);
        partial void PrepareUpdateTeamMemberRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string uid,
            string teamId,
            global::Vercel.UpdateTeamMemberRequest request);
        partial void ProcessUpdateTeamMemberResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUpdateTeamMemberResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.UpdateTeamMemberResponse> UpdateTeamMemberAsync(
            string uid,
            string teamId,
        ...
        {
            var __response = await UpdateTeamMemberAsResponseAsync(
                uid: uid,
                teamId: teamId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.UpdateTeamMemberResponse>> UpdateTeamMemberAsResponseAsync(
            string uid,
            string teamId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUpdateTeamMemberArguments(
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UpdateTeamMemberSecurityRequirements,
                operationName: "UpdateTeamMemberAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "UpdateTeamMemberAsync",
                                pathTemplate: "$\"/v1/teams/{teamId}/members/{uid}\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUpdateTeamMemberResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUpdateTeamMemberResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vercel.UpdateTeamMemberResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vercel.AutoSDKHttpResponse<global::Vercel.UpdateTeamMemberResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vercel.UpdateTeamMemberResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.UpdateTeamMemberResponse> UpdateTeamMemberAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Vercel.UpdateTeamMemberRequest
            {
                Confirmed = confirmed,
                Role = role,
            ...
            return await UpdateTeamMemberAsync(
                uid: uid,
                teamId: teamId,
                request: __request,
                requestOptions: requestOptions,
