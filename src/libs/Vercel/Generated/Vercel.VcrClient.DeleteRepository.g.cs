...
namespace Vercel
{
    public partial class VcrClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_DeleteRepositorySecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_DeleteRepositorySecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_DeleteRepositorySecurityRequirement0,
            };
        partial void PrepareDeleteRepositoryArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string projectId,
            ref string idOrName,
            ref string? teamId,
            ref string? slug);
        partial void PrepareDeleteRepositoryRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? teamId,
            string? slug);
        partial void ProcessDeleteRepositoryResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessDeleteRepositoryResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> DeleteRepositoryAsync(
            string projectId,
            string idOrName,
        ...
        {
            var __response = await DeleteRepositoryAsResponseAsync(
                projectId: projectId,
                idOrName: idOrName,
                teamId: teamId,
                slug: slug,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<string>> DeleteRepositoryAsResponseAsync(
            string projectId,
            string idOrName,
            string? teamId = default,
            string? slug = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareDeleteRepositoryArguments(
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_DeleteRepositorySecurityRequirements,
                operationName: "DeleteRepositoryAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareDeleteRepositoryRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "DeleteRepositoryAsync",
                                pathTemplate: "$\"/v1/vcr/repository/{idOrName}\"",
                                httpMethod: "DELETE",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessDeleteRepositoryResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessDeleteRepositoryResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
