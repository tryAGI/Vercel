...
namespace Vercel
{
    ...
    public sealed partial class UpdateProjectResponseLatestDeploymentOidcTokenClaims
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateProjectResponseLatestDeploymentOidcTokenClaims" /> class.
        /// </summary>
...
#endif
        public UpdateProjectResponseLatestDeploymentOidcTokenClaims(
            string iss,
            string sub,
            string scope,
            string aud,
