...
namespace Vercel
{
    ...
    public sealed partial class CreateProjectResponseAbuseBlockHistoryItemVariant1RegisteredShaBlock
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateProjectResponseAbuseBlockHistoryItemVariant1RegisteredShaBlock" /> class.
        /// </summary>
...
#endif
        public CreateProjectResponseAbuseBlockHistoryItemVariant1RegisteredShaBlock(
            string createdAt,
            string createdBy,
            string sha)
        {
