...
namespace Vercel
{
    public partial class MarketplaceClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_ImportResourceSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_ImportResourceSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_ImportResourceSecurityRequirement0,
            };
        partial void PrepareImportResourceArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string integrationConfigurationId,
            ref string resourceId,
            global::Vercel.ImportResourceRequest request);
        partial void PrepareImportResourceRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string integrationConfigurationId,
            string resourceId,
            global::Vercel.ImportResourceRequest request);
        partial void ProcessImportResourceResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessImportResourceResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.ImportResourceResponse> ImportResourceAsync(
            string integrationConfigurationId,
            string resourceId,
        ...
        {
            var __response = await ImportResourceAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.ImportResourceResponse>> ImportResourceAsResponseAsync(
            string integrationConfigurationId,
            string resourceId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareImportResourceArguments(
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ImportResourceSecurityRequirements,
                operationName: "ImportResourceAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "ImportResourceAsync",
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessImportResourceResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vercel.ImportResourceResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vercel.AutoSDKHttpResponse<global::Vercel.ImportResourceResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vercel.ImportResourceResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.ImportResourceResponse> ImportResourceAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Vercel.ImportResourceRequest
            {
                Ownership = ownership,
                ProductId = productId,
                Name = name,
            ...
            return await ImportResourceAsync(
                integrationConfigurationId: integrationConfigurationId,
                resourceId: resourceId,
                request: __request,
                requestOptions: requestOptions,
