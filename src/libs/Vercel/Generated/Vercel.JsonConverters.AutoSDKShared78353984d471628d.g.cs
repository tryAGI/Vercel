...
{
    /// <inheritdoc />
    public class AutoSDKShared78353984d471628dJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Vercel.AutoSDKShared78353984d471628d>
    {
        /// <inheritdoc />
        public override global::Vercel.AutoSDKShared78353984d471628d Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var __score0 = 0;
            if (__jsonProps.Contains("defaultAppProjectName")) __score0++;
            ...
            var __score1 = 0;
            if (__jsonProps.Contains("defaultAppProjectName")) __score1++;
            ...
            if (__jsonProps.Contains("mfeConfigUploadState")) __score1++;
            var __bestScore = 0;
            var __bestIndex = -1;
            if (__score0 > __bestScore) { __bestScore = __score0; __bestIndex = 0; }
            if (__score1 > __bestScore) { __bestScore = __score1; __bestIndex = 1; }

            global::Vercel.AutoSDKShared78353984d471628dVariant1? autoSDKShared78353984d471628dVariant1 = default;
            global::Vercel.AutoSDKShared238fc1521601aa81? shared238fc1521601aa81 = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                    try
                    {
                        ...
                        autoSDKShared78353984d471628dVariant1 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        ...
                        shared238fc1521601aa81 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
            ...
            if (autoSDKShared78353984d471628dVariant1 == null && shared238fc1521601aa81 == null)
            {
                try
                {
            ...
            var __value = new global::Vercel.AutoSDKShared78353984d471628d(
        ...
        public override void Write(
            ...
            global::Vercel.AutoSDKShared78353984d471628d value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");

            if (value.IsAutoSDKShared78353984d471628dVariant1)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Vercel.AutoSDKShared78353984d471628dVariant1), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Vercel.AutoSDKShared78353984d471628dVariant1?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::Vercel.AutoSDKShared78353984d471628dVariant1).Name}");
