...
namespace Vercel
{
    public partial interface IFeatureFlagsClient
    {
        ...
        global::System.Threading.Tasks.Task<global::Vercel.Segment> GetFlagSegmentAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.Segment>> GetFlagSegmentAsResponseAsync(
            string projectIdOrName,
            string segmentIdOrSlug,
            bool? withMetadata = default,
            string? teamId = default,
