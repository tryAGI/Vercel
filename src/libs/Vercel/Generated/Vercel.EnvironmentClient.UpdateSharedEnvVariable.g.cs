...
namespace Vercel
{
    public partial class EnvironmentClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_UpdateSharedEnvVariableSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_UpdateSharedEnvVariableSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_UpdateSharedEnvVariableSecurityRequirement0,
            };
        partial void PrepareUpdateSharedEnvVariableArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? teamId,
            ref string? slug,
            global::Vercel.UpdateSharedEnvVariableRequest request);
        partial void PrepareUpdateSharedEnvVariableRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? teamId,
            string? slug,
            global::Vercel.UpdateSharedEnvVariableRequest request);
        partial void ProcessUpdateSharedEnvVariableResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUpdateSharedEnvVariableResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.UpdateSharedEnvVariableResponse> UpdateSharedEnvVariableAsync(
        ...
        {
            var __response = await UpdateSharedEnvVariableAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.UpdateSharedEnvVariableResponse>> UpdateSharedEnvVariableAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUpdateSharedEnvVariableArguments(
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UpdateSharedEnvVariableSecurityRequirements,
                operationName: "UpdateSharedEnvVariableAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareUpdateSharedEnvVariableRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "UpdateSharedEnvVariableAsync",
                                pathTemplate: "\"/v1/env\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUpdateSharedEnvVariableResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUpdateSharedEnvVariableResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vercel.UpdateSharedEnvVariableResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vercel.AutoSDKHttpResponse<global::Vercel.UpdateSharedEnvVariableResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vercel.UpdateSharedEnvVariableResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.UpdateSharedEnvVariableResponse> UpdateSharedEnvVariableAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Vercel.UpdateSharedEnvVariableRequest
            {
                Updates = updates,
            };

            return await UpdateSharedEnvVariableAsync(
                teamId: teamId,
                slug: slug,
                request: __request,
                requestOptions: requestOptions,
