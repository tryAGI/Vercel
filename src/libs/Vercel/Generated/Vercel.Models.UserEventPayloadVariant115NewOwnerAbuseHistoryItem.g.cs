...
namespace Vercel
{
    ...
    public sealed partial class UserEventPayloadVariant115NewOwnerAbuseHistoryItem
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UserEventPayloadVariant115NewOwnerAbuseHistoryItem" /> class.
        /// </summary>
...
#endif
        public UserEventPayloadVariant115NewOwnerAbuseHistoryItem(
            string scanner,
            string reason,
            string by,
            string byId,
