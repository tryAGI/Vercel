...
namespace Vercel
{
    public partial class WebAnalyticsClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_CountPageviewsSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_CountPageviewsSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_CountPageviewsSecurityRequirement0,
            };
        partial void PrepareCountPageviewsArguments(
            ...
            ref string? teamId,
            ref string? slug);
        partial void PrepareCountPageviewsRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? teamId,
            string? slug);
        partial void ProcessCountPageviewsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCountPageviewsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.CountPageviewsResponse> CountPageviewsAsync(
            string projectId,
        ...
        {
            var __response = await CountPageviewsAsResponseAsync(
                projectId: projectId,
                since: since,
                until: until,
                filter: filter,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.CountPageviewsResponse>> CountPageviewsAsResponseAsync(
            string projectId,
            global::Vercel.AnyOf<double?, string>? since = default,
            global::Vercel.AnyOf<double?, string>? until = default,
            string? filter = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareCountPageviewsArguments(
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CountPageviewsSecurityRequirements,
                operationName: "CountPageviewsAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "CountPageviewsAsync",
                                pathTemplate: "\"/v1/query/web-analytics/visits/count\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCountPageviewsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vercel.CountPageviewsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vercel.AutoSDKHttpResponse<global::Vercel.CountPageviewsResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vercel.CountPageviewsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
