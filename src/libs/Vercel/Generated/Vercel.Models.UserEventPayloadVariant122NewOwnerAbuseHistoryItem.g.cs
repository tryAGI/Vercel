...
namespace Vercel
{
    ...
    public sealed partial class UserEventPayloadVariant122NewOwnerAbuseHistoryItem
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UserEventPayloadVariant122NewOwnerAbuseHistoryItem" /> class.
        /// </summary>
...
#endif
        public UserEventPayloadVariant122NewOwnerAbuseHistoryItem(
            string scanner,
            string reason,
            string by,
            string byId,
