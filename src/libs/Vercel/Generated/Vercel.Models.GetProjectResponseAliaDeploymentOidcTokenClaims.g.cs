...
namespace Vercel
{
    ...
    public sealed partial class GetProjectResponseAliaDeploymentOidcTokenClaims
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetProjectResponseAliaDeploymentOidcTokenClaims" /> class.
        /// </summary>
...
#endif
        public GetProjectResponseAliaDeploymentOidcTokenClaims(
            string iss,
            string sub,
            string scope,
            string aud,
