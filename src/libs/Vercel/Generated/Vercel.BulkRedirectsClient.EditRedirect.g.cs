...
namespace Vercel
{
    public partial class BulkRedirectsClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_EditRedirectSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_EditRedirectSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_EditRedirectSecurityRequirement0,
            };
        partial void PrepareEditRedirectArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string projectId,
            ref string? teamId,
            ref string? slug,
            global::Vercel.EditRedirectRequest request);
        partial void PrepareEditRedirectRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? slug,
            global::Vercel.EditRedirectRequest request);
        partial void ProcessEditRedirectResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessEditRedirectResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.EditRedirectResponse> EditRedirectAsync(
            string projectId,
        ...
        {
            var __response = await EditRedirectAsResponseAsync(
                projectId: projectId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.EditRedirectResponse>> EditRedirectAsResponseAsync(
            string projectId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_EditRedirectSecurityRequirements,
                operationName: "EditRedirectAsync");
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessEditRedirectResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vercel.EditRedirectResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vercel.AutoSDKHttpResponse<global::Vercel.EditRedirectResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vercel.EditRedirectResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.EditRedirectResponse> EditRedirectAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Vercel.EditRedirectRequest
            {
                Name = name,
                Redirect = redirect,
                Restore = restore,
            ...
            return await EditRedirectAsync(
                projectId: projectId,
                teamId: teamId,
                slug: slug,
                request: __request,
