...
namespace Vercel
{
    ...
    public sealed partial class UpdateProjectResponseGitProviderOptionsConsolidatedGitCommitStatus
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateProjectResponseGitProviderOptionsConsolidatedGitCommitStatus" /> class.
        /// </summary>
        /// <param name="enabled">
        /// Whether consolidated commit status is enabled.
        /// </param>
...
#endif
        public UpdateProjectResponseGitProviderOptionsConsolidatedGitCommitStatus(
            bool enabled,
