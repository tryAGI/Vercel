...
namespace Vercel
{
    public partial class ConnectClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_UpsertConnectorProjectConnectionSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_UpsertConnectorProjectConnectionSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_UpsertConnectorProjectConnectionSecurityRequirement0,
            };
        partial void PrepareUpsertConnectorProjectConnectionArguments(
        ...
        partial void PrepareUpsertConnectorProjectConnectionRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? slug,
            global::Vercel.ConnectUpsertProjectConnectionRequest request);
        partial void ProcessUpsertConnectorProjectConnectionResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUpsertConnectorProjectConnectionResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.ConnectProjectConnection> UpsertConnectorProjectConnectionAsync(
            string connector,
            string projectId,
        ...
        {
            var __response = await UpsertConnectorProjectConnectionAsResponseAsync(
                connector: connector,
                projectId: projectId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.ConnectProjectConnection>> UpsertConnectorProjectConnectionAsResponseAsync(
            string connector,
            string projectId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUpsertConnectorProjectConnectionArguments(
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UpsertConnectorProjectConnectionSecurityRequirements,
                operationName: "UpsertConnectorProjectConnectionAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareUpsertConnectorProjectConnectionRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "UpsertConnectorProjectConnectionAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUpsertConnectorProjectConnectionResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUpsertConnectorProjectConnectionResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vercel.ConnectProjectConnection.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vercel.AutoSDKHttpResponse<global::Vercel.ConnectProjectConnection>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vercel.ConnectProjectConnection.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.ConnectProjectConnection> UpsertConnectorProjectConnectionAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Vercel.ConnectUpsertProjectConnectionRequest
            {
                Environments = environments,
            };

            return await UpsertConnectorProjectConnectionAsync(
                connector: connector,
                projectId: projectId,
                teamId: teamId,
                slug: slug,
