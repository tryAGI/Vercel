            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::Vercel.OneOf<global::Vercel.UploadFileResponseVariant1, object>.FromJson(__content, JsonSerializerContext) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::Vercel.OneOf<global::Vercel.UploadFileResponseVariant1, object>.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
