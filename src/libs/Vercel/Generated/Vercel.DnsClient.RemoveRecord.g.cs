...
namespace Vercel
{
    public partial class DnsClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_RemoveRecordSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_RemoveRecordSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_RemoveRecordSecurityRequirement0,
            };
        partial void PrepareRemoveRecordArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string domain,
            ref string recordId,
            ref string? teamId,
            ref string? slug);
        partial void PrepareRemoveRecordRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? teamId,
            string? slug);
        partial void ProcessRemoveRecordResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessRemoveRecordResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> RemoveRecordAsync(
            string domain,
            string recordId,
        ...
        {
            var __response = await RemoveRecordAsResponseAsync(
                domain: domain,
                recordId: recordId,
                teamId: teamId,
                slug: slug,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<string>> RemoveRecordAsResponseAsync(
            string domain,
            string recordId,
            string? teamId = default,
            string? slug = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_RemoveRecordSecurityRequirements,
                operationName: "RemoveRecordAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "RemoveRecordAsync",
                                pathTemplate: "$\"/v2/domains/{domain}/records/{recordId}\"",
                                httpMethod: "DELETE",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessRemoveRecordResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
