...
namespace Vercel
{
    public partial class ProjectsClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_EditProjectEnvSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_EditProjectEnvSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_EditProjectEnvSecurityRequirement0,
            };
        partial void PrepareEditProjectEnvArguments(
        ...
        partial void PrepareEditProjectEnvRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? slug,
            global::Vercel.EditProjectEnvRequest request);
        partial void ProcessEditProjectEnvResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessEditProjectEnvResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.EditProjectEnvResponse> EditProjectEnvAsync(
            string idOrName,
            string id,
        ...
        {
            var __response = await EditProjectEnvAsResponseAsync(
                idOrName: idOrName,
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.EditProjectEnvResponse>> EditProjectEnvAsResponseAsync(
            string idOrName,
            string id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareEditProjectEnvArguments(
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_EditProjectEnvSecurityRequirements,
                operationName: "EditProjectEnvAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "EditProjectEnvAsync",
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessEditProjectEnvResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vercel.EditProjectEnvResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vercel.AutoSDKHttpResponse<global::Vercel.EditProjectEnvResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vercel.EditProjectEnvResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.EditProjectEnvResponse> EditProjectEnvAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Vercel.EditProjectEnvRequest
            {
                Key = key,
                Target = target,
                GitBranch = gitBranch,
            ...
            return await EditProjectEnvAsync(
                idOrName: idOrName,
                id: id,
                teamId: teamId,
                slug: slug,
