...
namespace Vercel
{
    ...
    public sealed partial class CompleteRollingReleaseResponseRollingReleaseActiveStage
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CompleteRollingReleaseResponseRollingReleaseActiveStage" /> class.
        /// </summary>
        /// <param name="index">
        /// The zero-based index of the stage<br/>
        /// Example: 0
...
#endif
        public CompleteRollingReleaseResponseRollingReleaseActiveStage(
            double index,
            bool isFinalStage,
