...
namespace Vercel
{
    ...
    public sealed partial class UpdateIntegrationDeploymentActionRequestOutcomeVariant2ClaimRuleWhen
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateIntegrationDeploymentActionRequestOutcomeVariant2ClaimRuleWhen" /> class.
        /// </summary>
        /// <param name="role">
        /// Applies only when the token is minted for one of these roles.
        /// </param>
...
#endif
        public UpdateIntegrationDeploymentActionRequestOutcomeVariant2ClaimRuleWhen(
