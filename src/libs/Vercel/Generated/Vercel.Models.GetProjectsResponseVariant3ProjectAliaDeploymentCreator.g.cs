...
namespace Vercel
{
    ...
    public sealed partial class GetProjectsResponseVariant3ProjectAliaDeploymentCreator
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetProjectsResponseVariant3ProjectAliaDeploymentCreator" /> class.
        /// </summary>
...
#endif
        public GetProjectsResponseVariant3ProjectAliaDeploymentCreator(
            string email,
            string uid,
            string username,
            string? githubLogin,
