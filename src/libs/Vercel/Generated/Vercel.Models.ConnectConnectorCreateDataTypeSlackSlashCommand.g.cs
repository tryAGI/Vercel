...
namespace Vercel
{
    ...
    public sealed partial class ConnectConnectorCreateDataTypeSlackSlashCommand
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ConnectConnectorCreateDataTypeSlackSlashCommand" /> class.
        /// </summary>
        /// <param name="command">
        /// Slash command including its leading slash.
        /// </param>
...
#endif
        public ConnectConnectorCreateDataTypeSlackSlashCommand(
            string command,
            string description,
            string? usageHint,
            bool? shouldEscape)
