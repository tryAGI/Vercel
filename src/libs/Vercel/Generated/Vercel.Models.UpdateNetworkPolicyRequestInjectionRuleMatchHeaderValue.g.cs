...
namespace Vercel
{
    ...
    public sealed partial class UpdateNetworkPolicyRequestInjectionRuleMatchHeaderValue
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateNetworkPolicyRequestInjectionRuleMatchHeaderValue" /> class.
        /// </summary>
        /// <param name="exact">
        /// Match the value exactly. Case-sensitive for paths, header values, and methods; case-insensitive for domains and header keys.
        /// </param>
...
#endif
        public UpdateNetworkPolicyRequestInjectionRuleMatchHeaderValue(
            string? exact,
            string? startsWith)
        {
            this.Exact = exact;
