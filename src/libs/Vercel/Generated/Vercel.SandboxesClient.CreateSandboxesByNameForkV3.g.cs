...
namespace Vercel
{
    public partial class SandboxesClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_CreateSandboxesByNameForkV3SecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_CreateSandboxesByNameForkV3SecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_CreateSandboxesByNameForkV3SecurityRequirement0,
            };
        partial void PrepareCreateSandboxesByNameForkV3Arguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string name,
            ref string? projectId,
            ref string? teamId,
            ref string? slug,
            global::Vercel.CreateSandboxesByNameForkV3Request request);
        partial void PrepareCreateSandboxesByNameForkV3Request(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? slug,
            global::Vercel.CreateSandboxesByNameForkV3Request request);
        partial void ProcessCreateSandboxesByNameForkV3Response(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateSandboxesByNameForkV3ResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.CreateSandboxesByNameForkV3Response> CreateSandboxesByNameForkV3Async(
            string name,
        ...
        {
            var __response = await CreateSandboxesByNameForkV3AsResponseAsync(
                name: name,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.CreateSandboxesByNameForkV3Response>> CreateSandboxesByNameForkV3AsResponseAsync(
            string name,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateSandboxesByNameForkV3Arguments(
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateSandboxesByNameForkV3SecurityRequirements,
                operationName: "CreateSandboxesByNameForkV3Async");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateSandboxesByNameForkV3Request(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CreateSandboxesByNameForkV3",
                                methodName: "CreateSandboxesByNameForkV3Async",
                                pathTemplate: "$\"/v3/sandboxes/{name}/fork\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateSandboxesByNameForkV3Response(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateSandboxesByNameForkV3ResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vercel.CreateSandboxesByNameForkV3Response.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vercel.AutoSDKHttpResponse<global::Vercel.CreateSandboxesByNameForkV3Response>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vercel.CreateSandboxesByNameForkV3Response.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.CreateSandboxesByNameForkV3Response> CreateSandboxesByNameForkV3Async(
            ...
            string? teamId = default,
            string? slug = default,
            global::Vercel.OneOf<global::Vercel.CreateSandboxesByNameForkV3RequestNetworkPolicyVariant1, global::Vercel.CreateSandboxesByNameForkV3RequestNetworkPolicyVariant2>? networkPolicy = default,
            global::Vercel.CreateSandboxesByNameForkV3RequestResources? resources = default,
            ...
            global::Vercel.OneOf<string, global::Vercel.CreateSandboxesByNameForkV3RequestKeepLastSnapshots>? keepLastSnapshots = default,
            global::System.Collections.Generic.Dictionary<string, string>? tags = default,
            global::Vercel.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Vercel.CreateSandboxesByNameForkV3Request
            {
            ...
            return await CreateSandboxesByNameForkV3Async(
                name: name,
                projectId: projectId,
                teamId: teamId,
                slug: slug,
