...
namespace Vercel
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Vercel.AutoSDKRetryOptions Retry { get; set; } = new global::Vercel.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Vercel.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Vercel.IAutoSDKHook>();
        ...
        public global::Vercel.AutoSDKClientOptions AddHook(
            global::Vercel.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Vercel.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Vercel.AutoSDKClientOptions UseAuthorizationProvider(
            global::Vercel.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Vercel.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Vercel.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Vercel.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Vercel.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Vercel.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Vercel.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Vercel.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Vercel.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Vercel.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Vercel.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Vercel.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Vercel.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Vercel.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Vercel.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Vercel.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Vercel.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Vercel.AutoSDKClientOptions clientOptions,
            global::Vercel.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Vercel.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Vercel.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Vercel.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Vercel.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Vercel.IAutoSDKHook, global::Vercel.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Vercel.AutoSDKHookContext context)
        {
