...
namespace Vercel
{
    ...
    public sealed partial class GetProjectsResponseVariant2ProjectAbuseHistoryItem
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetProjectsResponseVariant2ProjectAbuseHistoryItem" /> class.
        /// </summary>
...
#endif
        public GetProjectsResponseVariant2ProjectAbuseHistoryItem(
            string scanner,
            string reason,
            string by,
            string byId,
