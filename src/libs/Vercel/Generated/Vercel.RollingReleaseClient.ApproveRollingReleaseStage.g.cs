...
namespace Vercel
{
    public partial class RollingReleaseClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_ApproveRollingReleaseStageSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_ApproveRollingReleaseStageSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_ApproveRollingReleaseStageSecurityRequirement0,
            };
        partial void PrepareApproveRollingReleaseStageArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string idOrName,
            ref string? teamId,
            ref string? slug,
            global::Vercel.ApproveRollingReleaseStageRequest request);
        partial void PrepareApproveRollingReleaseStageRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? slug,
            global::Vercel.ApproveRollingReleaseStageRequest request);
        partial void ProcessApproveRollingReleaseStageResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessApproveRollingReleaseStageResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareApproveRollingReleaseStageArguments(
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ApproveRollingReleaseStageSecurityRequirements,
                operationName: "ApproveRollingReleaseStageAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareApproveRollingReleaseStageRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "ApproveRollingReleaseStageAsync",
                                pathTemplate: "$\"/v1/projects/{idOrName}/rolling-release/approve-stage\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessApproveRollingReleaseStageResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessApproveRollingReleaseStageResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::Vercel.ApproveRollingReleaseStageResponse.FromJson(__content, JsonSerializerContext) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::Vercel.ApproveRollingReleaseStageResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.ApproveRollingReleaseStageResponse> ApproveRollingReleaseStageAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Vercel.ApproveRollingReleaseStageRequest
            {
                NextStageIndex = nextStageIndex,
                CanaryDeploymentId = canaryDeploymentId,
            };

            return await ApproveRollingReleaseStageAsync(
                idOrName: idOrName,
                teamId: teamId,
                slug: slug,
                request: __request,
