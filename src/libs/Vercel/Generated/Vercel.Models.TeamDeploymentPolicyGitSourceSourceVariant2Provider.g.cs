...
namespace Vercel
{
    ...
    public static class TeamDeploymentPolicyGitSourceSourceVariant2ProviderExtensions
    {
        ...
        public static string ToValueString(this TeamDeploymentPolicyGitSourceSourceVariant2Provider value)
        {
            return value switch
            {
                TeamDeploymentPolicyGitSourceSourceVariant2Provider.Bitbucket => "bitbucket",
                TeamDeploymentPolicyGitSourceSourceVariant2Provider.Github => "github",
        ...
        public static TeamDeploymentPolicyGitSourceSourceVariant2Provider? ToEnum(string value)
        {
            return value switch
            {
                "bitbucket" => TeamDeploymentPolicyGitSourceSourceVariant2Provider.Bitbucket,
                "github" => TeamDeploymentPolicyGitSourceSourceVariant2Provider.Github,
