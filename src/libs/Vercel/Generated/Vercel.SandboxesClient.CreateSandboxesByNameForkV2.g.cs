...
namespace Vercel
{
    public partial class SandboxesClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_CreateSandboxesByNameForkV2SecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_CreateSandboxesByNameForkV2SecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_CreateSandboxesByNameForkV2SecurityRequirement0,
            };
        partial void PrepareCreateSandboxesByNameForkV2Arguments(
        ...
        partial void PrepareCreateSandboxesByNameForkV2Request(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? slug,
            global::Vercel.CreateSandboxesByNameForkV2Request request);
        partial void ProcessCreateSandboxesByNameForkV2Response(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateSandboxesByNameForkV2ResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.CreateSandboxesByNameForkV2Response> CreateSandboxesByNameForkV2Async(
            string name,
        ...
        {
            var __response = await CreateSandboxesByNameForkV2AsResponseAsync(
                name: name,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.CreateSandboxesByNameForkV2Response>> CreateSandboxesByNameForkV2AsResponseAsync(
            string name,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateSandboxesByNameForkV2Arguments(
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateSandboxesByNameForkV2SecurityRequirements,
                operationName: "CreateSandboxesByNameForkV2Async");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateSandboxesByNameForkV2Request(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CreateSandboxesByNameForkV2",
                                methodName: "CreateSandboxesByNameForkV2Async",
                                pathTemplate: "$\"/v2/sandboxes/{name}/fork\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateSandboxesByNameForkV2Response(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateSandboxesByNameForkV2ResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vercel.CreateSandboxesByNameForkV2Response.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vercel.AutoSDKHttpResponse<global::Vercel.CreateSandboxesByNameForkV2Response>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vercel.CreateSandboxesByNameForkV2Response.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.CreateSandboxesByNameForkV2Response> CreateSandboxesByNameForkV2Async(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Vercel.CreateSandboxesByNameForkV2Request
            {
            ...
            return await CreateSandboxesByNameForkV2Async(
                name: name,
                projectId: projectId,
                teamId: teamId,
                slug: slug,
