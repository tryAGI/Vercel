...
namespace Vercel
{
    ...
    public sealed partial class CancelDeploymentResponseProjectSettingsWebAnalytics
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CancelDeploymentResponseProjectSettingsWebAnalytics" /> class.
        /// </summary>
        /// <param name="id"></param>
...
#endif
        public CancelDeploymentResponseProjectSettingsWebAnalytics(
            string id,
            double? disabledAt,
            double? canceledAt,
            double? enabledAt,
