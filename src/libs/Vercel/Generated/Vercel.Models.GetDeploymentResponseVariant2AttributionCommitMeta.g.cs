...
namespace Vercel
{
    ...
    public sealed partial class GetDeploymentResponseVariant2AttributionCommitMeta
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetDeploymentResponseVariant2AttributionCommitMeta" /> class.
        /// </summary>
        /// <param name="email">
        /// Email from git commit author
        /// </param>
...
#endif
        public GetDeploymentResponseVariant2AttributionCommitMeta(
            string? email,
            string? name,
            bool? isVerified)
        {
