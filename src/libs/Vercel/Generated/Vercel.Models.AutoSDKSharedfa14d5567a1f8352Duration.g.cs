...
namespace Vercel
{
    ...
    ///
    /// </summary>
    public sealed partial class AutoSDKSharedfa14d5567a1f8352Duration
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AutoSDKSharedfa14d5567a1f8352Duration" /> class.
        /// </summary>
        /// <param name="endTime">
        /// Unix timestamp in milliseconds when the build container exited.
        /// </param>
...
#endif
        public AutoSDKSharedfa14d5567a1f8352Duration(
            double? endTime,
