...
namespace Vercel
{
    ...
    public sealed partial class GetProjectsResponseVariant2ProjectSecurityFirewallRouteSrc
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetProjectsResponseVariant2ProjectSecurityFirewallRouteSrc" /> class.
        /// </summary>
        /// <param name="re"></param>
        /// <param name="eq"></param>
...
#endif
        public GetProjectsResponseVariant2ProjectSecurityFirewallRouteSrc(
            string? re,
            string? eq,
            string? neq,
