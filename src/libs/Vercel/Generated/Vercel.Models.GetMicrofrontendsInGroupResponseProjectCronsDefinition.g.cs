...
namespace Vercel
{
    ...
    public sealed partial class GetMicrofrontendsInGroupResponseProjectCronsDefinition
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Vercel.JsonConverters.GetMicrofrontendsInGroupResponseProjectCronsDefinitionSourceJsonConverter))]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetMicrofrontendsInGroupResponseProjectCronsDefinition" /> class.
        /// </summary>
        /// <param name="host">
        /// The hostname that should be used.<br/>
        /// Example: vercel.com
...
#endif
        public GetMicrofrontendsInGroupResponseProjectCronsDefinition(
            string host,
            string path,
            string schedule,
