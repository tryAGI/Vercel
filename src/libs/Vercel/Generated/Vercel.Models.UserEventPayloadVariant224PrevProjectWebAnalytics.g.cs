...
namespace Vercel
{
    ...
    public sealed partial class UserEventPayloadVariant224PrevProjectWebAnalytics
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UserEventPayloadVariant224PrevProjectWebAnalytics" /> class.
        /// </summary>
        /// <param name="id"></param>
...
#endif
        public UserEventPayloadVariant224PrevProjectWebAnalytics(
            string id,
            double? disabledAt,
            double? canceledAt,
            double? enabledAt,
