    ...
    public static class UserEventTypeExtensions
    {
        ...
        public static string ToValueString(this UserEventType value)
        {
            return value switch
            {
                ...
                UserEventType.AdminTeamSlugUpdate => "admin-team-slug-update",
                UserEventType.AdminUserDelete => "admin-user-delete",
                UserEventType.AdminUserPrimaryEmailUpdated => "admin-user-primary-email-updated",
                UserEventType.AdminUsernameUpdated => "admin-username-updated",
                ...
                UserEventType.AiGatewayAutoReloadUpdated => "ai-gateway-auto-reload-updated",
                UserEventType.AiGatewayBudgetDefaultUpdated => "ai-gateway-budget-default-updated",
                ...
                UserEventType.AiGatewayByokModelMappingsUpdated => "ai-gateway-byok-model-mappings-updated",
                UserEventType.AiGatewayCreditsPurchased => "ai-gateway-credits-purchased",
                UserEventType.AiGatewayGuardrailsUpdated => "ai-gateway-guardrails-updated",
                UserEventType.AiGatewayHipaaComplianceToggled => "ai-gateway-hipaa-compliance-toggled",
                UserEventType.AiGatewayInferenceRegionsUpdated => "ai-gateway-inference-regions-updated",
                ...
                UserEventType.AiGatewayModelCatalogAlertSettingsUpdated => "ai-gateway-model-catalog-alert-settings-updated",
                ...
                UserEventType.AiGatewayPromptTrainingOptOutToggled => "ai-gateway-prompt-training-opt-out-toggled",
                ...
                UserEventType.AiGatewayVirtualModelConfigDeleted => "ai-gateway-virtual-model-config-deleted",
                ...
                UserEventType.AiGatewayZeroDataRetentionToggled => "ai-gateway-zero-data-retention-toggled",
                ...
                UserEventType.BillingSettingsUpdated => "billing-settings-updated",
                ...
                UserEventType.CodeOwnersConfigUpdated => "code-owners-config-updated",
                UserEventType.ComplianceDocumentDownloaded => "compliance-document-downloaded",
                UserEventType.ComplianceDocumentPreviewed => "compliance-document-previewed",
                UserEventType.ComplianceDocumentsBulkDownloaded => "compliance-documents-bulk-downloaded",
                ...
                UserEventType.CustomMetricMetadataDeleted => "custom-metric-metadata-deleted",
                UserEventType.CustomMetricMetadataUpdated => "custom-metric-metadata-updated",
                ...
                UserEventType.DefaultPasswordProtection => "default-password-protection",
                UserEventType.DefaultSsoProtection => "default-sso-protection",
                ...
                UserEventType.DeploymentProtectionAccessRequests => "deployment-protection-access-requests",
                ...
                UserEventType.EnforceDisjunctiveProductionSecrets => "enforce-disjunctive-production-secrets",
                ...
                UserEventType.ExperimentDeleted => "experiment-deleted",
                ...
                UserEventType.FlatRateCdnAutoUpgradeConsent => "flat-rate-cdn-auto-upgrade-consent",
                UserEventType.GitIntegrationRepoPush => "git-integration-repo-push",
                UserEventType.GitAccountIntegrationLinkAdded => "git_account_integration_link_added",
                UserEventType.GlobalConfigBackupRestored => "global-config-backup-restored",
                UserEventType.GlobalConfigCreated => "global-config-created",
                UserEventType.GlobalConfigDeleted => "global-config-deleted",
                UserEventType.GlobalConfigItemsUpdated => "global-config-items-updated",
                UserEventType.GlobalConfigSchemaDeleted => "global-config-schema-deleted",
                UserEventType.GlobalConfigSchemaUpdated => "global-config-schema-updated",
                UserEventType.GlobalConfigTokenCreated => "global-config-token-created",
                UserEventType.GlobalConfigTokenDeleted => "global-config-token-deleted",
                UserEventType.GlobalConfigTransferIn => "global-config-transfer-in",
                UserEventType.GlobalConfigTransferOut => "global-config-transfer-out",
                UserEventType.GlobalConfigUpdated => "global-config-updated",
                UserEventType.InstantRollbackCreated => "instant-rollback-created",
                UserEventType.IntegrationConfigurationCredentialRevoked => "integration-configuration-credential-revoked",
                UserEventType.IntegrationConfigurationCredentialRotated => "integration-configuration-credential-rotated",
                ...
                UserEventType.IntegrationResourceRedisCommandExecuted => "integration-resource-redis-command-executed",
                ...
                UserEventType.KmsIssuerKeyRevoked => "kms-issuer-key-revoked",
                ...
                UserEventType.LoginConnectionLinked => "login-connection-linked",
                UserEventType.LoginConnectionUnlinked => "login-connection-unlinked",
                UserEventType.ManualDeploymentPromotionCreated => "manual-deployment-promotion-created",
                UserEventType.MarketplaceAutoCardCollectionUpdated => "marketplace-auto-card-collection-updated",
                ...
                UserEventType.OrganizationSsoEnforced => "organization-sso-enforced",
                UserEventType.OrganizationTeamAdd => "organization-team-add",
                UserEventType.OrganizationTeamCreate => "organization-team-create",
                UserEventType.OrganizationTeamDelete => "organization-team-delete",
                UserEventType.OrganizationTeamSsoUpdate => "organization-team-sso-update",
                UserEventType.OrganizationUpdateAccountFlowDismissed => "organization-update-account-flow-dismissed",
                UserEventType.OrganizationUpdateAccountFlowTriggered => "organization-update-account-flow-triggered",
                ...
                UserEventType.PageIntegrityScriptApprovalRuleCreated => "page-integrity-script-approval-rule-created",
                UserEventType.PageIntegrityScriptApprovalRuleDeleted => "page-integrity-script-approval-rule-deleted",
                ...
                UserEventType.ProjectCustomEnvironmentSchedulesDefaultUpdated => "project-custom-environment-schedules-default-updated",
                ...
                UserEventType.ProjectGitCredentialBoundCreated => "project-git-credential-bound-created",
                UserEventType.ProjectGitCredentialBoundDeleted => "project-git-credential-bound-deleted",
                UserEventType.ProjectGitCredentialBoundUpdated => "project-git-credential-bound-updated",
                UserEventType.ProjectGitCredentialGrantCreated => "project-git-credential-grant-created",
                UserEventType.ProjectGitCredentialGrantDeleted => "project-git-credential-grant-deleted",
                UserEventType.ProjectGitCredentialGrantUpdated => "project-git-credential-grant-updated",
                ...
                UserEventType.ProjectSandboxConfigUpdated => "project-sandbox-config-updated",
                ...
                UserEventType.ProjectSpeedInsightsFreeDataStarted => "project-speed-insights-free-data-started",
                ...
                UserEventType.RepositoryCiEnvVariableCreate => "repository-ci-env-variable-create",
                UserEventType.RepositoryCiEnvVariableDelete => "repository-ci-env-variable-delete",
                UserEventType.RepositoryCiEnvVariableUpdate => "repository-ci-env-variable-update",
                UserEventType.RuntimeCachePurgeAll => "runtime-cache-purge-all",
                UserEventType.SamlConnectionCreated => "saml-connection-created",
                ...
                UserEventType.SharedEnvVariableRepoLink => "shared-env-variable-repo-link",
                UserEventType.SharedEnvVariableRepoUnlink => "shared-env-variable-repo-unlink",
                ...
                UserEventType.StrictConnectors => "strict-connectors",
                ...
                UserEventType.SupportSessionCreated => "support-session-created",
                UserEventType.Team => "team",
                UserEventType.TeamAgentBillingMigrationDecisionChanged => "team-agent-billing-migration-decision-changed",
                UserEventType.TeamAvatarUpdate => "team-avatar-update",
                UserEventType.TeamCollaborationSettingsUpdated => "team-collaboration-settings-updated",
                ...
                UserEventType.TracingPaused => "tracing-paused",
                UserEventType.TracingResumed => "tracing-resumed",
                UserEventType.UnlinkLoginConnection => "unlink-login-connection",
                UserEventType.UpdateAccountFlowDismissed => "update-account-flow-dismissed",
                UserEventType.UpdateAccountFlowTriggered => "update-account-flow-triggered",
                UserEventType.UserAutoBlockConfigured => "user-auto-block-configured",
                UserEventType.UserBlocked => "user-blocked",
                UserEventType.UserDelete => "user-delete",
                UserEventType.UserDeleteRequested => "user-delete-requested",
                ...
                UserEventType.UserMfaChallengeInitiated => "user-mfa-challenge-initiated",
                ...
                UserEventType.UserMfaRecoveryCodeUsed => "user-mfa-recovery-code-used",
                ...
                UserEventType.UserPhoneRemoved => "user-phone-removed",
                UserEventType.UserPhoneUpdated => "user-phone-updated",
                UserEventType.UserPrimaryEmailUpdated => "user-primary-email-updated",
                UserEventType.UserProviderEmailClaimEvaluated => "user-provider-email-claim-evaluated",
                UserEventType.UserSudoModeRemoved => "user-sudo-mode-removed",
                ...
                UserEventType.UserUnblocked => "user-unblocked",
        ...
        public static UserEventType? ToEnum(string value)
        {
            return value switch
            {
                ...
                "admin-team-slug-update" => UserEventType.AdminTeamSlugUpdate,
                "admin-user-delete" => UserEventType.AdminUserDelete,
                "admin-user-primary-email-updated" => UserEventType.AdminUserPrimaryEmailUpdated,
                "admin-username-updated" => UserEventType.AdminUsernameUpdated,
                ...
                "ai-gateway-auto-reload-updated" => UserEventType.AiGatewayAutoReloadUpdated,
                "ai-gateway-budget-default-updated" => UserEventType.AiGatewayBudgetDefaultUpdated,
                ...
                "ai-gateway-byok-model-mappings-updated" => UserEventType.AiGatewayByokModelMappingsUpdated,
                "ai-gateway-credits-purchased" => UserEventType.AiGatewayCreditsPurchased,
                "ai-gateway-guardrails-updated" => UserEventType.AiGatewayGuardrailsUpdated,
                "ai-gateway-hipaa-compliance-toggled" => UserEventType.AiGatewayHipaaComplianceToggled,
                "ai-gateway-inference-regions-updated" => UserEventType.AiGatewayInferenceRegionsUpdated,
                ...
                "ai-gateway-model-catalog-alert-settings-updated" => UserEventType.AiGatewayModelCatalogAlertSettingsUpdated,
                ...
                "ai-gateway-prompt-training-opt-out-toggled" => UserEventType.AiGatewayPromptTrainingOptOutToggled,
                ...
                "ai-gateway-virtual-model-config-deleted" => UserEventType.AiGatewayVirtualModelConfigDeleted,
                ...
                "ai-gateway-zero-data-retention-toggled" => UserEventType.AiGatewayZeroDataRetentionToggled,
                ...
                "billing-settings-updated" => UserEventType.BillingSettingsUpdated,
                ...
                "code-owners-config-updated" => UserEventType.CodeOwnersConfigUpdated,
                "compliance-document-downloaded" => UserEventType.ComplianceDocumentDownloaded,
                "compliance-document-previewed" => UserEventType.ComplianceDocumentPreviewed,
                "compliance-documents-bulk-downloaded" => UserEventType.ComplianceDocumentsBulkDownloaded,
                ...
                "custom-metric-metadata-deleted" => UserEventType.CustomMetricMetadataDeleted,
                "custom-metric-metadata-updated" => UserEventType.CustomMetricMetadataUpdated,
                ...
                "default-password-protection" => UserEventType.DefaultPasswordProtection,
                "default-sso-protection" => UserEventType.DefaultSsoProtection,
                ...
                "deployment-protection-access-requests" => UserEventType.DeploymentProtectionAccessRequests,
                ...
                "enforce-disjunctive-production-secrets" => UserEventType.EnforceDisjunctiveProductionSecrets,
                ...
                "experiment-deleted" => UserEventType.ExperimentDeleted,
                ...
                "flat-rate-cdn-auto-upgrade-consent" => UserEventType.FlatRateCdnAutoUpgradeConsent,
                "git-integration-repo-push" => UserEventType.GitIntegrationRepoPush,
                "git_account_integration_link_added" => UserEventType.GitAccountIntegrationLinkAdded,
                "global-config-backup-restored" => UserEventType.GlobalConfigBackupRestored,
                "global-config-created" => UserEventType.GlobalConfigCreated,
                "global-config-deleted" => UserEventType.GlobalConfigDeleted,
                "global-config-items-updated" => UserEventType.GlobalConfigItemsUpdated,
                "global-config-schema-deleted" => UserEventType.GlobalConfigSchemaDeleted,
                "global-config-schema-updated" => UserEventType.GlobalConfigSchemaUpdated,
                "global-config-token-created" => UserEventType.GlobalConfigTokenCreated,
                "global-config-token-deleted" => UserEventType.GlobalConfigTokenDeleted,
                "global-config-transfer-in" => UserEventType.GlobalConfigTransferIn,
                "global-config-transfer-out" => UserEventType.GlobalConfigTransferOut,
                "global-config-updated" => UserEventType.GlobalConfigUpdated,
                "instant-rollback-created" => UserEventType.InstantRollbackCreated,
                "integration-configuration-credential-revoked" => UserEventType.IntegrationConfigurationCredentialRevoked,
                "integration-configuration-credential-rotated" => UserEventType.IntegrationConfigurationCredentialRotated,
                ...
                "integration-resource-redis-command-executed" => UserEventType.IntegrationResourceRedisCommandExecuted,
                ...
                "kms-issuer-key-revoked" => UserEventType.KmsIssuerKeyRevoked,
                ...
                "login-connection-linked" => UserEventType.LoginConnectionLinked,
                "login-connection-unlinked" => UserEventType.LoginConnectionUnlinked,
                "manual-deployment-promotion-created" => UserEventType.ManualDeploymentPromotionCreated,
                "marketplace-auto-card-collection-updated" => UserEventType.MarketplaceAutoCardCollectionUpdated,
                ...
                "organization-sso-enforced" => UserEventType.OrganizationSsoEnforced,
                "organization-team-add" => UserEventType.OrganizationTeamAdd,
                "organization-team-create" => UserEventType.OrganizationTeamCreate,
                "organization-team-delete" => UserEventType.OrganizationTeamDelete,
                "organization-team-sso-update" => UserEventType.OrganizationTeamSsoUpdate,
                "organization-update-account-flow-dismissed" => UserEventType.OrganizationUpdateAccountFlowDismissed,
                "organization-update-account-flow-triggered" => UserEventType.OrganizationUpdateAccountFlowTriggered,
                ...
                "page-integrity-script-approval-rule-created" => UserEventType.PageIntegrityScriptApprovalRuleCreated,
                "page-integrity-script-approval-rule-deleted" => UserEventType.PageIntegrityScriptApprovalRuleDeleted,
                ...
                "project-custom-environment-schedules-default-updated" => UserEventType.ProjectCustomEnvironmentSchedulesDefaultUpdated,
                ...
                "project-git-credential-bound-created" => UserEventType.ProjectGitCredentialBoundCreated,
                "project-git-credential-bound-deleted" => UserEventType.ProjectGitCredentialBoundDeleted,
                "project-git-credential-bound-updated" => UserEventType.ProjectGitCredentialBoundUpdated,
                "project-git-credential-grant-created" => UserEventType.ProjectGitCredentialGrantCreated,
                "project-git-credential-grant-deleted" => UserEventType.ProjectGitCredentialGrantDeleted,
                "project-git-credential-grant-updated" => UserEventType.ProjectGitCredentialGrantUpdated,
                ...
                "project-sandbox-config-updated" => UserEventType.ProjectSandboxConfigUpdated,
                ...
                "project-speed-insights-free-data-started" => UserEventType.ProjectSpeedInsightsFreeDataStarted,
                ...
                "repository-ci-env-variable-create" => UserEventType.RepositoryCiEnvVariableCreate,
                "repository-ci-env-variable-delete" => UserEventType.RepositoryCiEnvVariableDelete,
                "repository-ci-env-variable-update" => UserEventType.RepositoryCiEnvVariableUpdate,
                "runtime-cache-purge-all" => UserEventType.RuntimeCachePurgeAll,
                "saml-connection-created" => UserEventType.SamlConnectionCreated,
                ...
                "shared-env-variable-repo-link" => UserEventType.SharedEnvVariableRepoLink,
                "shared-env-variable-repo-unlink" => UserEventType.SharedEnvVariableRepoUnlink,
                ...
                "strict-connectors" => UserEventType.StrictConnectors,
                ...
                "support-session-created" => UserEventType.SupportSessionCreated,
                "team" => UserEventType.Team,
                "team-agent-billing-migration-decision-changed" => UserEventType.TeamAgentBillingMigrationDecisionChanged,
                "team-avatar-update" => UserEventType.TeamAvatarUpdate,
                "team-collaboration-settings-updated" => UserEventType.TeamCollaborationSettingsUpdated,
                ...
                "tracing-paused" => UserEventType.TracingPaused,
                "tracing-resumed" => UserEventType.TracingResumed,
                "unlink-login-connection" => UserEventType.UnlinkLoginConnection,
                "update-account-flow-dismissed" => UserEventType.UpdateAccountFlowDismissed,
                "update-account-flow-triggered" => UserEventType.UpdateAccountFlowTriggered,
                "user-auto-block-configured" => UserEventType.UserAutoBlockConfigured,
                "user-blocked" => UserEventType.UserBlocked,
                "user-delete" => UserEventType.UserDelete,
                "user-delete-requested" => UserEventType.UserDeleteRequested,
                ...
                "user-mfa-challenge-initiated" => UserEventType.UserMfaChallengeInitiated,
                ...
                "user-mfa-recovery-code-used" => UserEventType.UserMfaRecoveryCodeUsed,
                ...
                "user-phone-removed" => UserEventType.UserPhoneRemoved,
                "user-phone-updated" => UserEventType.UserPhoneUpdated,
                "user-primary-email-updated" => UserEventType.UserPrimaryEmailUpdated,
                "user-provider-email-claim-evaluated" => UserEventType.UserProviderEmailClaimEvaluated,
                "user-sudo-mode-removed" => UserEventType.UserSudoModeRemoved,
                ...
                "user-unblocked" => UserEventType.UserUnblocked,
