...
namespace Vercel
{
    public partial class VcrClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_ListRepositoryTagsSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_ListRepositoryTagsSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_ListRepositoryTagsSecurityRequirement0,
            };
        partial void PrepareListRepositoryTagsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string projectId,
            ref string idOrName,
            ref int? limit,
            ref string? cursor,
            ref global::Vercel.ListRepositoryTagsSortBy? sortBy,
            ref global::Vercel.ListRepositoryTagsSortOrder? sortOrder,
            ref string? teamId,
            ref string? slug);
        partial void PrepareListRepositoryTagsRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            int? limit,
            string? cursor,
            global::Vercel.ListRepositoryTagsSortBy? sortBy,
            global::Vercel.ListRepositoryTagsSortOrder? sortOrder,
            string? teamId,
            string? slug);
        partial void ProcessListRepositoryTagsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessListRepositoryTagsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.ListRepositoryTagsResponse> ListRepositoryTagsAsync(
            string projectId,
            string idOrName,
            int? limit = default,
        ...
        {
            var __response = await ListRepositoryTagsAsResponseAsync(
                projectId: projectId,
                idOrName: idOrName,
                limit: limit,
                cursor: cursor,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.ListRepositoryTagsResponse>> ListRepositoryTagsAsResponseAsync(
            string projectId,
            string idOrName,
            int? limit = default,
            string? cursor = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareListRepositoryTagsArguments(
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ListRepositoryTagsSecurityRequirements,
                operationName: "ListRepositoryTagsAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Vercel.PathBuilder(
                                path: $"/v1/vcr/repository/{idOrName}/tags",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareListRepositoryTagsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "ListRepositoryTagsAsync",
                                pathTemplate: "$\"/v1/vcr/repository/{idOrName}/tags\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessListRepositoryTagsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListRepositoryTagsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vercel.ListRepositoryTagsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vercel.AutoSDKHttpResponse<global::Vercel.ListRepositoryTagsResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vercel.ListRepositoryTagsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
