...
namespace Vercel
{
    public partial class DomainsRegistrarClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_UpdateDomainNameserversSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_UpdateDomainNameserversSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_UpdateDomainNameserversSecurityRequirement0,
            };
        partial void PrepareUpdateDomainNameserversArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string domain,
            ref string? teamId,
            global::Vercel.UpdateDomainNameserversRequest request);
        partial void PrepareUpdateDomainNameserversRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string domain,
            string? teamId,
            global::Vercel.UpdateDomainNameserversRequest request);
        partial void ProcessUpdateDomainNameserversResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        /// <summary>
        /// Update nameservers for a domain<br/>
        ...
        public async global::System.Threading.Tasks.Task UpdateDomainNameserversAsync(
            string domain,
        ...
        {
            await UpdateDomainNameserversAsResponseAsync(
                domain: domain,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse> UpdateDomainNameserversAsResponseAsync(
            string domain,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUpdateDomainNameserversArguments(
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UpdateDomainNameserversSecurityRequirements,
                operationName: "UpdateDomainNameserversAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareUpdateDomainNameserversRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "UpdateDomainNameserversAsync",
                                pathTemplate: "$\"/v1/registrar/domains/{domain}/nameservers\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUpdateDomainNameserversResponse(
                    httpClient: HttpClient,
        ...
        public async global::System.Threading.Tasks.Task UpdateDomainNameserversAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Vercel.UpdateDomainNameserversRequest
            {
                Nameservers = nameservers,
            };

            await UpdateDomainNameserversAsync(
                domain: domain,
                teamId: teamId,
                request: __request,
                requestOptions: requestOptions,
