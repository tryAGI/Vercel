...
namespace Vercel
{
    public partial class AccessGroupsClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_ReadAccessGroupProjectSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_ReadAccessGroupProjectSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_ReadAccessGroupProjectSecurityRequirement0,
            };
        partial void PrepareReadAccessGroupProjectArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string accessGroupIdOrName,
            ref string projectId,
            ref string? teamId,
            ref string? slug);
        partial void PrepareReadAccessGroupProjectRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? teamId,
            string? slug);
        partial void ProcessReadAccessGroupProjectResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessReadAccessGroupProjectResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.ReadAccessGroupProjectResponse> ReadAccessGroupProjectAsync(
            string accessGroupIdOrName,
            string projectId,
        ...
        {
            var __response = await ReadAccessGroupProjectAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.ReadAccessGroupProjectResponse>> ReadAccessGroupProjectAsResponseAsync(
            string accessGroupIdOrName,
            string projectId,
            string? teamId = default,
            string? slug = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareReadAccessGroupProjectArguments(
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ReadAccessGroupProjectSecurityRequirements,
                operationName: "ReadAccessGroupProjectAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "ReadAccessGroupProjectAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessReadAccessGroupProjectResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessReadAccessGroupProjectResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vercel.ReadAccessGroupProjectResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vercel.AutoSDKHttpResponse<global::Vercel.ReadAccessGroupProjectResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vercel.ReadAccessGroupProjectResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
