...
namespace Vercel
{
    public partial class ChecksV2Client
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_ListDeploymentCheckRunsSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_ListDeploymentCheckRunsSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_ListDeploymentCheckRunsSecurityRequirement0,
            };
        partial void PrepareListDeploymentCheckRunsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string deploymentId,
            ref string? teamId,
            ref string? slug);
        partial void PrepareListDeploymentCheckRunsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string deploymentId,
            string? teamId,
            string? slug);
        partial void ProcessListDeploymentCheckRunsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessListDeploymentCheckRunsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareListDeploymentCheckRunsArguments(
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ListDeploymentCheckRunsSecurityRequirements,
                operationName: "ListDeploymentCheckRunsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareListDeploymentCheckRunsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "ListDeploymentCheckRunsAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessListDeploymentCheckRunsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListDeploymentCheckRunsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::Vercel.ListDeploymentCheckRunsResponse.FromJson(__content, JsonSerializerContext) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::Vercel.ListDeploymentCheckRunsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
