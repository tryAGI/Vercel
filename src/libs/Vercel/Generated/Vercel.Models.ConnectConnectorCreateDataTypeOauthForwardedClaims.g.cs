...
namespace Vercel
{
    ...
    public sealed partial class ConnectConnectorCreateDataTypeOauthForwardedClaims
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ConnectConnectorCreateDataTypeOauthForwardedClaims" /> class.
        /// </summary>
        /// <param name="idToken">
        /// ID token claim names that Connect can expose.
        /// </param>
...
#endif
        public ConnectConnectorCreateDataTypeOauthForwardedClaims(
