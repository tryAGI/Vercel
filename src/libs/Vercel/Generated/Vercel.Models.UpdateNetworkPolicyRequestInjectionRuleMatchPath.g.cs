...
namespace Vercel
{
    ...
    public sealed partial class UpdateNetworkPolicyRequestInjectionRuleMatchPath
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateNetworkPolicyRequestInjectionRuleMatchPath" /> class.
        /// </summary>
        /// <param name="exact">
        /// Match the value exactly. Case-sensitive for paths, header values, and methods; case-insensitive for domains and header keys.
        /// </param>
...
#endif
        public UpdateNetworkPolicyRequestInjectionRuleMatchPath(
            string? exact,
            string? startsWith)
        {
            this.Exact = exact;
