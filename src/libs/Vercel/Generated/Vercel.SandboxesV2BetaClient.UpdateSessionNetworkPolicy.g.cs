...
namespace Vercel
{
    public partial class SandboxesV2BetaClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_UpdateSessionNetworkPolicySecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_UpdateSessionNetworkPolicySecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_UpdateSessionNetworkPolicySecurityRequirement0,
            };
        partial void PrepareUpdateSessionNetworkPolicyArguments(
        ...
        partial void ProcessUpdateSessionNetworkPolicyResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await UpdateSessionNetworkPolicyAsResponseAsync(
                sessionId: sessionId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareUpdateSessionNetworkPolicyArguments(
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UpdateSessionNetworkPolicySecurityRequirements,
                operationName: "UpdateSessionNetworkPolicyAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareUpdateSessionNetworkPolicyRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "UpdateSessionNetworkPolicyAsync",
                                pathTemplate: "$\"/v2/sandboxes/sessions/{sessionId}/network-policy\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUpdateSessionNetworkPolicyResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUpdateSessionNetworkPolicyResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vercel.UpdateSessionNetworkPolicyResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vercel.AutoSDKHttpResponse<global::Vercel.UpdateSessionNetworkPolicyResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vercel.UpdateSessionNetworkPolicyResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await UpdateSessionNetworkPolicyAsync(
                sessionId: sessionId,
                teamId: teamId,
                slug: slug,
                request: __request,
