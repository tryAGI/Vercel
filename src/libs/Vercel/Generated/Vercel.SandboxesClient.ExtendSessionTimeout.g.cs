...
namespace Vercel
{
    public partial class SandboxesClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_ExtendSessionTimeoutSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_ExtendSessionTimeoutSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_ExtendSessionTimeoutSecurityRequirement0,
            };
        partial void PrepareExtendSessionTimeoutArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string sessionId,
            ref string? teamId,
            ref string? slug,
            global::Vercel.ExtendSessionTimeoutRequest request);
        partial void PrepareExtendSessionTimeoutRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? slug,
            global::Vercel.ExtendSessionTimeoutRequest request);
        partial void ProcessExtendSessionTimeoutResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessExtendSessionTimeoutResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.ExtendSessionTimeoutResponse> ExtendSessionTimeoutAsync(
            string sessionId,
        ...
        {
            var __response = await ExtendSessionTimeoutAsResponseAsync(
                sessionId: sessionId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.ExtendSessionTimeoutResponse>> ExtendSessionTimeoutAsResponseAsync(
            string sessionId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareExtendSessionTimeoutArguments(
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ExtendSessionTimeoutSecurityRequirements,
                operationName: "ExtendSessionTimeoutAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareExtendSessionTimeoutRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "ExtendSessionTimeoutAsync",
                                pathTemplate: "$\"/v2/sandboxes/sessions/{sessionId}/extend-timeout\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessExtendSessionTimeoutResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessExtendSessionTimeoutResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vercel.ExtendSessionTimeoutResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vercel.AutoSDKHttpResponse<global::Vercel.ExtendSessionTimeoutResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vercel.ExtendSessionTimeoutResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.ExtendSessionTimeoutResponse> ExtendSessionTimeoutAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Vercel.ExtendSessionTimeoutRequest
            {
                Duration = duration,
            };

            return await ExtendSessionTimeoutAsync(
                sessionId: sessionId,
                teamId: teamId,
                slug: slug,
                request: __request,
