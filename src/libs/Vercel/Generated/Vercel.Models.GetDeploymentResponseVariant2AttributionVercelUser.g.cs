...
namespace Vercel
{
    ...
    public sealed partial class GetDeploymentResponseVariant2AttributionVercelUser
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetDeploymentResponseVariant2AttributionVercelUser" /> class.
        /// </summary>
        /// <param name="id">
        /// Vercel user ID
        /// </param>
...
#endif
        public GetDeploymentResponseVariant2AttributionVercelUser(
            string id,
            string username,
