...
namespace Vercel
{
    ...
    /// </summary>
    public static class TeamLimitedSamlDirectorySyncStateExtensions
    {
        /// <summary>
        /// Converts an enum to a string.
        /// </summary>
        public static string ToValueString(this TeamLimitedSamlDirectorySyncState value)
        {
            return value switch
            {
                TeamLimitedSamlDirectorySyncState.Active => "ACTIVE",
                TeamLimitedSamlDirectorySyncState.Setup => "SETUP",
        ...
        /// </summary>
        public static TeamLimitedSamlDirectorySyncState? ToEnum(string value)
        {
            return value switch
            {
                "ACTIVE" => TeamLimitedSamlDirectorySyncState.Active,
                "SETUP" => TeamLimitedSamlDirectorySyncState.Setup,
                _ => null,
            };
        }
    }
