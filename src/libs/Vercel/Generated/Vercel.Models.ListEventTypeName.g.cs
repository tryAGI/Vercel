    ...
    public static class ListEventTypeNameExtensions
    {
        ...
        public static string ToValueString(this ListEventTypeName value)
        {
            return value switch
            {
                ...
                ListEventTypeName.AdminTeamSlugUpdate => "admin-team-slug-update",
                ListEventTypeName.AdminUserDelete => "admin-user-delete",
                ListEventTypeName.AdminUserPrimaryEmailUpdated => "admin-user-primary-email-updated",
                ListEventTypeName.AdminUsernameUpdated => "admin-username-updated",
                ...
                ListEventTypeName.AiGatewayPrivateProviderCreated => "ai-gateway-private-provider-created",
                ListEventTypeName.AiGatewayPrivateProviderDeleted => "ai-gateway-private-provider-deleted",
                ListEventTypeName.AiGatewayPrivateProviderUpdated => "ai-gateway-private-provider-updated",
                ListEventTypeName.AiGatewayPromptTrainingOptOutToggled => "ai-gateway-prompt-training-opt-out-toggled",
                ListEventTypeName.AiGatewayProviderAllowlistProvidersUpdated => "ai-gateway-provider-allowlist-providers-updated",
                ListEventTypeName.AiGatewayProviderAllowlistToggled => "ai-gateway-provider-allowlist-toggled",
                ...
                ListEventTypeName.AiOmniagent => "ai-omniagent",
                ListEventTypeName.AlertInvestigationProjectAllowlistUpdated => "alert-investigation-project-allowlist-updated",
                ...
                ListEventTypeName.BillingSettingsUpdated => "billing-settings-updated",
                ...
                ListEventTypeName.ConnectCreateConnector => "connect-create-connector",
                ListEventTypeName.ConnectDeleteConnector => "connect-delete-connector",
                ListEventTypeName.ConnectDeleteInstallation => "connect-delete-installation",
                ListEventTypeName.ConnectDetachProject => "connect-detach-project",
                ...
                ListEventTypeName.ConnectImportTokens => "connect-import-tokens",
                ListEventTypeName.ConnectRevokeAllTokens => "connect-revoke-all-tokens",
                ListEventTypeName.ConnectUpdateConnector => "connect-update-connector",
                ListEventTypeName.ConnectUpdateTriggerDestinations => "connect-update-trigger-destinations",
                ListEventTypeName.ConnectUpsertInstallation => "connect-upsert-installation",
                ...
                ListEventTypeName.DefaultPasswordProtection => "default-password-protection",
                ListEventTypeName.DefaultSsoProtection => "default-sso-protection",
                ...
                ListEventTypeName.DeploymentPolicyBlocked => "deployment-policy-blocked",
                ListEventTypeName.DeploymentProtectionAccessRequests => "deployment-protection-access-requests",
                ListEventTypeName.DeploymentUndeleted => "deployment-undeleted",
                ...
                ListEventTypeName.DnsRecordInternal => "dns-record-internal",
                ...
                ListEventTypeName.DomainEchChange => "domain-ech-change",
                ...
                ListEventTypeName.EdgeCacheDangerouslyDeleteImmutableStatic => "edge-cache-dangerously-delete-immutable-static",
                ...
                ListEventTypeName.EmuMemberRemovedUnverifiedDomain => "emu-member-removed-unverified-domain",
                ListEventTypeName.EnforceDisjunctiveProductionSecrets => "enforce-disjunctive-production-secrets",
                ...
                ListEventTypeName.EnvVariableMasked => "env-variable-masked",
                ...
                ListEventTypeName.ExperimentDeleted => "experiment-deleted",
                ...
                ListEventTypeName.IntegrationResourceRedisCommandExecuted => "integration-resource-redis-command-executed",
                ListEventTypeName.IntegrationResourceSqlQueryExecuted => "integration-resource-sql-query-executed",
                ...
                ListEventTypeName.KmsIssuerCreated => "kms-issuer-created",
                ListEventTypeName.KmsIssuerDeleted => "kms-issuer-deleted",
                ListEventTypeName.KmsIssuerKeyActivated => "kms-issuer-key-activated",
                ListEventTypeName.KmsIssuerKeyCreated => "kms-issuer-key-created",
                ListEventTypeName.KmsIssuerKeyRevoked => "kms-issuer-key-revoked",
                ListEventTypeName.KmsIssuerKeyRotated => "kms-issuer-key-rotated",
                ListEventTypeName.KmsIssuerPolicyCreated => "kms-issuer-policy-created",
                ListEventTypeName.KmsIssuerPolicyDeleted => "kms-issuer-policy-deleted",
                ListEventTypeName.KmsIssuerPolicyUpdated => "kms-issuer-policy-updated",
                ListEventTypeName.KmsIssuerUpdated => "kms-issuer-updated",
                ...
                ListEventTypeName.MarketplaceAutoCardCollectionUpdated => "marketplace-auto-card-collection-updated",
                ListEventTypeName.MarketplaceBillingCollectionUpdated => "marketplace-billing-collection-updated",
                ...
                ListEventTypeName.MonitoringAlertUpdated => "monitoring-alert-updated",
                ...
                ListEventTypeName.OrganizationSsoEnforced => "organization-sso-enforced",
                ...
                ListEventTypeName.OrganizationUpdateAccountFlowDismissed => "organization-update-account-flow-dismissed",
                ListEventTypeName.OrganizationUpdateAccountFlowTriggered => "organization-update-account-flow-triggered",
                ...
                ListEventTypeName.PassportAccessGranted => "passport-access-granted",
                ...
                ListEventTypeName.ProjectCustomEnvironmentSchedulesDefaultUpdated => "project-custom-environment-schedules-default-updated",
                ...
                ListEventTypeName.ProjectExpirationReached => "project-expiration-reached",
                ...
                ListEventTypeName.ProjectGitCredentialBoundCreated => "project-git-credential-bound-created",
                ListEventTypeName.ProjectGitCredentialBoundDeleted => "project-git-credential-bound-deleted",
                ListEventTypeName.ProjectGitCredentialBoundUpdated => "project-git-credential-bound-updated",
                ListEventTypeName.ProjectGitCredentialGrantCreated => "project-git-credential-grant-created",
                ListEventTypeName.ProjectGitCredentialGrantDeleted => "project-git-credential-grant-deleted",
                ListEventTypeName.ProjectGitCredentialGrantUpdated => "project-git-credential-grant-updated",
                ...
                ListEventTypeName.ProjectPassportUpdated => "project-passport-updated",
                ...
                ListEventTypeName.ProjectRollbackDescriptionUpdated => "project-rollback-description-updated",
                ...
                ListEventTypeName.RepositoryCiEnvVariableCreate => "repository-ci-env-variable-create",
                ListEventTypeName.RepositoryCiEnvVariableDelete => "repository-ci-env-variable-delete",
                ListEventTypeName.RepositoryCiEnvVariableUpdate => "repository-ci-env-variable-update",
                ListEventTypeName.RuntimeCachePurgeAll => "runtime-cache-purge-all",
                ListEventTypeName.SamlConnectionCreated => "saml-connection-created",
                ListEventTypeName.SamlConnectionDeleted => "saml-connection-deleted",
                ...
                ListEventTypeName.SharedEnvVariableRepoLink => "shared-env-variable-repo-link",
                ListEventTypeName.SharedEnvVariableRepoUnlink => "shared-env-variable-repo-unlink",
                ...
                ListEventTypeName.SupportSessionCreated => "support-session-created",
                ...
                ListEventTypeName.TeamMemberSsoAuthorizationAttempt => "team-member-sso-authorization-attempt",
                ...
                ListEventTypeName.TeamRemoteCachingPurge => "team-remote-caching-purge",
                ...
                ListEventTypeName.UserEmuAccountUpdateOptedIn => "user-emu-account-update-opted-in",
                ListEventTypeName.UserEmuAccountUpdateOptedOut => "user-emu-account-update-opted-out",
                ListEventTypeName.UserEmuRecoveryEmailSent => "user-emu-recovery-email-sent",
                ListEventTypeName.UserEmuRecoveryInitiated => "user-emu-recovery-initiated",
                ListEventTypeName.UserEmuToggled => "user-emu-toggled",
                ListEventTypeName.UserMfaChallengeFailed => "user-mfa-challenge-failed",
                ListEventTypeName.UserMfaChallengeInitiated => "user-mfa-challenge-initiated",
                ...
                ListEventTypeName.UserPhoneRemoved => "user-phone-removed",
                ListEventTypeName.UserPhoneUpdated => "user-phone-updated",
                ListEventTypeName.UserPrimaryEmailUpdated => "user-primary-email-updated",
                ListEventTypeName.UserProviderEmailClaimEvaluated => "user-provider-email-claim-evaluated",
                ListEventTypeName.UserSudoModeRemoved => "user-sudo-mode-removed",
                ...
                ListEventTypeName.UserUnblocked => "user-unblocked",
                ...
                ListEventTypeName.VcrRepositoryPermissionAdded => "vcr-repository-permission-added",
                ListEventTypeName.VcrRepositoryPermissionRemoved => "vcr-repository-permission-removed",
                ListEventTypeName.VcrRepositoryPermissionsCleared => "vcr-repository-permissions-cleared",
                ListEventTypeName.VcrRepositoryVisibilityChanged => "vcr-repository-visibility-changed",
        ...
        public static ListEventTypeName? ToEnum(string value)
        {
            return value switch
            {
                ...
                "admin-team-slug-update" => ListEventTypeName.AdminTeamSlugUpdate,
                "admin-user-delete" => ListEventTypeName.AdminUserDelete,
                "admin-user-primary-email-updated" => ListEventTypeName.AdminUserPrimaryEmailUpdated,
                "admin-username-updated" => ListEventTypeName.AdminUsernameUpdated,
                ...
                "ai-gateway-private-provider-created" => ListEventTypeName.AiGatewayPrivateProviderCreated,
                "ai-gateway-private-provider-deleted" => ListEventTypeName.AiGatewayPrivateProviderDeleted,
                "ai-gateway-private-provider-updated" => ListEventTypeName.AiGatewayPrivateProviderUpdated,
                "ai-gateway-prompt-training-opt-out-toggled" => ListEventTypeName.AiGatewayPromptTrainingOptOutToggled,
                "ai-gateway-provider-allowlist-providers-updated" => ListEventTypeName.AiGatewayProviderAllowlistProvidersUpdated,
                "ai-gateway-provider-allowlist-toggled" => ListEventTypeName.AiGatewayProviderAllowlistToggled,
                ...
                "ai-omniagent" => ListEventTypeName.AiOmniagent,
                "alert-investigation-project-allowlist-updated" => ListEventTypeName.AlertInvestigationProjectAllowlistUpdated,
                ...
                "billing-settings-updated" => ListEventTypeName.BillingSettingsUpdated,
                ...
                "connect-create-connector" => ListEventTypeName.ConnectCreateConnector,
                "connect-delete-connector" => ListEventTypeName.ConnectDeleteConnector,
                "connect-delete-installation" => ListEventTypeName.ConnectDeleteInstallation,
                "connect-detach-project" => ListEventTypeName.ConnectDetachProject,
                ...
                "connect-import-tokens" => ListEventTypeName.ConnectImportTokens,
                "connect-revoke-all-tokens" => ListEventTypeName.ConnectRevokeAllTokens,
                "connect-update-connector" => ListEventTypeName.ConnectUpdateConnector,
                "connect-update-trigger-destinations" => ListEventTypeName.ConnectUpdateTriggerDestinations,
                "connect-upsert-installation" => ListEventTypeName.ConnectUpsertInstallation,
                ...
                "default-password-protection" => ListEventTypeName.DefaultPasswordProtection,
                "default-sso-protection" => ListEventTypeName.DefaultSsoProtection,
                ...
                "deployment-policy-blocked" => ListEventTypeName.DeploymentPolicyBlocked,
                "deployment-protection-access-requests" => ListEventTypeName.DeploymentProtectionAccessRequests,
                "deployment-undeleted" => ListEventTypeName.DeploymentUndeleted,
                ...
                "dns-record-internal" => ListEventTypeName.DnsRecordInternal,
                ...
                "domain-ech-change" => ListEventTypeName.DomainEchChange,
                ...
                "edge-cache-dangerously-delete-immutable-static" => ListEventTypeName.EdgeCacheDangerouslyDeleteImmutableStatic,
                ...
                "emu-member-removed-unverified-domain" => ListEventTypeName.EmuMemberRemovedUnverifiedDomain,
                "enforce-disjunctive-production-secrets" => ListEventTypeName.EnforceDisjunctiveProductionSecrets,
                ...
                "env-variable-masked" => ListEventTypeName.EnvVariableMasked,
                ...
                "experiment-deleted" => ListEventTypeName.ExperimentDeleted,
                ...
                "integration-resource-redis-command-executed" => ListEventTypeName.IntegrationResourceRedisCommandExecuted,
                "integration-resource-sql-query-executed" => ListEventTypeName.IntegrationResourceSqlQueryExecuted,
                ...
                "kms-issuer-created" => ListEventTypeName.KmsIssuerCreated,
                "kms-issuer-deleted" => ListEventTypeName.KmsIssuerDeleted,
                "kms-issuer-key-activated" => ListEventTypeName.KmsIssuerKeyActivated,
                "kms-issuer-key-created" => ListEventTypeName.KmsIssuerKeyCreated,
                "kms-issuer-key-revoked" => ListEventTypeName.KmsIssuerKeyRevoked,
                "kms-issuer-key-rotated" => ListEventTypeName.KmsIssuerKeyRotated,
                "kms-issuer-policy-created" => ListEventTypeName.KmsIssuerPolicyCreated,
                "kms-issuer-policy-deleted" => ListEventTypeName.KmsIssuerPolicyDeleted,
                "kms-issuer-policy-updated" => ListEventTypeName.KmsIssuerPolicyUpdated,
                "kms-issuer-updated" => ListEventTypeName.KmsIssuerUpdated,
                ...
                "marketplace-auto-card-collection-updated" => ListEventTypeName.MarketplaceAutoCardCollectionUpdated,
                "marketplace-billing-collection-updated" => ListEventTypeName.MarketplaceBillingCollectionUpdated,
                ...
                "monitoring-alert-updated" => ListEventTypeName.MonitoringAlertUpdated,
                ...
                "organization-sso-enforced" => ListEventTypeName.OrganizationSsoEnforced,
                ...
                "organization-update-account-flow-dismissed" => ListEventTypeName.OrganizationUpdateAccountFlowDismissed,
                "organization-update-account-flow-triggered" => ListEventTypeName.OrganizationUpdateAccountFlowTriggered,
                ...
                "passport-access-granted" => ListEventTypeName.PassportAccessGranted,
                ...
                "project-custom-environment-schedules-default-updated" => ListEventTypeName.ProjectCustomEnvironmentSchedulesDefaultUpdated,
                ...
                "project-expiration-reached" => ListEventTypeName.ProjectExpirationReached,
                ...
                "project-git-credential-bound-created" => ListEventTypeName.ProjectGitCredentialBoundCreated,
                "project-git-credential-bound-deleted" => ListEventTypeName.ProjectGitCredentialBoundDeleted,
                "project-git-credential-bound-updated" => ListEventTypeName.ProjectGitCredentialBoundUpdated,
                "project-git-credential-grant-created" => ListEventTypeName.ProjectGitCredentialGrantCreated,
                "project-git-credential-grant-deleted" => ListEventTypeName.ProjectGitCredentialGrantDeleted,
                "project-git-credential-grant-updated" => ListEventTypeName.ProjectGitCredentialGrantUpdated,
                ...
                "project-passport-updated" => ListEventTypeName.ProjectPassportUpdated,
                ...
                "project-rollback-description-updated" => ListEventTypeName.ProjectRollbackDescriptionUpdated,
                ...
                "repository-ci-env-variable-create" => ListEventTypeName.RepositoryCiEnvVariableCreate,
                "repository-ci-env-variable-delete" => ListEventTypeName.RepositoryCiEnvVariableDelete,
                "repository-ci-env-variable-update" => ListEventTypeName.RepositoryCiEnvVariableUpdate,
                "runtime-cache-purge-all" => ListEventTypeName.RuntimeCachePurgeAll,
                "saml-connection-created" => ListEventTypeName.SamlConnectionCreated,
                "saml-connection-deleted" => ListEventTypeName.SamlConnectionDeleted,
                ...
                "shared-env-variable-repo-link" => ListEventTypeName.SharedEnvVariableRepoLink,
                "shared-env-variable-repo-unlink" => ListEventTypeName.SharedEnvVariableRepoUnlink,
                ...
                "support-session-created" => ListEventTypeName.SupportSessionCreated,
                ...
                "team-member-sso-authorization-attempt" => ListEventTypeName.TeamMemberSsoAuthorizationAttempt,
                ...
                "team-remote-caching-purge" => ListEventTypeName.TeamRemoteCachingPurge,
                ...
                "user-emu-account-update-opted-in" => ListEventTypeName.UserEmuAccountUpdateOptedIn,
                "user-emu-account-update-opted-out" => ListEventTypeName.UserEmuAccountUpdateOptedOut,
                "user-emu-recovery-email-sent" => ListEventTypeName.UserEmuRecoveryEmailSent,
                "user-emu-recovery-initiated" => ListEventTypeName.UserEmuRecoveryInitiated,
                "user-emu-toggled" => ListEventTypeName.UserEmuToggled,
                "user-mfa-challenge-failed" => ListEventTypeName.UserMfaChallengeFailed,
                "user-mfa-challenge-initiated" => ListEventTypeName.UserMfaChallengeInitiated,
                ...
                "user-phone-removed" => ListEventTypeName.UserPhoneRemoved,
                "user-phone-updated" => ListEventTypeName.UserPhoneUpdated,
                "user-primary-email-updated" => ListEventTypeName.UserPrimaryEmailUpdated,
                "user-provider-email-claim-evaluated" => ListEventTypeName.UserProviderEmailClaimEvaluated,
                "user-sudo-mode-removed" => ListEventTypeName.UserSudoModeRemoved,
                ...
                "user-unblocked" => ListEventTypeName.UserUnblocked,
                ...
                "vcr-repository-permission-added" => ListEventTypeName.VcrRepositoryPermissionAdded,
                "vcr-repository-permission-removed" => ListEventTypeName.VcrRepositoryPermissionRemoved,
                "vcr-repository-permissions-cleared" => ListEventTypeName.VcrRepositoryPermissionsCleared,
                "vcr-repository-visibility-changed" => ListEventTypeName.VcrRepositoryVisibilityChanged,
