...
namespace Vercel
{
    ...
    public sealed partial class GetProjectsResponseVariant2ProjectAliaDeploymentCreator
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetProjectsResponseVariant2ProjectAliaDeploymentCreator" /> class.
        /// </summary>
...
#endif
        public GetProjectsResponseVariant2ProjectAliaDeploymentCreator(
            string email,
            string uid,
            string username,
            string? githubLogin,
