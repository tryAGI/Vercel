...
namespace Vercel
{
    public partial class EdgeCacheClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_InvalidateByTagsSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_InvalidateByTagsSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_InvalidateByTagsSecurityRequirement0,
            };
        partial void PrepareInvalidateByTagsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string projectIdOrName,
            ref string? teamId,
            ref string? slug,
            global::Vercel.InvalidateByTagsRequest request);
        partial void PrepareInvalidateByTagsRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? slug,
            global::Vercel.InvalidateByTagsRequest request);
        partial void ProcessInvalidateByTagsResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task InvalidateByTagsAsync(
            string projectIdOrName,
        ...
        {
            await InvalidateByTagsAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse> InvalidateByTagsAsResponseAsync(
            string projectIdOrName,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareInvalidateByTagsArguments(
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_InvalidateByTagsSecurityRequirements,
                operationName: "InvalidateByTagsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareInvalidateByTagsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "InvalidateByTagsAsync",
                                pathTemplate: "\"/v1/edge-cache/invalidate-by-tags\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessInvalidateByTagsResponse(
                    httpClient: HttpClient,
        ...
        public async global::System.Threading.Tasks.Task InvalidateByTagsAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Vercel.InvalidateByTagsRequest
            {
                Tags = tags,
                Target = target,
            };

            await InvalidateByTagsAsync(
                projectIdOrName: projectIdOrName,
                teamId: teamId,
                slug: slug,
                request: __request,
