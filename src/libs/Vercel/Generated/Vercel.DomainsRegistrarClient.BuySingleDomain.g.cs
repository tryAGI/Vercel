...
namespace Vercel
{
    public partial class DomainsRegistrarClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_BuySingleDomainSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_BuySingleDomainSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_BuySingleDomainSecurityRequirement0,
            };
        partial void PrepareBuySingleDomainArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string domain,
            ref string? teamId,
            global::Vercel.BuySingleDomainRequest request);
        partial void PrepareBuySingleDomainRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string domain,
            string? teamId,
            global::Vercel.BuySingleDomainRequest request);
        partial void ProcessBuySingleDomainResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessBuySingleDomainResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.BuySingleDomainResponse> BuySingleDomainAsync(
            string domain,
        ...
        {
            var __response = await BuySingleDomainAsResponseAsync(
                domain: domain,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.BuySingleDomainResponse>> BuySingleDomainAsResponseAsync(
            string domain,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareBuySingleDomainArguments(
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_BuySingleDomainSecurityRequirements,
                operationName: "BuySingleDomainAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "BuySingleDomainAsync",
                                pathTemplate: "$\"/v1/registrar/domains/{domain}/buy\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessBuySingleDomainResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                global::Vercel.AnyOf<global::Vercel.DomainTooShort, global::Vercel.OrderTooExpensive, global::Vercel.InvalidAdditionalContactInfo, global::Vercel.AdditionalContactInfoRequired, global::Vercel.ExpectedPriceMismatch, global::Vercel.DomainNotAvailable, global::Vercel.EmojiTldNotSupported, global::Vercel.LanguageCodeRequired, global::Vercel.TldNotSupported, global::Vercel.HttpApiDecodeError>? __value_400 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_400 = global::Vercel.AnyOf<global::Vercel.DomainTooShort, global::Vercel.OrderTooExpensive, global::Vercel.InvalidAdditionalContactInfo, global::Vercel.AdditionalContactInfoRequired, global::Vercel.ExpectedPriceMismatch, global::Vercel.DomainNotAvailable, global::Vercel.EmojiTldNotSupported, global::Vercel.LanguageCodeRequired, global::Vercel.TldNotSupported, global::Vercel.HttpApiDecodeError>.FromJson(__content_400, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Vercel.ApiException<global::Vercel.AnyOf<global::Vercel.DomainTooShort, global::Vercel.OrderTooExpensive, global::Vercel.InvalidAdditionalContactInfo, global::Vercel.AdditionalContactInfoRequired, global::Vercel.ExpectedPriceMismatch, global::Vercel.DomainNotAvailable, global::Vercel.EmojiTldNotSupported, global::Vercel.LanguageCodeRequired, global::Vercel.TldNotSupported, global::Vercel.HttpApiDecodeError>?>.Create(
                            ...
                            if ((int)__response.StatusCode == 401)
                            {
                                ...
                                throw global::Vercel.ApiException<global::Vercel.Unauthorized>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 429)
                            {
                                ...
                                throw global::Vercel.ApiException<global::Vercel.TooManyRequests>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 500)
                            {
                                ...
                                throw global::Vercel.ApiException<global::Vercel.InternalServerError>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessBuySingleDomainResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vercel.BuySingleDomainResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vercel.AutoSDKHttpResponse<global::Vercel.BuySingleDomainResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vercel.BuySingleDomainResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.BuySingleDomainResponse> BuySingleDomainAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Vercel.BuySingleDomainRequest
            {
                AutoRenew = autoRenew,
                Years = years,
            ...
            return await BuySingleDomainAsync(
                domain: domain,
                teamId: teamId,
                request: __request,
                requestOptions: requestOptions,
