...
namespace Vercel
{
    ...
    public sealed partial class StartRollingReleaseResponseRollingReleaseActiveStage
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="StartRollingReleaseResponseRollingReleaseActiveStage" /> class.
        /// </summary>
        /// <param name="index">
        /// The zero-based index of the stage<br/>
        /// Example: 0
...
#endif
        public StartRollingReleaseResponseRollingReleaseActiveStage(
            double index,
            bool isFinalStage,
