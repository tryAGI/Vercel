...
namespace Vercel
{
    public partial class VcrClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_ListRepositoryImagesSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_ListRepositoryImagesSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_ListRepositoryImagesSecurityRequirement0,
            };
        partial void PrepareListRepositoryImagesArguments(
            ...
            ref string? teamId,
            ref string? slug);
        partial void PrepareListRepositoryImagesRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? teamId,
            string? slug);
        partial void ProcessListRepositoryImagesResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessListRepositoryImagesResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.VcrImageList> ListRepositoryImagesAsync(
            string projectId,
            string idOrName,
            int? limit = default,
        ...
        {
            var __response = await ListRepositoryImagesAsResponseAsync(
                projectId: projectId,
                idOrName: idOrName,
                limit: limit,
                cursor: cursor,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.VcrImageList>> ListRepositoryImagesAsResponseAsync(
            string projectId,
            string idOrName,
            int? limit = default,
            string? cursor = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareListRepositoryImagesArguments(
                httpClient: HttpClient,
                projectId: ref projectId,
                idOrName: ref idOrName,
                limit: ref limit,
                cursor: ref cursor,
                untagged: ref untagged,
                teamId: ref teamId,
                slug: ref slug);
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ListRepositoryImagesSecurityRequirements,
                operationName: "ListRepositoryImagesAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            __pathBuilder
                                ...
                                .AddOptionalParameter("untagged", untagged?.ToString().ToLowerInvariant())
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareListRepositoryImagesRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "ListRepositoryImagesAsync",
                                pathTemplate: "$\"/v1/vcr/repository/{idOrName}/images\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessListRepositoryImagesResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListRepositoryImagesResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vercel.VcrImageList.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vercel.AutoSDKHttpResponse<global::Vercel.VcrImageList>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vercel.VcrImageList.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
