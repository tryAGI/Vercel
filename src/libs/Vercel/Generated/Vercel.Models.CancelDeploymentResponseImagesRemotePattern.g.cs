...
namespace Vercel
{
    ...
    public sealed partial class CancelDeploymentResponseImagesRemotePattern
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Vercel.JsonConverters.CancelDeploymentResponseImagesRemotePatternProtocolJsonConverter))]
        public global::Vercel.CancelDeploymentResponseImagesRemotePatternProtocol? Protocol { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CancelDeploymentResponseImagesRemotePattern" /> class.
        /// </summary>
        /// <param name="hostname">
        /// Can be literal or wildcard. Single `*` matches a single subdomain. Double `**` matches any number of subdomains.
        /// </param>
...
#endif
        public CancelDeploymentResponseImagesRemotePattern(
            string hostname,
            global::Vercel.CancelDeploymentResponseImagesRemotePatternProtocol? protocol,
            string? port,
            string? pathname,
            string? search)
        {
