...
namespace Vercel
{
    ...
    public sealed partial class StartRollingReleaseResponseRollingReleaseNextStage
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="StartRollingReleaseResponseRollingReleaseNextStage" /> class.
        /// </summary>
        /// <param name="index">
        /// The zero-based index of the stage<br/>
        /// Example: 0
...
#endif
        public StartRollingReleaseResponseRollingReleaseNextStage(
            double index,
            bool isFinalStage,
