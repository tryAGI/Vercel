...
namespace Vercel
{
    ...
    public sealed partial class GetDeploymentResponseVariant1AttributionGitUser
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetDeploymentResponseVariant1AttributionGitUser" /> class.
        /// </summary>
        /// <param name="id"></param>
        /// <param name="login">
        /// Git provider username/login
...
#endif
        public GetDeploymentResponseVariant1AttributionGitUser(
