...
namespace Vercel
{
    ...
    public sealed partial class GetMicrofrontendsInGroupResponseProjectIpBucket
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetMicrofrontendsInGroupResponseProjectIpBucket" /> class.
        /// </summary>
...
#endif
        public GetMicrofrontendsInGroupResponseProjectIpBucket(
            string bucket,
            bool? @default,
            double? supportUntil)
        {
