...
namespace Vercel
{
    ...
    public sealed partial class GetProjectsResponseVariant1ItemSecurityFirewallRouteSrc
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetProjectsResponseVariant1ItemSecurityFirewallRouteSrc" /> class.
        /// </summary>
        /// <param name="re"></param>
        /// <param name="eq"></param>
...
#endif
        public GetProjectsResponseVariant1ItemSecurityFirewallRouteSrc(
            string? re,
            string? eq,
            string? neq,
