...
namespace Vercel
{
    ...
    public sealed partial class GetKmsIssuerResponseSigningKey
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Vercel.JsonConverters.GetKmsIssuerResponseSigningKeyStatusJsonConverter))]
        [global::System.Text.Json.Serialization.JsonRequired]
        public required global::Vercel.GetKmsIssuerResponseSigningKeyStatus Status { get; set; }

        /// <summary>
        ///
        /// </summary>
        [global::System.Text.Json.Serialization.JsonPropertyName("publicKey")]
        public global::Vercel.GetKmsIssuerResponseSigningKeyPublicKey? PublicKey { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetKmsIssuerResponseSigningKey" /> class.
        /// </summary>
        /// <param name="keyId">
        /// The server-minted, unique record identifier. Use this to address the key on the activate / certificate endpoints.
        /// </param>
...
#endif
        public GetKmsIssuerResponseSigningKey(
            string keyId,
            string issuerId,
            string algorithm,
            global::Vercel.GetKmsIssuerResponseSigningKeyStatus status,
            string createdAt,
            string updatedAt,
            string? importKeyId,
            global::Vercel.GetKmsIssuerResponseSigningKeyPublicKey? publicKey,
