...
namespace Vercel
{
    ...
    public sealed partial class CreateDeploymentResponseVariant2AttributionVercelUser
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateDeploymentResponseVariant2AttributionVercelUser" /> class.
        /// </summary>
        /// <param name="id">
        /// Vercel user ID
        /// </param>
...
#endif
        public CreateDeploymentResponseVariant2AttributionVercelUser(
            string id,
            string username,
