...
namespace Vercel
{
    public partial interface IFeatureFlagsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.OneOf<object, global::Vercel.ListTeamFlagSettingsResponseVariant2>>> ListTeamFlagSettingsAsResponseAsync(
            string teamId,
            int? limit = default,
            string? cursor = default,
            string? slug = default,
