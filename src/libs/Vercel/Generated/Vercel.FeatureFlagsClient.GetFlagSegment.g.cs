...
namespace Vercel
{
    public partial class FeatureFlagsClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_GetFlagSegmentSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_GetFlagSegmentSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_GetFlagSegmentSecurityRequirement0,
            };
        partial void PrepareGetFlagSegmentArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string projectIdOrName,
            ref string segmentIdOrSlug,
            ref bool? withMetadata,
            ref string? teamId,
            ref string? slug);
        partial void PrepareGetFlagSegmentRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? teamId,
            string? slug);
        partial void ProcessGetFlagSegmentResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetFlagSegmentResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.Segment> GetFlagSegmentAsync(
            string projectIdOrName,
            string segmentIdOrSlug,
        ...
        {
            var __response = await GetFlagSegmentAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.Segment>> GetFlagSegmentAsResponseAsync(
            string projectIdOrName,
            string segmentIdOrSlug,
            bool? withMetadata = default,
            string? teamId = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetFlagSegmentArguments(
                httpClient: HttpClient,
                projectIdOrName: ref projectIdOrName,
                segmentIdOrSlug: ref segmentIdOrSlug,
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetFlagSegmentSecurityRequirements,
                operationName: "GetFlagSegmentAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetFlagSegmentAsync",
                                pathTemplate: "$\"/v1/projects/{projectIdOrName}/feature-flags/segments/{segmentIdOrSlug}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetFlagSegmentResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vercel.Segment.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vercel.AutoSDKHttpResponse<global::Vercel.Segment>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vercel.Segment.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
