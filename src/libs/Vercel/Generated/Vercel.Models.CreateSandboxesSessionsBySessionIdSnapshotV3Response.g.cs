...
namespace Vercel
{
    ...
    public sealed partial class CreateSandboxesSessionsBySessionIdSnapshotV3Response
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateSandboxesSessionsBySessionIdSnapshotV3Response" /> class.
        /// </summary>
        /// <param name="snapshot">
        /// This object contains information related to a Snapshot of a Vercel Sandbox session (v2 API).
        /// </param>
...
#endif
        public CreateSandboxesSessionsBySessionIdSnapshotV3Response(
