...
namespace Vercel
{
    public partial class EnvironmentClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_GetCustomEnvironmentSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_GetCustomEnvironmentSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_GetCustomEnvironmentSecurityRequirement0,
            };
        partial void PrepareGetCustomEnvironmentArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string idOrName,
            ref string environmentSlugOrId,
            ref string? teamId,
            ref string? slug);
        partial void PrepareGetCustomEnvironmentRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? teamId,
            string? slug);
        partial void ProcessGetCustomEnvironmentResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetCustomEnvironmentResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetCustomEnvironmentArguments(
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetCustomEnvironmentSecurityRequirements,
                operationName: "GetCustomEnvironmentAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetCustomEnvironmentRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetCustomEnvironmentAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetCustomEnvironmentResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetCustomEnvironmentResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::Vercel.GetCustomEnvironmentResponse.FromJson(__content, JsonSerializerContext) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::Vercel.GetCustomEnvironmentResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
