...
namespace Vercel
{
    ...
    public sealed partial class TeamLimitedSamlConnection
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Vercel.JsonConverters.TeamLimitedSamlConnectionSyncStateJsonConverter))]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TeamLimitedSamlConnection" /> class.
        /// </summary>
        /// <param name="type">
        /// The Identity Provider "type", for example Okta.<br/>
        /// Example: OktaSAML
        ...
        public TeamLimitedSamlConnection(
            ...
            double? lastSyncedAt,
            global::Vercel.TeamLimitedSamlConnectionSyncState? syncState)
        {
