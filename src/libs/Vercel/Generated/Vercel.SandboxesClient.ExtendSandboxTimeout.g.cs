...
namespace Vercel
{
    public partial class SandboxesClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_ExtendSandboxTimeoutSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_ExtendSandboxTimeoutSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_ExtendSandboxTimeoutSecurityRequirement0,
            };
        partial void PrepareExtendSandboxTimeoutArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string sandboxId,
            ref string? teamId,
            ref string? slug,
            global::Vercel.ExtendSandboxTimeoutRequest request);
        partial void PrepareExtendSandboxTimeoutRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? slug,
            global::Vercel.ExtendSandboxTimeoutRequest request);
        partial void ProcessExtendSandboxTimeoutResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessExtendSandboxTimeoutResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.ExtendSandboxTimeoutResponse> ExtendSandboxTimeoutAsync(
            string sandboxId,
        ...
        {
            var __response = await ExtendSandboxTimeoutAsResponseAsync(
                sandboxId: sandboxId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.ExtendSandboxTimeoutResponse>> ExtendSandboxTimeoutAsResponseAsync(
            string sandboxId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareExtendSandboxTimeoutArguments(
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ExtendSandboxTimeoutSecurityRequirements,
                operationName: "ExtendSandboxTimeoutAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Vercel.PathBuilder(
                                path: $"/v1/sandboxes/{sandboxId}/extend-timeout",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareExtendSandboxTimeoutRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "ExtendSandboxTimeoutAsync",
                                pathTemplate: "$\"/v1/sandboxes/{sandboxId}/extend-timeout\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessExtendSandboxTimeoutResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessExtendSandboxTimeoutResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vercel.ExtendSandboxTimeoutResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vercel.AutoSDKHttpResponse<global::Vercel.ExtendSandboxTimeoutResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vercel.ExtendSandboxTimeoutResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.ExtendSandboxTimeoutResponse> ExtendSandboxTimeoutAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Vercel.ExtendSandboxTimeoutRequest
            {
                Duration = duration,
            };

            return await ExtendSandboxTimeoutAsync(
                sandboxId: sandboxId,
                teamId: teamId,
                slug: slug,
                request: __request,
