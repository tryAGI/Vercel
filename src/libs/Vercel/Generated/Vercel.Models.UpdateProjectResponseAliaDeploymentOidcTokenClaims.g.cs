...
namespace Vercel
{
    ...
    public sealed partial class UpdateProjectResponseAliaDeploymentOidcTokenClaims
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateProjectResponseAliaDeploymentOidcTokenClaims" /> class.
        /// </summary>
...
#endif
        public UpdateProjectResponseAliaDeploymentOidcTokenClaims(
            string iss,
            string sub,
            string scope,
            string aud,
