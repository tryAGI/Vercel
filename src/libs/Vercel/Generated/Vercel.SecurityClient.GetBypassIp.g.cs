...
namespace Vercel
{
    public partial class SecurityClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_GetBypassIpSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_GetBypassIpSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_GetBypassIpSecurityRequirement0,
            };
        partial void PrepareGetBypassIpArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string projectId,
            ref double? limit,
            ref string? sourceIp,
            ref string? domain,
            ref bool? projectScope,
            ref string? offset,
            ref string? teamId,
            ref string? slug);
        partial void PrepareGetBypassIpRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? teamId,
            string? slug);
        partial void ProcessGetBypassIpResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetBypassIpResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.GetBypassIpResponse> GetBypassIpAsync(
            string projectId,
        ...
        {
            var __response = await GetBypassIpAsResponseAsync(
                projectId: projectId,
                limit: limit,
                sourceIp: sourceIp,
                domain: domain,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.GetBypassIpResponse>> GetBypassIpAsResponseAsync(
            string projectId,
            double? limit = default,
            string? sourceIp = default,
            string? domain = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetBypassIpSecurityRequirements,
                operationName: "GetBypassIpAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            __pathBuilder
                                ...
                                .AddOptionalParameter("sourceIp", sourceIp)
                                .AddOptionalParameter("domain", domain)
                                .AddOptionalParameter("projectScope", projectScope?.ToString().ToLowerInvariant())
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetBypassIpResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vercel.GetBypassIpResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vercel.AutoSDKHttpResponse<global::Vercel.GetBypassIpResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vercel.GetBypassIpResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
