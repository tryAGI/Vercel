...
namespace Vercel
{
    ...
    public sealed partial class RevokeKmsSigningKeyResponseSigningKey
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RevokeKmsSigningKeyResponseSigningKey" /> class.
        /// </summary>
        /// <param name="keyId">
        /// The server-minted, unique record identifier. Use this to address the key on the activate / certificate endpoints.
        /// </param>
...
#endif
        public RevokeKmsSigningKeyResponseSigningKey(
            string keyId,
            string issuerId,
            string algorithm,
            global::Vercel.RevokeKmsSigningKeyResponseSigningKeyStatus status,
            string createdAt,
            string updatedAt,
            string? importKeyId,
            global::Vercel.RevokeKmsSigningKeyResponseSigningKeyPublicKey? publicKey,
