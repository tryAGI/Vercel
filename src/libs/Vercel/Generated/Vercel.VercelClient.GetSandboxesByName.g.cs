...
namespace Vercel
{
    public partial class VercelClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_GetSandboxesByNameSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_GetSandboxesByNameSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_GetSandboxesByNameSecurityRequirement0,
            };
        partial void PrepareGetSandboxesByNameArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string name,
            ref string? projectId,
            ref bool? resume);
        partial void PrepareGetSandboxesByNameRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string name,
            string? projectId,
            bool? resume);
        partial void ProcessGetSandboxesByNameResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetSandboxesByNameResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.GetSandboxesByNameResponse> GetSandboxesByNameAsync(
            string name,
        ...
        {
            var __response = await GetSandboxesByNameAsResponseAsync(
                name: name,
                projectId: projectId,
                resume: resume,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.GetSandboxesByNameResponse>> GetSandboxesByNameAsResponseAsync(
            string name,
            string? projectId = default,
            bool? resume = default,
            global::Vercel.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetSandboxesByNameArguments(
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetSandboxesByNameSecurityRequirements,
                operationName: "GetSandboxesByNameAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetSandboxesByNameRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetSandboxesByName",
                                methodName: "GetSandboxesByNameAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetSandboxesByNameResponse(
                    httpClient: HttpClient,
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vercel.GetSandboxesByNameResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vercel.AutoSDKHttpResponse<global::Vercel.GetSandboxesByNameResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vercel.GetSandboxesByNameResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
