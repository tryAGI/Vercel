...
namespace Vercel
{
    public partial class AccessGroupsClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_ListAccessGroupProjectsSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_ListAccessGroupProjectsSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_ListAccessGroupProjectsSecurityRequirement0,
            };
        partial void PrepareListAccessGroupProjectsArguments(
            ...
            ref string? teamId,
            ref string? slug);
        partial void PrepareListAccessGroupProjectsRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? teamId,
            string? slug);
        partial void ProcessListAccessGroupProjectsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessListAccessGroupProjectsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.ListAccessGroupProjectsResponse> ListAccessGroupProjectsAsync(
            string idOrName,
            int? limit = default,
            string? next = default,
        ...
        {
            var __response = await ListAccessGroupProjectsAsResponseAsync(
                idOrName: idOrName,
                limit: limit,
                next: next,
                teamId: teamId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.ListAccessGroupProjectsResponse>> ListAccessGroupProjectsAsResponseAsync(
            string idOrName,
            int? limit = default,
            string? next = default,
            string? teamId = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareListAccessGroupProjectsArguments(
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ListAccessGroupProjectsSecurityRequirements,
                operationName: "ListAccessGroupProjectsAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "ListAccessGroupProjectsAsync",
                                pathTemplate: "$\"/v1/access-groups/{idOrName}/projects\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessListAccessGroupProjectsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListAccessGroupProjectsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vercel.ListAccessGroupProjectsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vercel.AutoSDKHttpResponse<global::Vercel.ListAccessGroupProjectsResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vercel.ListAccessGroupProjectsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
