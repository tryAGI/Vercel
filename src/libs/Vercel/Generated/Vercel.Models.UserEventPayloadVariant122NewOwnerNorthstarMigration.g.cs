...
namespace Vercel
{
    ...
    public sealed partial class UserEventPayloadVariant122NewOwnerNorthstarMigration
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UserEventPayloadVariant122NewOwnerNorthstarMigration" /> class.
        /// </summary>
        /// <param name="teamId">
        /// The ID of the team we created for this user.
        /// </param>
...
#endif
        public UserEventPayloadVariant122NewOwnerNorthstarMigration(
            string teamId,
            double projects,
            double stores,
