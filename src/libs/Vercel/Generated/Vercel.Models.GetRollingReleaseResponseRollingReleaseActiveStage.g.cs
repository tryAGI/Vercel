...
namespace Vercel
{
    ...
    public sealed partial class GetRollingReleaseResponseRollingReleaseActiveStage
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetRollingReleaseResponseRollingReleaseActiveStage" /> class.
        /// </summary>
        /// <param name="index">
        /// The zero-based index of the stage<br/>
        /// Example: 0
...
#endif
        public GetRollingReleaseResponseRollingReleaseActiveStage(
            double index,
            bool isFinalStage,
