...
namespace Vercel
{
    ...
    public sealed partial class ImportResourceRequestSecretEnvironmentOverrides
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ImportResourceRequestSecretEnvironmentOverrides" /> class.
        /// </summary>
...
#endif
        public ImportResourceRequestSecretEnvironmentOverrides(
            string? development,
            string? preview,
            string? production)
        {
