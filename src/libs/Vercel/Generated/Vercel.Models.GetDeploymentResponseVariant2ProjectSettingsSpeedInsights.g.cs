...
namespace Vercel
{
    ...
    public sealed partial class GetDeploymentResponseVariant2ProjectSettingsSpeedInsights
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetDeploymentResponseVariant2ProjectSettingsSpeedInsights" /> class.
        /// </summary>
        /// <param name="id"></param>
...
#endif
        public GetDeploymentResponseVariant2ProjectSettingsSpeedInsights(
            string id,
            double? enabledAt,
            double? disabledAt,
            double? canceledAt,
