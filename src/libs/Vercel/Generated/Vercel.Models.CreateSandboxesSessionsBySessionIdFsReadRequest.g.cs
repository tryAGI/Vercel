...
namespace Vercel
{
    ...
    public sealed partial class CreateSandboxesSessionsBySessionIdFsReadRequest
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateSandboxesSessionsBySessionIdFsReadRequest" /> class.
        /// </summary>
        /// <param name="path">
        /// The path of the file to read. Can be absolute or relative to the working directory.<br/>
        /// Example: dist/agent-output.md
...
#endif
        public CreateSandboxesSessionsBySessionIdFsReadRequest(
            string path,
            string? cwd)
        {
            this.Cwd = cwd;
