...
namespace Vercel
{
    ...
    public sealed partial class CreateSandboxesByNameForkRequestNetworkPolicyVariant2AllowItemMatchPath
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateSandboxesByNameForkRequestNetworkPolicyVariant2AllowItemMatchPath" /> class.
        /// </summary>
        /// <param name="exact">
        /// Match the value exactly. Case-sensitive for paths, header values, and methods; case-insensitive for domains and header keys.
        /// </param>
...
#endif
        public CreateSandboxesByNameForkRequestNetworkPolicyVariant2AllowItemMatchPath(
            string? exact,
            string? startsWith)
        {
            this.Exact = exact;
