...
namespace Vercel
{
    public partial class SandboxesV2BetaClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_CreateSessionSnapshotSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_CreateSessionSnapshotSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_CreateSessionSnapshotSecurityRequirement0,
            };
        partial void PrepareCreateSessionSnapshotArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string sessionId,
            ref string? teamId,
            ref string? slug,
            global::Vercel.CreateSessionSnapshotRequest request);
        partial void PrepareCreateSessionSnapshotRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? slug,
            global::Vercel.CreateSessionSnapshotRequest request);
        partial void ProcessCreateSessionSnapshotResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateSessionSnapshotResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.CreateSessionSnapshotResponse> CreateSessionSnapshotAsync(
            string sessionId,
        ...
        {
            var __response = await CreateSessionSnapshotAsResponseAsync(
                sessionId: sessionId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.CreateSessionSnapshotResponse>> CreateSessionSnapshotAsResponseAsync(
            string sessionId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateSessionSnapshotArguments(
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateSessionSnapshotSecurityRequirements,
                operationName: "CreateSessionSnapshotAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateSessionSnapshotRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "CreateSessionSnapshotAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateSessionSnapshotResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateSessionSnapshotResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vercel.CreateSessionSnapshotResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vercel.AutoSDKHttpResponse<global::Vercel.CreateSessionSnapshotResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vercel.CreateSessionSnapshotResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.CreateSessionSnapshotResponse> CreateSessionSnapshotAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Vercel.CreateSessionSnapshotRequest
            {
                Expiration = expiration,
            };

            return await CreateSessionSnapshotAsync(
                sessionId: sessionId,
                teamId: teamId,
                slug: slug,
                request: __request,
