...
namespace Vercel
{
    public partial interface IAccessGroupsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.OneOf<object, global::Vercel.ListAccessGroupsResponseVariant2>>> ListAccessGroupsAsResponseAsync(
            string? projectId = default,
            string? search = default,
            int? membersLimit = default,
            int? projectsLimit = default,
