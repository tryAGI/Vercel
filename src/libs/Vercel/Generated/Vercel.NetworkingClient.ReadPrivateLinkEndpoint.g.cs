...
namespace Vercel
{
    public partial class NetworkingClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_ReadPrivateLinkEndpointSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_ReadPrivateLinkEndpointSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_ReadPrivateLinkEndpointSecurityRequirement0,
            };
        partial void PrepareReadPrivateLinkEndpointArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string projectId,
            ref string endpointId,
            ref string? teamId,
            ref string? slug);
        partial void PrepareReadPrivateLinkEndpointRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? teamId,
            string? slug);
        partial void ProcessReadPrivateLinkEndpointResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessReadPrivateLinkEndpointResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.PrivateLinkEndpoint> ReadPrivateLinkEndpointAsync(
            string projectId,
            string endpointId,
        ...
        {
            var __response = await ReadPrivateLinkEndpointAsResponseAsync(
                projectId: projectId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.PrivateLinkEndpoint>> ReadPrivateLinkEndpointAsResponseAsync(
            string projectId,
            string endpointId,
            string? teamId = default,
            string? slug = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareReadPrivateLinkEndpointArguments(
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ReadPrivateLinkEndpointSecurityRequirements,
                operationName: "ReadPrivateLinkEndpointAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareReadPrivateLinkEndpointRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "ReadPrivateLinkEndpointAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessReadPrivateLinkEndpointResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessReadPrivateLinkEndpointResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
