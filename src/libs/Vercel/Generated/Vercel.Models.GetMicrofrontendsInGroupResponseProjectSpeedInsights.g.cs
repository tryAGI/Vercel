...
namespace Vercel
{
    ...
    public sealed partial class GetMicrofrontendsInGroupResponseProjectSpeedInsights
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetMicrofrontendsInGroupResponseProjectSpeedInsights" /> class.
        /// </summary>
        /// <param name="id"></param>
...
#endif
        public GetMicrofrontendsInGroupResponseProjectSpeedInsights(
            string id,
            double? enabledAt,
            double? disabledAt,
            double? canceledAt,
