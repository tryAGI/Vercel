...
namespace Vercel
{
    ...
    public sealed partial class CreateSandboxesSessionsBySessionIdNetworkPolicyRequestVariant2AllowItemMatchPath
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateSandboxesSessionsBySessionIdNetworkPolicyRequestVariant2AllowItemMatchPath" /> class.
        /// </summary>
        /// <param name="exact">
        /// Match the value exactly. Case-sensitive for paths, header values, and methods; case-insensitive for domains and header keys.
        /// </param>
...
#endif
        public CreateSandboxesSessionsBySessionIdNetworkPolicyRequestVariant2AllowItemMatchPath(
            string? exact,
            string? startsWith)
        {
            this.Exact = exact;
