...
namespace Vercel
{
    ...
    public sealed partial class ConnectConnectorUpdateDataTypeLinearApplication
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ConnectConnectorUpdateDataTypeLinearApplication" /> class.
        /// </summary>
        /// <param name="id">
        /// Linear OAuth application ID.
        /// </param>
...
#endif
        public ConnectConnectorUpdateDataTypeLinearApplication(
            string id,
            string clientId,
            string name,
            string? description,
