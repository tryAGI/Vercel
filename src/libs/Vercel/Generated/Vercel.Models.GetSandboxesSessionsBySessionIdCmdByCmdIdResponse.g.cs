...
namespace Vercel
{
    ...
    public sealed partial class GetSandboxesSessionsBySessionIdCmdByCmdIdResponse
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetSandboxesSessionsBySessionIdCmdByCmdIdResponse" /> class.
        /// </summary>
        /// <param name="command">
        /// This object represents a command run in a Vercel Sandbox session (v2 API).
        /// </param>
...
#endif
        public GetSandboxesSessionsBySessionIdCmdByCmdIdResponse(
