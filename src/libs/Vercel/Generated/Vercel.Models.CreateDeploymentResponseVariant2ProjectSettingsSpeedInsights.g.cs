...
namespace Vercel
{
    ...
    public sealed partial class CreateDeploymentResponseVariant2ProjectSettingsSpeedInsights
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateDeploymentResponseVariant2ProjectSettingsSpeedInsights" /> class.
        /// </summary>
        /// <param name="id"></param>
...
#endif
        public CreateDeploymentResponseVariant2ProjectSettingsSpeedInsights(
            string id,
            double? enabledAt,
            double? disabledAt,
            double? canceledAt,
