...
namespace Vercel
{
    ...
    public sealed partial class CreateProjectResponseAliaDeploymentOidcTokenClaims
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateProjectResponseAliaDeploymentOidcTokenClaims" /> class.
        /// </summary>
...
#endif
        public CreateProjectResponseAliaDeploymentOidcTokenClaims(
            string iss,
            string sub,
            string scope,
            string aud,
