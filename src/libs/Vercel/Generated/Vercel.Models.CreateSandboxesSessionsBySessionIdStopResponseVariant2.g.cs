...
namespace Vercel
{
    ...
    public sealed partial class CreateSandboxesSessionsBySessionIdStopResponseVariant2
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateSandboxesSessionsBySessionIdStopResponseVariant2" /> class.
        /// </summary>
        /// <param name="snapshot">
        /// This object contains information related to a Snapshot of a Vercel Sandbox session (v2 API).
        /// </param>
...
#endif
        public CreateSandboxesSessionsBySessionIdStopResponseVariant2(
