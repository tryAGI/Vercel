...
namespace Vercel
{
    ...
    public sealed partial class CreateDeploymentResponseVariant2ImagesRemotePattern
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Vercel.JsonConverters.CreateDeploymentResponseVariant2ImagesRemotePatternProtocolJsonConverter))]
        public global::Vercel.CreateDeploymentResponseVariant2ImagesRemotePatternProtocol? Protocol { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateDeploymentResponseVariant2ImagesRemotePattern" /> class.
        /// </summary>
        /// <param name="hostname">
        /// Can be literal or wildcard. Single `*` matches a single subdomain. Double `**` matches any number of subdomains.
        /// </param>
...
#endif
        public CreateDeploymentResponseVariant2ImagesRemotePattern(
            string hostname,
            global::Vercel.CreateDeploymentResponseVariant2ImagesRemotePatternProtocol? protocol,
            string? port,
            string? pathname,
            string? search)
        {
