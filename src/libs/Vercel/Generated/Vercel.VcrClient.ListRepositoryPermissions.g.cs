...
namespace Vercel
{
    public partial class VcrClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_ListRepositoryPermissionsSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_ListRepositoryPermissionsSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_ListRepositoryPermissionsSecurityRequirement0,
            };
        partial void PrepareListRepositoryPermissionsArguments(
            ...
            ref string? teamId,
            ref string? slug);
        partial void PrepareListRepositoryPermissionsRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? teamId,
            string? slug);
        partial void ProcessListRepositoryPermissionsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessListRepositoryPermissionsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// List repository permissions<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.VcrRepositoryPermissionList> ListRepositoryPermissionsAsync(
            string projectId,
            string idOrName,
            int? limit = default,
        ...
        {
            var __response = await ListRepositoryPermissionsAsResponseAsync(
                projectId: projectId,
                idOrName: idOrName,
                limit: limit,
                cursor: cursor,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.VcrRepositoryPermissionList>> ListRepositoryPermissionsAsResponseAsync(
            string projectId,
            string idOrName,
            int? limit = default,
            string? cursor = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareListRepositoryPermissionsArguments(
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ListRepositoryPermissionsSecurityRequirements,
                operationName: "ListRepositoryPermissionsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareListRepositoryPermissionsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "ListRepositoryPermissionsAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessListRepositoryPermissionsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListRepositoryPermissionsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vercel.VcrRepositoryPermissionList.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vercel.AutoSDKHttpResponse<global::Vercel.VcrRepositoryPermissionList>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vercel.VcrRepositoryPermissionList.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
