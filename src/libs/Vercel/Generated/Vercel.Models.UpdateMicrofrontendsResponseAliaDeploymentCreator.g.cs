...
namespace Vercel
{
    ...
    public sealed partial class UpdateMicrofrontendsResponseAliaDeploymentCreator
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateMicrofrontendsResponseAliaDeploymentCreator" /> class.
        /// </summary>
...
#endif
        public UpdateMicrofrontendsResponseAliaDeploymentCreator(
            string email,
            string uid,
            string username,
            string? githubLogin,
