...
namespace Vercel
{
    ...
    public sealed partial class GetProjectsResponseVariant1ItemAbuseHistoryItem
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetProjectsResponseVariant1ItemAbuseHistoryItem" /> class.
        /// </summary>
...
#endif
        public GetProjectsResponseVariant1ItemAbuseHistoryItem(
            string scanner,
            string reason,
            string by,
            string byId,
