...
namespace Vercel
{
    ...
    public sealed partial class CreateDeploymentResponseProjectSettingsWebAnalytics
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateDeploymentResponseProjectSettingsWebAnalytics" /> class.
        /// </summary>
        /// <param name="id"></param>
...
#endif
        public CreateDeploymentResponseProjectSettingsWebAnalytics(
            string id,
            double? disabledAt,
            double? canceledAt,
            double? enabledAt,
