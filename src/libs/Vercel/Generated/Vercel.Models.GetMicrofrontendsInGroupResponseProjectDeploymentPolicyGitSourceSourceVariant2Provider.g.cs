...
namespace Vercel
{
    ...
    public static class GetMicrofrontendsInGroupResponseProjectDeploymentPolicyGitSourceSourceVariant2ProviderExtensions
    {
        ...
        public static string ToValueString(this GetMicrofrontendsInGroupResponseProjectDeploymentPolicyGitSourceSourceVariant2Provider value)
        {
            return value switch
            {
                GetMicrofrontendsInGroupResponseProjectDeploymentPolicyGitSourceSourceVariant2Provider.Bitbucket => "bitbucket",
                GetMicrofrontendsInGroupResponseProjectDeploymentPolicyGitSourceSourceVariant2Provider.Github => "github",
        ...
        public static GetMicrofrontendsInGroupResponseProjectDeploymentPolicyGitSourceSourceVariant2Provider? ToEnum(string value)
        {
            return value switch
            {
                "bitbucket" => GetMicrofrontendsInGroupResponseProjectDeploymentPolicyGitSourceSourceVariant2Provider.Bitbucket,
                "github" => GetMicrofrontendsInGroupResponseProjectDeploymentPolicyGitSourceSourceVariant2Provider.Github,
