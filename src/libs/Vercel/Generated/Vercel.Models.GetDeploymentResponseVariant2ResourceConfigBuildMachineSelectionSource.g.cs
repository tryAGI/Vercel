...
namespace Vercel
{
    ...
    public static class GetDeploymentResponseVariant2ResourceConfigBuildMachineSelectionSourceExtensions
    {
        ...
        public static string ToValueString(this GetDeploymentResponseVariant2ResourceConfigBuildMachineSelectionSource value)
        {
            return value switch
            {
                GetDeploymentResponseVariant2ResourceConfigBuildMachineSelectionSource.DeploymentOverride => "deployment-override",
                ...
                GetDeploymentResponseVariant2ResourceConfigBuildMachineSelectionSource.TeamEntitlement => "team-entitlement",
        ...
        public static GetDeploymentResponseVariant2ResourceConfigBuildMachineSelectionSource? ToEnum(string value)
        {
            return value switch
            {
                "deployment-override" => GetDeploymentResponseVariant2ResourceConfigBuildMachineSelectionSource.DeploymentOverride,
                ...
                "team-entitlement" => GetDeploymentResponseVariant2ResourceConfigBuildMachineSelectionSource.TeamEntitlement,
