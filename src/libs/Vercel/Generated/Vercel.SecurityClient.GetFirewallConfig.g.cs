...
namespace Vercel
{
    public partial class SecurityClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_GetFirewallConfigSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_GetFirewallConfigSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_GetFirewallConfigSecurityRequirement0,
            };
        partial void PrepareGetFirewallConfigArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string projectId,
            ref string? teamId,
            ref string? slug,
            ref string configVersion);
        partial void PrepareGetFirewallConfigRequest(
            global::System.Net.Http.HttpClient httpClient,
        ...
        partial void ProcessGetFirewallConfigResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetFirewallConfigResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKShared1629dac811485089> GetFirewallConfigAsync(
            string projectId,
            string configVersion,
        ...
        {
            var __response = await GetFirewallConfigAsResponseAsync(
                projectId: projectId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.AutoSDKShared1629dac811485089>> GetFirewallConfigAsResponseAsync(
            string projectId,
            string configVersion,
            string? teamId = default,
            string? slug = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetFirewallConfigArguments(
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetFirewallConfigSecurityRequirements,
                operationName: "GetFirewallConfigAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetFirewallConfigAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetFirewallConfigResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetFirewallConfigResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vercel.AutoSDKShared1629dac811485089.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vercel.AutoSDKHttpResponse<global::Vercel.AutoSDKShared1629dac811485089>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vercel.AutoSDKShared1629dac811485089.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
