...
namespace Vercel
{
    ...
    public sealed partial class GetMicrofrontendsInGroupResponseProjectTargetsCreator
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetMicrofrontendsInGroupResponseProjectTargetsCreator" /> class.
        /// </summary>
...
#endif
        public GetMicrofrontendsInGroupResponseProjectTargetsCreator(
            string email,
            string uid,
            string username,
            string? githubLogin,
