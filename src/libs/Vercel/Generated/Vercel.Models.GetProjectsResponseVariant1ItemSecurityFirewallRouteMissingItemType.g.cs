    ...
    public static class GetProjectsResponseVariant1ItemSecurityFirewallRouteMissingItemTypeExtensions
    {
        ...
        public static string ToValueString(this GetProjectsResponseVariant1ItemSecurityFirewallRouteMissingItemType value)
        {
            return value switch
            {
                ...
                GetProjectsResponseVariant1ItemSecurityFirewallRouteMissingItemType.DomainEnvironment => "domain_environment",
                ...
                GetProjectsResponseVariant1ItemSecurityFirewallRouteMissingItemType.TrustedSource => "trusted_source",
        ...
        public static GetProjectsResponseVariant1ItemSecurityFirewallRouteMissingItemType? ToEnum(string value)
        {
            return value switch
            {
                ...
                "domain_environment" => GetProjectsResponseVariant1ItemSecurityFirewallRouteMissingItemType.DomainEnvironment,
                ...
                "trusted_source" => GetProjectsResponseVariant1ItemSecurityFirewallRouteMissingItemType.TrustedSource,
                _ => null,
            };
        }
    }
