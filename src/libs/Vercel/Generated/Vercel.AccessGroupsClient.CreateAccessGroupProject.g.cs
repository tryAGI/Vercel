...
namespace Vercel
{
    public partial class AccessGroupsClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_CreateAccessGroupProjectSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_CreateAccessGroupProjectSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_CreateAccessGroupProjectSecurityRequirement0,
            };
        partial void PrepareCreateAccessGroupProjectArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string accessGroupIdOrName,
            ref string? teamId,
            ref string? slug,
            global::Vercel.CreateAccessGroupProjectRequest request);
        partial void PrepareCreateAccessGroupProjectRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? slug,
            global::Vercel.CreateAccessGroupProjectRequest request);
        partial void ProcessCreateAccessGroupProjectResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateAccessGroupProjectResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.CreateAccessGroupProjectResponse> CreateAccessGroupProjectAsync(
            string accessGroupIdOrName,
        ...
        {
            var __response = await CreateAccessGroupProjectAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.CreateAccessGroupProjectResponse>> CreateAccessGroupProjectAsResponseAsync(
            string accessGroupIdOrName,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateAccessGroupProjectArguments(
                httpClient: HttpClient,
                accessGroupIdOrName: ref accessGroupIdOrName,
                teamId: ref teamId,
                slug: ref slug,
                request: request);
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateAccessGroupProjectSecurityRequirements,
                operationName: "CreateAccessGroupProjectAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "CreateAccessGroupProjectAsync",
                                pathTemplate: "$\"/v1/access-groups/{accessGroupIdOrName}/projects\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateAccessGroupProjectResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateAccessGroupProjectResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vercel.CreateAccessGroupProjectResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vercel.AutoSDKHttpResponse<global::Vercel.CreateAccessGroupProjectResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vercel.CreateAccessGroupProjectResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.CreateAccessGroupProjectResponse> CreateAccessGroupProjectAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Vercel.CreateAccessGroupProjectRequest
            {
                ProjectId = projectId,
                Role = role,
            };

            return await CreateAccessGroupProjectAsync(
                accessGroupIdOrName: accessGroupIdOrName,
                teamId: teamId,
                slug: slug,
                request: __request,
