...
namespace Vercel
{
    ...
    public sealed partial class UserEventPayloadVariant29
    {
        ...
        public global::Vercel.UserEventPayloadVariant29App? App { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UserEventPayloadVariant29" /> class.
        /// </summary>
        /// <param name="appName">
        /// The App's name at the moment this even was published (it may have changed since then).
        /// </param>
        ...
        public UserEventPayloadVariant29(
            string appName,
            string? appId,
            global::Vercel.UserEventPayloadVariant29App? app,
            double? issuedBefore)
        {
