...
namespace Vercel
{
    ...
    public static class CreateProjectResponseFrameworkExtensions
    {
        ...
        public static string ToValueString(this CreateProjectResponseFramework value)
        {
            return value switch
            {
                CreateProjectResponseFramework.ActixWeb => "actix-web",
                CreateProjectResponseFramework.Angular => "angular",
                CreateProjectResponseFramework.Ash => "ash",
                CreateProjectResponseFramework.Astro => "astro",
                CreateProjectResponseFramework.Axum => "axum",
                CreateProjectResponseFramework.Blitzjs => "blitzjs",
                CreateProjectResponseFramework.Brunch => "brunch",
                CreateProjectResponseFramework.Bun => "bun",
                CreateProjectResponseFramework.Container => "container",
                ...
                CreateProjectResponseFramework.Eve => "eve",
                CreateProjectResponseFramework.Express => "express",
                CreateProjectResponseFramework.FactoryEve => "factory-eve",
                ...
                CreateProjectResponseFramework.Mastra => "mastra",
                ...
                CreateProjectResponseFramework.SanityV2 => "sanity-v2",
                ...
                CreateProjectResponseFramework.TanstackStartLovable => "tanstack-start-lovable",
        ...
        public static CreateProjectResponseFramework? ToEnum(string value)
        {
            return value switch
            {
                "actix-web" => CreateProjectResponseFramework.ActixWeb,
                "angular" => CreateProjectResponseFramework.Angular,
                "ash" => CreateProjectResponseFramework.Ash,
                "astro" => CreateProjectResponseFramework.Astro,
                "axum" => CreateProjectResponseFramework.Axum,
                "blitzjs" => CreateProjectResponseFramework.Blitzjs,
                "brunch" => CreateProjectResponseFramework.Brunch,
                "bun" => CreateProjectResponseFramework.Bun,
                "container" => CreateProjectResponseFramework.Container,
                ...
                "eve" => CreateProjectResponseFramework.Eve,
                "express" => CreateProjectResponseFramework.Express,
                "factory-eve" => CreateProjectResponseFramework.FactoryEve,
                ...
                "mastra" => CreateProjectResponseFramework.Mastra,
                ...
                "sanity-v2" => CreateProjectResponseFramework.SanityV2,
                ...
                "tanstack-start-lovable" => CreateProjectResponseFramework.TanstackStartLovable,
