...
namespace Vercel
{
    ...
    public sealed partial class CreateDeploymentResponseVariant2ProjectSettingsWebAnalytics
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateDeploymentResponseVariant2ProjectSettingsWebAnalytics" /> class.
        /// </summary>
        /// <param name="id"></param>
...
#endif
        public CreateDeploymentResponseVariant2ProjectSettingsWebAnalytics(
            string id,
            double? disabledAt,
            double? canceledAt,
            double? enabledAt,
