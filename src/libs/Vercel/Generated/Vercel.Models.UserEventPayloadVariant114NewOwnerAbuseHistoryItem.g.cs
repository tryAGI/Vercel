...
namespace Vercel
{
    ...
    public sealed partial class UserEventPayloadVariant114NewOwnerAbuseHistoryItem
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UserEventPayloadVariant114NewOwnerAbuseHistoryItem" /> class.
        /// </summary>
...
#endif
        public UserEventPayloadVariant114NewOwnerAbuseHistoryItem(
            string scanner,
            string reason,
            string by,
            string byId,
