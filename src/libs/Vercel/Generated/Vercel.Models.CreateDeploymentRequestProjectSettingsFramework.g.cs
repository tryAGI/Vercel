...
namespace Vercel
{
    ...
    public static class CreateDeploymentRequestProjectSettingsFrameworkExtensions
    {
        ...
        public static string ToValueString(this CreateDeploymentRequestProjectSettingsFramework value)
        {
            return value switch
            {
                CreateDeploymentRequestProjectSettingsFramework.ActixWeb => "actix-web",
                CreateDeploymentRequestProjectSettingsFramework.Angular => "angular",
                CreateDeploymentRequestProjectSettingsFramework.Ash => "ash",
                CreateDeploymentRequestProjectSettingsFramework.Astro => "astro",
                CreateDeploymentRequestProjectSettingsFramework.Axum => "axum",
                ...
                CreateDeploymentRequestProjectSettingsFramework.Bun => "bun",
                CreateDeploymentRequestProjectSettingsFramework.Container => "container",
                ...
                CreateDeploymentRequestProjectSettingsFramework.Eve => "eve",
                CreateDeploymentRequestProjectSettingsFramework.Express => "express",
                CreateDeploymentRequestProjectSettingsFramework.FactoryEve => "factory-eve",
                ...
                CreateDeploymentRequestProjectSettingsFramework.SanityV2 => "sanity-v2",
                ...
                CreateDeploymentRequestProjectSettingsFramework.TanstackStartLovable => "tanstack-start-lovable",
        ...
        public static CreateDeploymentRequestProjectSettingsFramework? ToEnum(string value)
        {
            return value switch
            {
                "actix-web" => CreateDeploymentRequestProjectSettingsFramework.ActixWeb,
                "angular" => CreateDeploymentRequestProjectSettingsFramework.Angular,
                "ash" => CreateDeploymentRequestProjectSettingsFramework.Ash,
                "astro" => CreateDeploymentRequestProjectSettingsFramework.Astro,
                "axum" => CreateDeploymentRequestProjectSettingsFramework.Axum,
                ...
                "bun" => CreateDeploymentRequestProjectSettingsFramework.Bun,
                "container" => CreateDeploymentRequestProjectSettingsFramework.Container,
                ...
                "eve" => CreateDeploymentRequestProjectSettingsFramework.Eve,
                "express" => CreateDeploymentRequestProjectSettingsFramework.Express,
                "factory-eve" => CreateDeploymentRequestProjectSettingsFramework.FactoryEve,
                ...
                "sanity-v2" => CreateDeploymentRequestProjectSettingsFramework.SanityV2,
                ...
                "tanstack-start-lovable" => CreateDeploymentRequestProjectSettingsFramework.TanstackStartLovable,
