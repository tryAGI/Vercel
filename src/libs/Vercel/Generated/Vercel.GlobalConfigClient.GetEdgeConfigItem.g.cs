...
namespace Vercel
{
    public partial class GlobalConfigClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_GetEdgeConfigItemSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_GetEdgeConfigItemSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_GetEdgeConfigItemSecurityRequirement0,
            };
        partial void PrepareGetEdgeConfigItemArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string edgeConfigId,
            ref string edgeConfigItemKey,
            ref string? teamId,
            ref string? slug);
        partial void PrepareGetEdgeConfigItemRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? teamId,
            string? slug);
        partial void ProcessGetEdgeConfigItemResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetEdgeConfigItemResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Get a Global Config item<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.GlobalConfigItem> GetEdgeConfigItemAsync(
            string edgeConfigId,
            string edgeConfigItemKey,
        ...
        {
            var __response = await GetEdgeConfigItemAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.GlobalConfigItem>> GetEdgeConfigItemAsResponseAsync(
            string edgeConfigId,
            string edgeConfigItemKey,
            string? teamId = default,
            string? slug = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetEdgeConfigItemArguments(
                httpClient: HttpClient,
                edgeConfigId: ref edgeConfigId,
                edgeConfigItemKey: ref edgeConfigItemKey,
                teamId: ref teamId,
                slug: ref slug);
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetEdgeConfigItemSecurityRequirements,
                operationName: "GetEdgeConfigItemAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Vercel.PathBuilder(
                                path: $"/v1/global-config/{edgeConfigId}/item/{edgeConfigItemKey}",
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetEdgeConfigItemAsync",
                                pathTemplate: "$\"/v1/global-config/{edgeConfigId}/item/{edgeConfigItemKey}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetEdgeConfigItemResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetEdgeConfigItemResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vercel.GlobalConfigItem.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vercel.AutoSDKHttpResponse<global::Vercel.GlobalConfigItem>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vercel.GlobalConfigItem.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
