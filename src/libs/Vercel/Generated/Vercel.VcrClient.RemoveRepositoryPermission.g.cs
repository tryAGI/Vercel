...
namespace Vercel
{
    public partial class VcrClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_RemoveRepositoryPermissionSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_RemoveRepositoryPermissionSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_RemoveRepositoryPermissionSecurityRequirement0,
            };
        partial void PrepareRemoveRepositoryPermissionArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string projectId,
            ref string idOrName,
            ref string? teamId,
            ref string? slug,
            global::Vercel.RemoveRepositoryPermissionRequest request);
        partial void PrepareRemoveRepositoryPermissionRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? slug,
            global::Vercel.RemoveRepositoryPermissionRequest request);
        partial void ProcessRemoveRepositoryPermissionResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessRemoveRepositoryPermissionResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Remove a repository permission<br/>
        ...
        public async global::System.Threading.Tasks.Task<string> RemoveRepositoryPermissionAsync(
            string projectId,
            string idOrName,
        ...
        {
            var __response = await RemoveRepositoryPermissionAsResponseAsync(
                projectId: projectId,
                idOrName: idOrName,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<string>> RemoveRepositoryPermissionAsResponseAsync(
            string projectId,
            string idOrName,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareRemoveRepositoryPermissionArguments(
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_RemoveRepositoryPermissionSecurityRequirements,
                operationName: "RemoveRepositoryPermissionAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareRemoveRepositoryPermissionRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "RemoveRepositoryPermissionAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessRemoveRepositoryPermissionResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessRemoveRepositoryPermissionResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<string> RemoveRepositoryPermissionAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Vercel.RemoveRepositoryPermissionRequest
            {
                TeamId = requestTeamId,
                TeamSlug = teamSlug,
            };

            return await RemoveRepositoryPermissionAsync(
                projectId: projectId,
                idOrName: idOrName,
                teamId: teamId,
                slug: slug,
