...
namespace Vercel
{
    ...
    public sealed partial class CreateKmsIssuerResponseSigningKey
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Vercel.JsonConverters.CreateKmsIssuerResponseSigningKeyStatusJsonConverter))]
        [global::System.Text.Json.Serialization.JsonRequired]
        public required global::Vercel.CreateKmsIssuerResponseSigningKeyStatus Status { get; set; }

        /// <summary>
        ///
        /// </summary>
        [global::System.Text.Json.Serialization.JsonPropertyName("publicKey")]
        public global::Vercel.CreateKmsIssuerResponseSigningKeyPublicKey? PublicKey { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateKmsIssuerResponseSigningKey" /> class.
        /// </summary>
        /// <param name="keyId">
        /// The server-minted, unique record identifier. Use this to address the key on the activate / certificate endpoints.
        /// </param>
...
#endif
        public CreateKmsIssuerResponseSigningKey(
            string keyId,
            string issuerId,
            string algorithm,
            global::Vercel.CreateKmsIssuerResponseSigningKeyStatus status,
            string createdAt,
            string updatedAt,
            string? importKeyId,
            global::Vercel.CreateKmsIssuerResponseSigningKeyPublicKey? publicKey,
