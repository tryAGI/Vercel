...
namespace Vercel
{
    public partial class ProjectsClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_BatchRemoveProjectEnvSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_BatchRemoveProjectEnvSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_BatchRemoveProjectEnvSecurityRequirement0,
            };
        partial void PrepareBatchRemoveProjectEnvArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string idOrName,
            ref string? teamId,
            ref string? slug,
            global::Vercel.BatchRemoveProjectEnvRequest request);
        partial void PrepareBatchRemoveProjectEnvRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? slug,
            global::Vercel.BatchRemoveProjectEnvRequest request);
        partial void ProcessBatchRemoveProjectEnvResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessBatchRemoveProjectEnvResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.BatchRemoveProjectEnvResponse> BatchRemoveProjectEnvAsync(
            string idOrName,
        ...
        {
            var __response = await BatchRemoveProjectEnvAsResponseAsync(
                idOrName: idOrName,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.BatchRemoveProjectEnvResponse>> BatchRemoveProjectEnvAsResponseAsync(
            string idOrName,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareBatchRemoveProjectEnvArguments(
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_BatchRemoveProjectEnvSecurityRequirements,
                operationName: "BatchRemoveProjectEnvAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareBatchRemoveProjectEnvRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "BatchRemoveProjectEnvAsync",
                                pathTemplate: "$\"/v1/projects/{idOrName}/env\"",
                                httpMethod: "DELETE",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessBatchRemoveProjectEnvResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessBatchRemoveProjectEnvResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vercel.BatchRemoveProjectEnvResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vercel.AutoSDKHttpResponse<global::Vercel.BatchRemoveProjectEnvResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vercel.BatchRemoveProjectEnvResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.BatchRemoveProjectEnvResponse> BatchRemoveProjectEnvAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Vercel.BatchRemoveProjectEnvRequest
            {
                Ids = ids,
            };

            return await BatchRemoveProjectEnvAsync(
                idOrName: idOrName,
                teamId: teamId,
                slug: slug,
                request: __request,
