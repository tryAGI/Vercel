...
namespace Vercel
{
    public partial class ProjectsClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_UpdateMicrofrontendsSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_UpdateMicrofrontendsSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_UpdateMicrofrontendsSecurityRequirement0,
            };
        partial void PrepareUpdateMicrofrontendsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string projectId,
            ref string? teamId,
            ref string? slug,
            global::Vercel.UpdateMicrofrontendsRequest request);
        partial void PrepareUpdateMicrofrontendsRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? slug,
            global::Vercel.UpdateMicrofrontendsRequest request);
        partial void ProcessUpdateMicrofrontendsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUpdateMicrofrontendsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKShared100e7eb80f0eb492> UpdateMicrofrontendsAsync(
            string projectId,
        ...
        {
            var __response = await UpdateMicrofrontendsAsResponseAsync(
                projectId: projectId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.AutoSDKShared100e7eb80f0eb492>> UpdateMicrofrontendsAsResponseAsync(
            string projectId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUpdateMicrofrontendsArguments(
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UpdateMicrofrontendsSecurityRequirements,
                operationName: "UpdateMicrofrontendsAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "UpdateMicrofrontendsAsync",
                                pathTemplate: "$\"/v1/projects/{projectId}/microfrontends\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUpdateMicrofrontendsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUpdateMicrofrontendsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vercel.AutoSDKShared100e7eb80f0eb492.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vercel.AutoSDKHttpResponse<global::Vercel.AutoSDKShared100e7eb80f0eb492>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vercel.AutoSDKShared100e7eb80f0eb492.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKShared100e7eb80f0eb492> UpdateMicrofrontendsAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Vercel.UpdateMicrofrontendsRequest
            {
            ...
            return await UpdateMicrofrontendsAsync(
                projectId: projectId,
                teamId: teamId,
                slug: slug,
                request: __request,
