...
namespace Vercel
{
    public partial class GlobalConfigClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_GetEdgeConfigTokenSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_GetEdgeConfigTokenSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_GetEdgeConfigTokenSecurityRequirement0,
            };
        partial void PrepareGetEdgeConfigTokenArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string edgeConfigId,
            ref string token,
            ref string? teamId,
            ref string? slug);
        partial void PrepareGetEdgeConfigTokenRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? teamId,
            string? slug);
        partial void ProcessGetEdgeConfigTokenResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetEdgeConfigTokenResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.GlobalConfigToken> GetEdgeConfigTokenAsync(
            string edgeConfigId,
            string token,
        ...
        {
            var __response = await GetEdgeConfigTokenAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.GlobalConfigToken>> GetEdgeConfigTokenAsResponseAsync(
            string edgeConfigId,
            string token,
            string? teamId = default,
            string? slug = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetEdgeConfigTokenArguments(
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetEdgeConfigTokenSecurityRequirements,
                operationName: "GetEdgeConfigTokenAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetEdgeConfigTokenRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetEdgeConfigTokenAsync",
                                pathTemplate: "$\"/v1/global-config/{edgeConfigId}/token/{token}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetEdgeConfigTokenResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetEdgeConfigTokenResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
