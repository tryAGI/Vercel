...
namespace Vercel
{
    public partial class GlobalConfigClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_GetEdgeConfigSchemaSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_GetEdgeConfigSchemaSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_GetEdgeConfigSchemaSecurityRequirement0,
            };
        partial void PrepareGetEdgeConfigSchemaArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string edgeConfigId,
            ref string? teamId,
            ref string? slug);
        partial void PrepareGetEdgeConfigSchemaRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string edgeConfigId,
            string? teamId,
            string? slug);
        partial void ProcessGetEdgeConfigSchemaResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetEdgeConfigSchemaResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Get Global Config schema<br/>
        ...
        public async global::System.Threading.Tasks.Task<string> GetEdgeConfigSchemaAsync(
            string edgeConfigId,
        ...
        {
            var __response = await GetEdgeConfigSchemaAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<string>> GetEdgeConfigSchemaAsResponseAsync(
            string edgeConfigId,
            string? teamId = default,
            string? slug = default,
            global::Vercel.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetEdgeConfigSchemaArguments(
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetEdgeConfigSchemaSecurityRequirements,
                operationName: "GetEdgeConfigSchemaAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetEdgeConfigSchemaRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetEdgeConfigSchemaAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetEdgeConfigSchemaResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetEdgeConfigSchemaResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
