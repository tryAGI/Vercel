...
namespace Vercel
{
    ...
    public sealed partial class UpdateResourceRequestSecretEnvironmentOverrides
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateResourceRequestSecretEnvironmentOverrides" /> class.
        /// </summary>
...
#endif
        public UpdateResourceRequestSecretEnvironmentOverrides(
            string? development,
            string? preview,
            string? production)
        {
