...
namespace Vercel
{
    ...
    public static class CancelDeploymentResponseProjectSettingsFrameworkExtensions
    {
        ...
        public static string ToValueString(this CancelDeploymentResponseProjectSettingsFramework value)
        {
            return value switch
            {
                CancelDeploymentResponseProjectSettingsFramework.ActixWeb => "actix-web",
                CancelDeploymentResponseProjectSettingsFramework.Angular => "angular",
                CancelDeploymentResponseProjectSettingsFramework.Ash => "ash",
                ...
                CancelDeploymentResponseProjectSettingsFramework.FactoryEve => "factory-eve",
                ...
                CancelDeploymentResponseProjectSettingsFramework.Mastra => "mastra",
                ...
                CancelDeploymentResponseProjectSettingsFramework.TanstackStartLovable => "tanstack-start-lovable",
        ...
        public static CancelDeploymentResponseProjectSettingsFramework? ToEnum(string value)
        {
            return value switch
            {
                "actix-web" => CancelDeploymentResponseProjectSettingsFramework.ActixWeb,
                "angular" => CancelDeploymentResponseProjectSettingsFramework.Angular,
                "ash" => CancelDeploymentResponseProjectSettingsFramework.Ash,
                ...
                "factory-eve" => CancelDeploymentResponseProjectSettingsFramework.FactoryEve,
                ...
                "mastra" => CancelDeploymentResponseProjectSettingsFramework.Mastra,
                ...
                "tanstack-start-lovable" => CancelDeploymentResponseProjectSettingsFramework.TanstackStartLovable,
