...
namespace Vercel
{
    public partial interface IBulkRedirectsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.OneOf<object, global::Vercel.GetRedirectsResponseVariant2, global::Vercel.GetRedirectsResponseVariant3>>> GetRedirectsAsResponseAsync(
            string projectId,
            string? versionId = default,
            string? q = default,
            global::Vercel.OneOf<bool?, global::Vercel.GetRedirectsDiff2?>? diff = default,
