...
namespace Vercel
{
    public partial class RollingReleaseClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_CompleteRollingReleaseSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_CompleteRollingReleaseSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_CompleteRollingReleaseSecurityRequirement0,
            };
        partial void PrepareCompleteRollingReleaseArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string idOrName,
            ref string? teamId,
            ref string? slug,
            global::Vercel.CompleteRollingReleaseRequest request);
        partial void PrepareCompleteRollingReleaseRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? slug,
            global::Vercel.CompleteRollingReleaseRequest request);
        partial void ProcessCompleteRollingReleaseResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCompleteRollingReleaseResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.CompleteRollingReleaseResponse> CompleteRollingReleaseAsync(
            string idOrName,
        ...
        {
            var __response = await CompleteRollingReleaseAsResponseAsync(
                idOrName: idOrName,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.CompleteRollingReleaseResponse>> CompleteRollingReleaseAsResponseAsync(
            string idOrName,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCompleteRollingReleaseArguments(
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CompleteRollingReleaseSecurityRequirements,
                operationName: "CompleteRollingReleaseAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCompleteRollingReleaseRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "CompleteRollingReleaseAsync",
                                pathTemplate: "$\"/v1/projects/{idOrName}/rolling-release/complete\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCompleteRollingReleaseResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCompleteRollingReleaseResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vercel.CompleteRollingReleaseResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vercel.AutoSDKHttpResponse<global::Vercel.CompleteRollingReleaseResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vercel.CompleteRollingReleaseResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.CompleteRollingReleaseResponse> CompleteRollingReleaseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Vercel.CompleteRollingReleaseRequest
            {
                CanaryDeploymentId = canaryDeploymentId,
            };

            return await CompleteRollingReleaseAsync(
                idOrName: idOrName,
                teamId: teamId,
                slug: slug,
                request: __request,
