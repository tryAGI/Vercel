...
namespace Vercel
{
    public partial interface IAccessGroupsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.ListAccessGroupProjectsResponse>> ListAccessGroupProjectsAsResponseAsync(
            string idOrName,
            int? limit = default,
            string? next = default,
            string? teamId = default,
