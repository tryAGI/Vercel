...
namespace Vercel
{
    public partial class TeamsClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_RequestAccessToTeamSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_RequestAccessToTeamSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_RequestAccessToTeamSecurityRequirement0,
            };
        partial void PrepareRequestAccessToTeamArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string teamId,
            global::Vercel.RequestAccessToTeamRequest request);
        partial void PrepareRequestAccessToTeamRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string teamId,
            global::Vercel.RequestAccessToTeamRequest request);
        partial void ProcessRequestAccessToTeamResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessRequestAccessToTeamResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.RequestAccessToTeamResponse> RequestAccessToTeamAsync(
            string teamId,
        ...
        {
            var __response = await RequestAccessToTeamAsResponseAsync(
                teamId: teamId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.RequestAccessToTeamResponse>> RequestAccessToTeamAsResponseAsync(
            string teamId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareRequestAccessToTeamArguments(
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_RequestAccessToTeamSecurityRequirements,
                operationName: "RequestAccessToTeamAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "RequestAccessToTeamAsync",
                                pathTemplate: "$\"/v1/teams/{teamId}/request\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessRequestAccessToTeamResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessRequestAccessToTeamResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vercel.RequestAccessToTeamResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vercel.AutoSDKHttpResponse<global::Vercel.RequestAccessToTeamResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vercel.RequestAccessToTeamResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.RequestAccessToTeamResponse> RequestAccessToTeamAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Vercel.RequestAccessToTeamRequest
            {
                JoinedFrom = joinedFrom,
            };

            return await RequestAccessToTeamAsync(
                teamId: teamId,
                request: __request,
                requestOptions: requestOptions,
