...
namespace Vercel
{
    ...
    public sealed partial class GetMicrofrontendsInGroupResponseProjectExpirationVariant2
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetMicrofrontendsInGroupResponseProjectExpirationVariant2" /> class.
        /// </summary>
        /// <param name="lockedAt">
        /// Unix ms timestamp when the project was locked.
        /// </param>
...
#endif
        public GetMicrofrontendsInGroupResponseProjectExpirationVariant2(
            double lockedAt,
            string lockedBy,
            double version)
        {
