...
namespace Vercel
{
    public partial class KmsClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_ActivateKmsSigningKeySecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_ActivateKmsSigningKeySecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_ActivateKmsSigningKeySecurityRequirement0,
            };
        partial void PrepareActivateKmsSigningKeyArguments(
        ...
        partial void PrepareActivateKmsSigningKeyRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? slug,
            global::Vercel.ActivateKmsSigningKeyRequest request);
        partial void ProcessActivateKmsSigningKeyResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessActivateKmsSigningKeyResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.ActivateKmsSigningKeyResponse> ActivateKmsSigningKeyAsync(
            string issuerId,
            string keyId,
        ...
        {
            var __response = await ActivateKmsSigningKeyAsResponseAsync(
                issuerId: issuerId,
                keyId: keyId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.ActivateKmsSigningKeyResponse>> ActivateKmsSigningKeyAsResponseAsync(
            string issuerId,
            string keyId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareActivateKmsSigningKeyArguments(
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ActivateKmsSigningKeySecurityRequirements,
                operationName: "ActivateKmsSigningKeyAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareActivateKmsSigningKeyRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "ActivateKmsSigningKeyAsync",
                                pathTemplate: "$\"/v1/kms/issuers/{issuerId}/keys/{keyId}/activate\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessActivateKmsSigningKeyResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessActivateKmsSigningKeyResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vercel.ActivateKmsSigningKeyResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vercel.AutoSDKHttpResponse<global::Vercel.ActivateKmsSigningKeyResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vercel.ActivateKmsSigningKeyResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.ActivateKmsSigningKeyResponse> ActivateKmsSigningKeyAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Vercel.ActivateKmsSigningKeyRequest
            {
                RevokePreviousAfterHours = revokePreviousAfterHours,
            };

            return await ActivateKmsSigningKeyAsync(
                issuerId: issuerId,
                keyId: keyId,
                teamId: teamId,
                slug: slug,
