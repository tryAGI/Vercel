...
namespace Vercel
{
    ...
    public sealed partial class GetDeploymentResponseVariant1ImagesRemotePattern
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Vercel.JsonConverters.GetDeploymentResponseVariant1ImagesRemotePatternProtocolJsonConverter))]
        public global::Vercel.GetDeploymentResponseVariant1ImagesRemotePatternProtocol? Protocol { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetDeploymentResponseVariant1ImagesRemotePattern" /> class.
        /// </summary>
        /// <param name="hostname">
        /// Can be literal or wildcard. Single `*` matches a single subdomain. Double `**` matches any number of subdomains.
        /// </param>
...
#endif
        public GetDeploymentResponseVariant1ImagesRemotePattern(
            string hostname,
            global::Vercel.GetDeploymentResponseVariant1ImagesRemotePatternProtocol? protocol,
            string? port,
            string? pathname,
            string? search)
        {
