...
namespace Vercel
{
    ...
    public sealed partial class GetDeploymentResponseVariant1ProjectSettingsWebAnalytics
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetDeploymentResponseVariant1ProjectSettingsWebAnalytics" /> class.
        /// </summary>
        /// <param name="id"></param>
...
#endif
        public GetDeploymentResponseVariant1ProjectSettingsWebAnalytics(
            string id,
            double? disabledAt,
            double? canceledAt,
            double? enabledAt,
