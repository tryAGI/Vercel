...
namespace Vercel
{
    public partial class SandboxesClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_RunCommandAsStreamSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_RunCommandAsStreamSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_RunCommandAsStreamSecurityRequirement0,
            };
        partial void PrepareRunCommandAsStreamArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string sandboxId,
            ref string? teamId,
            ref string? slug,
            global::Vercel.RunCommandRequest request);
        partial void PrepareRunCommandAsStreamRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? slug,
            global::Vercel.RunCommandRequest request);
        partial void ProcessRunCommandAsStreamResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Collections.Generic.IAsyncEnumerable<global::Vercel.RunCommandResponse2> RunCommandAsStreamAsync(
            string sandboxId,
            ...
            [global::System.Runtime.CompilerServices.EnumeratorCancellation] global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareRunCommandAsStreamArguments(
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_RunCommandAsStreamSecurityRequirements,
                operationName: "RunCommandAsStreamAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "RunCommandAsStream",
                                methodName: "RunCommandAsStreamAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessRunCommandAsStreamResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            while (!__reader.EndOfStream && !__effectiveCancellationToken.IsCancellationRequested)
                            {
                                ...
                                var __streamedResponse = global::Vercel.RunCommandResponse2.FromJson(__content, JsonSerializerContext) ??
                                                       throw new global::Vercel.ApiException(
            ...
            [global::System.Runtime.CompilerServices.EnumeratorCancellation] global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __enumerable = RunCommandAsStreamAsync(
                sandboxId: sandboxId,
                teamId: teamId,
                slug: slug,
                request: __request,
