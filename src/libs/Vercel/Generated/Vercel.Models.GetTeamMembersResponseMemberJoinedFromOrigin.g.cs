...
namespace Vercel
{
    ...
    public static class GetTeamMembersResponseMemberJoinedFromOriginExtensions
    {
        ...
        public static string ToValueString(this GetTeamMembersResponseMemberJoinedFromOrigin value)
        {
            return value switch
            {
                GetTeamMembersResponseMemberJoinedFromOrigin.AccountUpdate => "account-update",
                ...
                GetTeamMembersResponseMemberJoinedFromOrigin.NsnbRedeployAttributionCard => "nsnb-redeploy-attribution-card",
        ...
        public static GetTeamMembersResponseMemberJoinedFromOrigin? ToEnum(string value)
        {
            return value switch
            {
                "account-update" => GetTeamMembersResponseMemberJoinedFromOrigin.AccountUpdate,
                ...
                "nsnb-redeploy-attribution-card" => GetTeamMembersResponseMemberJoinedFromOrigin.NsnbRedeployAttributionCard,
