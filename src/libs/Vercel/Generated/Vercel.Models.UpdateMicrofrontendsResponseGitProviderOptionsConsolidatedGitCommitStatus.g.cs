...
namespace Vercel
{
    ...
    public sealed partial class UpdateMicrofrontendsResponseGitProviderOptionsConsolidatedGitCommitStatus
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateMicrofrontendsResponseGitProviderOptionsConsolidatedGitCommitStatus" /> class.
        /// </summary>
        /// <param name="enabled">
        /// Whether consolidated commit status is enabled.
        /// </param>
...
#endif
        public UpdateMicrofrontendsResponseGitProviderOptionsConsolidatedGitCommitStatus(
            bool enabled,
