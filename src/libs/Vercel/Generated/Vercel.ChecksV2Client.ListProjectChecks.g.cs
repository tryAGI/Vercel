...
namespace Vercel
{
    public partial class ChecksV2Client
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_ListProjectChecksSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_ListProjectChecksSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_ListProjectChecksSecurityRequirement0,
            };
        partial void PrepareListProjectChecksArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string projectIdOrName,
            ref global::Vercel.ListProjectChecksBlocks? blocks,
            ref string? teamId,
            ref string? slug);
        partial void PrepareListProjectChecksRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string projectIdOrName,
            global::Vercel.ListProjectChecksBlocks? blocks,
            string? teamId,
            string? slug);
        partial void ProcessListProjectChecksResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessListProjectChecksResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.ListProjectChecksResponse> ListProjectChecksAsync(
            string projectIdOrName,
        ...
        {
            var __response = await ListProjectChecksAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.ListProjectChecksResponse>> ListProjectChecksAsResponseAsync(
            string projectIdOrName,
            global::Vercel.ListProjectChecksBlocks? blocks = default,
            string? teamId = default,
            string? slug = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareListProjectChecksArguments(
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ListProjectChecksSecurityRequirements,
                operationName: "ListProjectChecksAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            __pathBuilder
                                .AddOptionalParameter("blocks", blocks?.ToValueString())
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "ListProjectChecksAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessListProjectChecksResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListProjectChecksResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vercel.ListProjectChecksResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vercel.AutoSDKHttpResponse<global::Vercel.ListProjectChecksResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vercel.ListProjectChecksResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
