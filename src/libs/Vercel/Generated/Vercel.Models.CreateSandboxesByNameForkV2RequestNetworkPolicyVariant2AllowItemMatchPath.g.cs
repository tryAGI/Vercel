...
namespace Vercel
{
    ...
    public sealed partial class CreateSandboxesByNameForkV2RequestNetworkPolicyVariant2AllowItemMatchPath
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateSandboxesByNameForkV2RequestNetworkPolicyVariant2AllowItemMatchPath" /> class.
        /// </summary>
        /// <param name="exact">
        /// Match the value exactly. Case-sensitive for paths, header values, and methods; case-insensitive for domains and header keys.
        /// </param>
...
#endif
        public CreateSandboxesByNameForkV2RequestNetworkPolicyVariant2AllowItemMatchPath(
            string? exact,
            string? startsWith)
        {
            this.Exact = exact;
