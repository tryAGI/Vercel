...
namespace Vercel
{
    ...
    public sealed partial class CreateKmsSigningKeyResponse
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Vercel.JsonConverters.CreateKmsSigningKeyResponseStatusJsonConverter))]
        [global::System.Text.Json.Serialization.JsonRequired]
        public required global::Vercel.CreateKmsSigningKeyResponseStatus Status { get; set; }

        /// <summary>
        /// 
        /// </summary>
        [global::System.Text.Json.Serialization.JsonPropertyName("publicKey")]
        public global::Vercel.CreateKmsSigningKeyResponsePublicKey? PublicKey { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateKmsSigningKeyResponse" /> class.
        /// </summary>
        /// <param name="keyId">
        /// The server-minted, unique record identifier. Use this to address the key on the activate / certificate endpoints.
        /// </param>
...
#endif
        public CreateKmsSigningKeyResponse(
            string keyId,
            string issuerId,
            string algorithm,
            global::Vercel.CreateKmsSigningKeyResponseStatus status,
            string createdAt,
            string updatedAt,
            string? importKeyId,
            global::Vercel.CreateKmsSigningKeyResponsePublicKey? publicKey,
