...
namespace Vercel
{
    public partial class SandboxesV2BetaClient
    {
        ...
        partial void PrepareGetSessionCommandArguments(
            ...
            ref string cmdId,
            ref global::Vercel.GetSessionCommandWait? wait,
            ref string? teamId,
            ref string? slug);
        partial void PrepareGetSessionCommandRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string sessionId,
            string cmdId,
            global::Vercel.GetSessionCommandWait? wait,
            string? teamId,
            string? slug);
        partial void ProcessGetSessionCommandResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.GetSessionCommandResponse> GetSessionCommandAsync(
            string sessionId,
            string cmdId,
        ...
        {
            var __response = await GetSessionCommandAsResponseAsync(
                sessionId: sessionId,
                cmdId: cmdId,
                wait: wait,
                teamId: teamId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.GetSessionCommandResponse>> GetSessionCommandAsResponseAsync(
            string sessionId,
            string cmdId,
            global::Vercel.GetSessionCommandWait? wait = default,
            string? teamId = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetSessionCommandArguments(
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetSessionCommandAsync",
                                pathTemplate: "$\"/v2/sandboxes/sessions/{sessionId}/cmd/{cmdId}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetSessionCommandResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetSessionCommandResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vercel.GetSessionCommandResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vercel.AutoSDKHttpResponse<global::Vercel.GetSessionCommandResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vercel.GetSessionCommandResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
