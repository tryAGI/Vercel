...
namespace Vercel
{
    public partial interface INetworkingClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::Vercel.Network>>> ListNetworksAsResponseAsync(
            bool? includeHostedZones = default,
            bool? includePeeringConnections = default,
            bool? includeProjects = default,
            string? search = default,
