...
namespace Vercel
{
    ...
    public sealed partial class UpdateMicrofrontendsResponseLatestDeploymentCreator
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateMicrofrontendsResponseLatestDeploymentCreator" /> class.
        /// </summary>
...
#endif
        public UpdateMicrofrontendsResponseLatestDeploymentCreator(
            string email,
            string uid,
            string username,
            string? githubLogin,
