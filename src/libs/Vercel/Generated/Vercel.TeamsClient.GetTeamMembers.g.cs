...
namespace Vercel
{
    public partial class TeamsClient
    {
        ...
        partial void PrepareGetTeamMembersArguments(
            ...
            ref double? until,
            ref string? search,
            ref global::Vercel.GetTeamMembersRole? role,
            ref string? excludeProject,
            ref string? eligibleMembersForProjectId,
            ref string teamId,
            ref string? slug);
        partial void PrepareGetTeamMembersRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            double? until,
            string? search,
            global::Vercel.GetTeamMembersRole? role,
            string? excludeProject,
            string? eligibleMembersForProjectId,
            string teamId,
            string? slug);
        partial void ProcessGetTeamMembersResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetTeamMembersResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.GetTeamMembersResponse> GetTeamMembersAsync(
            string teamId,
        ...
        {
            var __response = await GetTeamMembersAsResponseAsync(
                teamId: teamId,
                limit: limit,
                since: since,
                until: until,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.GetTeamMembersResponse>> GetTeamMembersAsResponseAsync(
            string teamId,
            double? limit = default,
            double? since = default,
            double? until = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetTeamMembersArguments(
                ...
                search: ref search,
                role: ref role,
                excludeProject: ref excludeProject,
                eligibleMembersForProjectId: ref eligibleMembersForProjectId,
                teamId: ref teamId,
                slug: ref slug);
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetTeamMembersAsync",
                                pathTemplate: "$\"/v3/teams/{teamId}/members\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetTeamMembersResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vercel.GetTeamMembersResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vercel.AutoSDKHttpResponse<global::Vercel.GetTeamMembersResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vercel.GetTeamMembersResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
