...
namespace Vercel
{
    public partial class VcrClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_AddRepositoryPermissionSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_AddRepositoryPermissionSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_AddRepositoryPermissionSecurityRequirement0,
            };
        partial void PrepareAddRepositoryPermissionArguments(
        ...
        partial void PrepareAddRepositoryPermissionRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? slug,
            global::Vercel.AddRepositoryPermissionRequest request);
        partial void ProcessAddRepositoryPermissionResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessAddRepositoryPermissionResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.AddRepositoryPermissionResponse> AddRepositoryPermissionAsync(
            string projectId,
            string idOrName,
        ...
        {
            var __response = await AddRepositoryPermissionAsResponseAsync(
                projectId: projectId,
                idOrName: idOrName,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.AddRepositoryPermissionResponse>> AddRepositoryPermissionAsResponseAsync(
            string projectId,
            string idOrName,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareAddRepositoryPermissionArguments(
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_AddRepositoryPermissionSecurityRequirements,
                operationName: "AddRepositoryPermissionAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareAddRepositoryPermissionRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "AddRepositoryPermissionAsync",
                                pathTemplate: "$\"/v1/vcr/repository/{idOrName}/permissions\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessAddRepositoryPermissionResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessAddRepositoryPermissionResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vercel.AddRepositoryPermissionResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vercel.AutoSDKHttpResponse<global::Vercel.AddRepositoryPermissionResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vercel.AddRepositoryPermissionResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.AddRepositoryPermissionResponse> AddRepositoryPermissionAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Vercel.AddRepositoryPermissionRequest
            {
                TeamId = requestTeamId,
                TeamSlug = teamSlug,
            };

            return await AddRepositoryPermissionAsync(
                projectId: projectId,
                idOrName: idOrName,
                teamId: teamId,
                slug: slug,
