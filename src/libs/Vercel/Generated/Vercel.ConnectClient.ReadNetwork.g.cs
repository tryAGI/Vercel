...
namespace Vercel
{
    public partial class ConnectClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_ReadNetworkSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_ReadNetworkSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_ReadNetworkSecurityRequirement0,
            };
        partial void PrepareReadNetworkArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string networkId,
            ref string? teamId,
            ref string? slug);
        partial void PrepareReadNetworkRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string networkId,
            string? teamId,
            string? slug);
        partial void ProcessReadNetworkResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessReadNetworkResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.Network> ReadNetworkAsync(
            string networkId,
        ...
        {
            var __response = await ReadNetworkAsResponseAsync(
                networkId: networkId,
                teamId: teamId,
                slug: slug,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.Network>> ReadNetworkAsResponseAsync(
            string networkId,
            string? teamId = default,
            string? slug = default,
            global::Vercel.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ReadNetworkSecurityRequirements,
                operationName: "ReadNetworkAsync");
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessReadNetworkResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
