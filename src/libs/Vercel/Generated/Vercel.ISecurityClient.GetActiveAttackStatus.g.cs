...
namespace Vercel
{
    public partial interface ISecurityClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.OneOf<object, global::Vercel.GetActiveAttackStatusResponseVariant2>>> GetActiveAttackStatusAsResponseAsync(
            string projectId,
            double? since = default,
            string? teamId = default,
            string? slug = default,
