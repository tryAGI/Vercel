...
namespace Vercel
{
    ...
    public sealed partial class CreateSandboxesByNameForkV3RequestNetworkPolicyVariant2AllowItemMatchHeaderKey
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateSandboxesByNameForkV3RequestNetworkPolicyVariant2AllowItemMatchHeaderKey" /> class.
        /// </summary>
        /// <param name="exact">
        /// Match the value exactly. Case-sensitive for paths, header values, and methods; case-insensitive for domains and header keys.
        /// </param>
...
#endif
        public CreateSandboxesByNameForkV3RequestNetworkPolicyVariant2AllowItemMatchHeaderKey(
            string? exact,
            string? startsWith)
        {
            this.Exact = exact;
