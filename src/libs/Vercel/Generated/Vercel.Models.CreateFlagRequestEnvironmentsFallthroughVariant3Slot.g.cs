...
namespace Vercel
{
    ...
    public sealed partial class CreateFlagRequestEnvironmentsFallthroughVariant3Slot
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateFlagRequestEnvironmentsFallthroughVariant3Slot" /> class.
        /// </summary>
        /// <param name="promille">
        /// Promille of traffic for rollToVariant (0-100_000, where 1_000 = 1%)
        /// </param>
...
#endif
        public CreateFlagRequestEnvironmentsFallthroughVariant3Slot(
            double promille,
            double durationMs)
        {
