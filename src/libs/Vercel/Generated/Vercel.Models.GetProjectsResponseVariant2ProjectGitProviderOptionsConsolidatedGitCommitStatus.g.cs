...
namespace Vercel
{
    ...
    public sealed partial class GetProjectsResponseVariant2ProjectGitProviderOptionsConsolidatedGitCommitStatus
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetProjectsResponseVariant2ProjectGitProviderOptionsConsolidatedGitCommitStatus" /> class.
        /// </summary>
        /// <param name="enabled">
        /// Whether consolidated commit status is enabled.
        /// </param>
...
#endif
        public GetProjectsResponseVariant2ProjectGitProviderOptionsConsolidatedGitCommitStatus(
            bool enabled,
