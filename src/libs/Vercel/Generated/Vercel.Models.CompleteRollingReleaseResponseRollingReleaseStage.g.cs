...
namespace Vercel
{
    ...
    public sealed partial class CompleteRollingReleaseResponseRollingReleaseStage
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CompleteRollingReleaseResponseRollingReleaseStage" /> class.
        /// </summary>
        /// <param name="index">
        /// The zero-based index of the stage<br/>
        /// Example: 0
...
#endif
        public CompleteRollingReleaseResponseRollingReleaseStage(
            double index,
            bool isFinalStage,
