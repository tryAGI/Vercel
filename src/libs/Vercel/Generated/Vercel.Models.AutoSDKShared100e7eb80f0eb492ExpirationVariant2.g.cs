...
namespace Vercel
{
    ...
    public sealed partial class AutoSDKShared100e7eb80f0eb492ExpirationVariant2
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AutoSDKShared100e7eb80f0eb492ExpirationVariant2" /> class.
        /// </summary>
        /// <param name="lockedAt">
        /// Unix ms timestamp when the project was locked.
        /// </param>
...
#endif
        public AutoSDKShared100e7eb80f0eb492ExpirationVariant2(
            double lockedAt,
            string lockedBy)
        {
