...
namespace Vercel
{
    ...
    public sealed partial class GetProjectsResponseVariant2ProjectSpeedInsights
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetProjectsResponseVariant2ProjectSpeedInsights" /> class.
        /// </summary>
        /// <param name="id"></param>
...
#endif
        public GetProjectsResponseVariant2ProjectSpeedInsights(
            string id,
            double? enabledAt,
            double? disabledAt,
            double? canceledAt,
