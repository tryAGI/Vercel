...
namespace Vercel
{
    public partial interface IFeatureFlagsClient
    {
        ...
        global::System.Threading.Tasks.Task<global::Vercel.Flag> GetFlagAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.Flag>> GetFlagAsResponseAsync(
            string projectIdOrName,
            string flagIdOrSlug,
            string? ifMatch = default,
            bool? withMetadata = default,
