...
namespace Vercel
{
    ...
    public sealed partial class GenerateFirewallRuleResponseRuleActionMitigateRateLimit
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GenerateFirewallRuleResponseRuleActionMitigateRateLimit" /> class.
        /// </summary>
...
#endif
        public GenerateFirewallRuleResponseRuleActionMitigateRateLimit(
            string algo,
            double window,
            double limit,
            ...
            string? action)
        {
            this.Algo = algo ?? throw new global::System.ArgumentNullException(nameof(algo));
            this.Window = window;
            this.Limit = limit;
