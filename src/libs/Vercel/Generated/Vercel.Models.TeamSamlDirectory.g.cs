...
namespace Vercel
{
    ...
    public sealed partial class TeamSamlDirectory
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Vercel.JsonConverters.TeamSamlDirectorySyncStateJsonConverter))]
        public global::Vercel.TeamSamlDirectorySyncState? SyncState { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TeamSamlDirectory" /> class.
        /// </summary>
        /// <param name="type">
        /// The Identity Provider "type", for example Okta.<br/>
        /// Example: OktaSAML
        ...
        public TeamSamlDirectory(
            ...
            double? lastSyncedAt,
            global::Vercel.TeamSamlDirectorySyncState? syncState)
        {
