...
namespace Vercel
{
    ...
    public sealed partial class CreateProjectResponseAbuseBlockRegisteredShaBlock
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateProjectResponseAbuseBlockRegisteredShaBlock" /> class.
        /// </summary>
...
#endif
        public CreateProjectResponseAbuseBlockRegisteredShaBlock(
            string createdAt,
            string createdBy,
            string sha)
        {
