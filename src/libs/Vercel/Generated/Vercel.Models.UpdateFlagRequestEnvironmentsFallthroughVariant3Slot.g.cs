...
namespace Vercel
{
    ...
    public sealed partial class UpdateFlagRequestEnvironmentsFallthroughVariant3Slot
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateFlagRequestEnvironmentsFallthroughVariant3Slot" /> class.
        /// </summary>
        /// <param name="promille">
        /// Promille of traffic for rollToVariant (0-100_000, where 1_000 = 1%)
        /// </param>
...
#endif
        public UpdateFlagRequestEnvironmentsFallthroughVariant3Slot(
            double promille,
            double durationMs)
        {
