...
namespace Vercel
{
    public partial interface IEnvironmentClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.GetProjectsByIdOrNameCustomEnvironmentsResponse>> GetProjectsByIdOrNameCustomEnvironmentsAsResponseAsync(
            string idOrName,
            string? gitBranch = default,
            string? teamId = default,
            string? slug = default,
