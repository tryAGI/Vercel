...
namespace Vercel
{
    public partial class KmsClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_RevokeKmsSigningKeySecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_RevokeKmsSigningKeySecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_RevokeKmsSigningKeySecurityRequirement0,
            };
        partial void PrepareRevokeKmsSigningKeyArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string issuerId,
            ref string keyId,
            ref string? teamId,
            ref string? slug);
        partial void PrepareRevokeKmsSigningKeyRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? teamId,
            string? slug);
        partial void ProcessRevokeKmsSigningKeyResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessRevokeKmsSigningKeyResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKShared6a7dd045a7a1bf61> RevokeKmsSigningKeyAsync(
            string issuerId,
            string keyId,
        ...
        {
            var __response = await RevokeKmsSigningKeyAsResponseAsync(
                issuerId: issuerId,
                keyId: keyId,
                teamId: teamId,
                slug: slug,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.AutoSDKShared6a7dd045a7a1bf61>> RevokeKmsSigningKeyAsResponseAsync(
            string issuerId,
            string keyId,
            string? teamId = default,
            string? slug = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareRevokeKmsSigningKeyArguments(
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_RevokeKmsSigningKeySecurityRequirements,
                operationName: "RevokeKmsSigningKeyAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Vercel.PathBuilder(
                                path: $"/v1/kms/issuers/{issuerId}/keys/{keyId}/revoke",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareRevokeKmsSigningKeyRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "RevokeKmsSigningKeyAsync",
                                pathTemplate: "$\"/v1/kms/issuers/{issuerId}/keys/{keyId}/revoke\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessRevokeKmsSigningKeyResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessRevokeKmsSigningKeyResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vercel.AutoSDKShared6a7dd045a7a1bf61.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vercel.AutoSDKHttpResponse<global::Vercel.AutoSDKShared6a7dd045a7a1bf61>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vercel.AutoSDKShared6a7dd045a7a1bf61.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
