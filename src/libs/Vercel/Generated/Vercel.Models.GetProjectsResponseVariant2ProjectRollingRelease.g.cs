...
namespace Vercel
{
    ...
    public sealed partial class GetProjectsResponseVariant2ProjectRollingRelease
    {
        ...
        public global::System.Collections.Generic.IList<global::Vercel.GetProjectsResponseVariant2ProjectRollingReleaseStage>? Stages { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetProjectsResponseVariant2ProjectRollingRelease" /> class.
        /// </summary>
        /// <param name="target">
        /// The environment that the release targets, currently only supports production. Adding in case we want to configure with alias groups or custom environments.<br/>
        /// Example: production
