...
namespace Vercel
{
    ...
    public sealed partial class CreateSandboxesSessionsBySessionIdFsMkdirRequest
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateSandboxesSessionsBySessionIdFsMkdirRequest" /> class.
        /// </summary>
        /// <param name="path">
        /// The path of the directory to create. Can be absolute or relative to the working directory.<br/>
        /// Example: src/components
...
#endif
        public CreateSandboxesSessionsBySessionIdFsMkdirRequest(
            string path,
            string? cwd,
            bool? recursive)
        {
