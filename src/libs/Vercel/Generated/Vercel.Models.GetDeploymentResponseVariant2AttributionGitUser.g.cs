...
namespace Vercel
{
    ...
    public sealed partial class GetDeploymentResponseVariant2AttributionGitUser
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetDeploymentResponseVariant2AttributionGitUser" /> class.
        /// </summary>
        /// <param name="id"></param>
        /// <param name="login">
        /// Git provider username/login
...
#endif
        public GetDeploymentResponseVariant2AttributionGitUser(
