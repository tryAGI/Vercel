...
namespace Vercel
{
    ...
    public sealed partial class UserEventPayloadVariant122NewOwnerResourceConfigSecurity
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UserEventPayloadVariant122NewOwnerResourceConfigSecurity" /> class.
        /// </summary>
...
#endif
        public UserEventPayloadVariant122NewOwnerResourceConfigSecurity(
            double? customRules,
            double? ipBlocks,
            double? ipBypass,
            double? rateLimit)
