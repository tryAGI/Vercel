...
namespace Vercel
{
    ...
    public sealed partial class CreateProjectResponseAbuseBlockHistoryItemVariant1
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Vercel.JsonConverters.CreateProjectResponseAbuseBlockHistoryItemVariant1ActionJsonConverter))]
        public global::Vercel.CreateProjectResponseAbuseBlockHistoryItemVariant1Action Action { get; set; }
        ...
        public global::Vercel.CreateProjectResponseAbuseBlockHistoryItemVariant1RegisteredShaBlock? RegisteredShaBlock { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateProjectResponseAbuseBlockHistoryItemVariant1" /> class.
        /// </summary>
...
#endif
        public CreateProjectResponseAbuseBlockHistoryItemVariant1(
            double createdAt,
            string reason,
            double statusCode,
            global::Vercel.CreateProjectResponseAbuseBlockHistoryItemVariant1Action action,
            string? actor,
            string? caseId,
            string? comment,
            bool? ineligibleForAppeal,
            bool? isCascading,
            global::Vercel.CreateProjectResponseAbuseBlockHistoryItemVariant1RegisteredShaBlock? registeredShaBlock)
        {
            this.Action = action;
            this.Actor = actor;
            this.CaseId = caseId;
