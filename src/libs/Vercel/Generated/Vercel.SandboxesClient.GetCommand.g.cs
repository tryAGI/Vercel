...
namespace Vercel
{
    public partial class SandboxesClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_GetCommandSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_GetCommandSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_GetCommandSecurityRequirement0,
            };
        partial void PrepareGetCommandArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string sandboxId,
            ref string cmdId,
            ref global::Vercel.GetCommandWait? wait,
            ref string? teamId,
            ref string? slug);
        partial void PrepareGetCommandRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string sandboxId,
            string cmdId,
            global::Vercel.GetCommandWait? wait,
            string? teamId,
            string? slug);
        partial void ProcessGetCommandResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetCommandResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.GetCommandResponse> GetCommandAsync(
            string sandboxId,
            string cmdId,
        ...
        {
            var __response = await GetCommandAsResponseAsync(
                sandboxId: sandboxId,
                cmdId: cmdId,
                wait: wait,
                teamId: teamId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.GetCommandResponse>> GetCommandAsResponseAsync(
            string sandboxId,
            string cmdId,
            global::Vercel.GetCommandWait? wait = default,
            string? teamId = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetCommandSecurityRequirements,
                operationName: "GetCommandAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Vercel.PathBuilder(
                                path: $"/v1/sandboxes/{sandboxId}/cmd/{cmdId}",
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetCommandAsync",
                                pathTemplate: "$\"/v1/sandboxes/{sandboxId}/cmd/{cmdId}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetCommandResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vercel.GetCommandResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vercel.AutoSDKHttpResponse<global::Vercel.GetCommandResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vercel.GetCommandResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
