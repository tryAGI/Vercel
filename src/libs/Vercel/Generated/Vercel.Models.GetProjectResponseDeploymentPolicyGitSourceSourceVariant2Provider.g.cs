...
namespace Vercel
{
    ...
    public static class GetProjectResponseDeploymentPolicyGitSourceSourceVariant2ProviderExtensions
    {
        ...
        public static string ToValueString(this GetProjectResponseDeploymentPolicyGitSourceSourceVariant2Provider value)
        {
            return value switch
            {
                GetProjectResponseDeploymentPolicyGitSourceSourceVariant2Provider.Bitbucket => "bitbucket",
                GetProjectResponseDeploymentPolicyGitSourceSourceVariant2Provider.Github => "github",
        ...
        public static GetProjectResponseDeploymentPolicyGitSourceSourceVariant2Provider? ToEnum(string value)
        {
            return value switch
            {
                "bitbucket" => GetProjectResponseDeploymentPolicyGitSourceSourceVariant2Provider.Bitbucket,
                "github" => GetProjectResponseDeploymentPolicyGitSourceSourceVariant2Provider.Github,
