...
namespace Vercel
{
    public partial class DomainsRegistrarClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_GetContactInfoSchemaSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_GetContactInfoSchemaSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_GetContactInfoSchemaSecurityRequirement0,
            };
        partial void PrepareGetContactInfoSchemaArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string domain,
            ref string? teamId);
        partial void PrepareGetContactInfoSchemaRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string domain,
            string? teamId);
        partial void ProcessGetContactInfoSchemaResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetContactInfoSchemaResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> GetContactInfoSchemaAsync(
            string domain,
            string? teamId = default,
            global::Vercel.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetContactInfoSchemaAsResponseAsync(
                domain: domain,
                teamId: teamId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<string>> GetContactInfoSchemaAsResponseAsync(
            string domain,
            string? teamId = default,
            global::Vercel.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetContactInfoSchemaArguments(
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetContactInfoSchemaSecurityRequirements,
                operationName: "GetContactInfoSchemaAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetContactInfoSchemaAsync",
                                pathTemplate: "$\"/v1/registrar/domains/{domain}/contact-info/schema\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetContactInfoSchemaResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                global::Vercel.AnyOf<global::Vercel.BadRequest, global::Vercel.HttpApiDecodeError>? __value_400 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_400 = global::Vercel.AnyOf<global::Vercel.BadRequest, global::Vercel.HttpApiDecodeError>.FromJson(__content_400, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Vercel.ApiException<global::Vercel.AnyOf<global::Vercel.BadRequest, global::Vercel.HttpApiDecodeError>?>.Create(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetContactInfoSchemaResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
