...
namespace Vercel
{
    public partial class EnvironmentClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_GetSharedEnvVarSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_GetSharedEnvVarSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_GetSharedEnvVarSecurityRequirement0,
            };
        partial void PrepareGetSharedEnvVarArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id,
            ref string? teamId,
            ref string? slug);
        partial void PrepareGetSharedEnvVarRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string id,
            string? teamId,
            string? slug);
        partial void ProcessGetSharedEnvVarResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetSharedEnvVarResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Retrieve the decrypted value of a Shared Environment Variable by id.<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKShared3123f815641fd36d> GetSharedEnvVarAsync(
            string id,
        ...
        {
            var __response = await GetSharedEnvVarAsResponseAsync(
                id: id,
                teamId: teamId,
                slug: slug,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.AutoSDKShared3123f815641fd36d>> GetSharedEnvVarAsResponseAsync(
            string id,
            string? teamId = default,
            string? slug = default,
            global::Vercel.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetSharedEnvVarArguments(
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetSharedEnvVarSecurityRequirements,
                operationName: "GetSharedEnvVarAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetSharedEnvVarAsync",
                                pathTemplate: "$\"/v1/env/{id}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetSharedEnvVarResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetSharedEnvVarResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vercel.AutoSDKShared3123f815641fd36d.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vercel.AutoSDKHttpResponse<global::Vercel.AutoSDKShared3123f815641fd36d>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vercel.AutoSDKShared3123f815641fd36d.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
