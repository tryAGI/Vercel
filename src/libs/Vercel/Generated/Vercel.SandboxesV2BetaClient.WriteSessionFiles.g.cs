...
namespace Vercel
{
    public partial class SandboxesV2BetaClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_WriteSessionFilesSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_WriteSessionFilesSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_WriteSessionFilesSecurityRequirement0,
            };
        ...
        partial void PrepareWriteSessionFilesRequest(
            ...
            string? teamId,
            string? slug);
        partial void ProcessWriteSessionFilesResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessWriteSessionFilesResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_WriteSessionFilesSecurityRequirements,
                operationName: "WriteSessionFilesAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "WriteSessionFilesAsync",
                                pathTemplate: "$\"/v2/sandboxes/sessions/{sessionId}/fs/write\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessWriteSessionFilesResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessWriteSessionFilesResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
