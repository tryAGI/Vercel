...
namespace Vercel
{
    ...
    /// Example: node24
    /// </summary>
    public enum CreateSandboxRequestRuntime
    {
        /// <summary>
        /// 
        /// </summary>
    ...
    /// </summary>
    public static class CreateSandboxRequestRuntimeExtensions
    {
        /// <summary>
        /// Converts an enum to a string.
        /// </summary>
        public static string ToValueString(this CreateSandboxRequestRuntime value)
        {
            return value switch
            {
        ...
        /// </summary>
        public static CreateSandboxRequestRuntime? ToEnum(string value)
        {
            return value switch
            {
