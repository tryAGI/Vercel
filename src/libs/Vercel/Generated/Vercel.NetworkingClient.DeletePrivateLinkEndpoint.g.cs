...
namespace Vercel
{
    public partial class NetworkingClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_DeletePrivateLinkEndpointSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_DeletePrivateLinkEndpointSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_DeletePrivateLinkEndpointSecurityRequirement0,
            };
        partial void PrepareDeletePrivateLinkEndpointArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string projectId,
            ref string endpointId,
            ref string? teamId,
            ref string? slug);
        partial void PrepareDeletePrivateLinkEndpointRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? teamId,
            string? slug);
        partial void ProcessDeletePrivateLinkEndpointResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessDeletePrivateLinkEndpointResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Delete a PrivateLink endpoint<br/>
        ...
        public async global::System.Threading.Tasks.Task<string> DeletePrivateLinkEndpointAsync(
            string projectId,
            string endpointId,
        ...
        {
            var __response = await DeletePrivateLinkEndpointAsResponseAsync(
                projectId: projectId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<string>> DeletePrivateLinkEndpointAsResponseAsync(
            string projectId,
            string endpointId,
            string? teamId = default,
            string? slug = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareDeletePrivateLinkEndpointArguments(
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_DeletePrivateLinkEndpointSecurityRequirements,
                operationName: "DeletePrivateLinkEndpointAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareDeletePrivateLinkEndpointRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "DeletePrivateLinkEndpointAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessDeletePrivateLinkEndpointResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessDeletePrivateLinkEndpointResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
