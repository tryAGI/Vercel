...
namespace Vercel
{
    ...
    public sealed partial class UpdateSessionNetworkPolicyRequestVariant2AllowItemMatchHeaderKey
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateSessionNetworkPolicyRequestVariant2AllowItemMatchHeaderKey" /> class.
        /// </summary>
        /// <param name="exact">
        /// Match the value exactly. Case-sensitive for paths, header values, and methods; case-insensitive for domains and header keys.
        /// </param>
...
#endif
        public UpdateSessionNetworkPolicyRequestVariant2AllowItemMatchHeaderKey(
            string? exact,
            string? startsWith)
        {
            this.Exact = exact;
