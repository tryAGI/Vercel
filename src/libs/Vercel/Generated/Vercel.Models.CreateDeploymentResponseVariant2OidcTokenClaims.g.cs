...
namespace Vercel
{
    ...
    public sealed partial class CreateDeploymentResponseVariant2OidcTokenClaims
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateDeploymentResponseVariant2OidcTokenClaims" /> class.
        /// </summary>
...
#endif
        public CreateDeploymentResponseVariant2OidcTokenClaims(
            string iss,
            string sub,
            string scope,
            string aud,
