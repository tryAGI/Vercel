...
namespace Vercel
{
    ...
    public sealed partial class GetMicrofrontendsInGroupResponseProjectGitComments
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetMicrofrontendsInGroupResponseProjectGitComments" /> class.
        /// </summary>
...
#endif
        public GetMicrofrontendsInGroupResponseProjectGitComments(
            bool onPullRequest,
            bool onCommit)
        {
