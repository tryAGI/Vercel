...
namespace Vercel
{
    ...
    public static class CreateProjectRequestFrameworkExtensions
    {
        ...
        public static string ToValueString(this CreateProjectRequestFramework value)
        {
            return value switch
            {
                CreateProjectRequestFramework.ActixWeb => "actix-web",
                CreateProjectRequestFramework.Angular => "angular",
                CreateProjectRequestFramework.Ash => "ash",
                CreateProjectRequestFramework.Astro => "astro",
                CreateProjectRequestFramework.Axum => "axum",
                CreateProjectRequestFramework.Blitzjs => "blitzjs",
                CreateProjectRequestFramework.Brunch => "brunch",
                CreateProjectRequestFramework.Bun => "bun",
                CreateProjectRequestFramework.Container => "container",
                ...
                CreateProjectRequestFramework.Eve => "eve",
                CreateProjectRequestFramework.Express => "express",
                CreateProjectRequestFramework.FactoryEve => "factory-eve",
                ...
                CreateProjectRequestFramework.Mastra => "mastra",
                ...
                CreateProjectRequestFramework.SanityV2 => "sanity-v2",
                ...
                CreateProjectRequestFramework.TanstackStartLovable => "tanstack-start-lovable",
        ...
        public static CreateProjectRequestFramework? ToEnum(string value)
        {
            return value switch
            {
                "actix-web" => CreateProjectRequestFramework.ActixWeb,
                "angular" => CreateProjectRequestFramework.Angular,
                "ash" => CreateProjectRequestFramework.Ash,
                "astro" => CreateProjectRequestFramework.Astro,
                "axum" => CreateProjectRequestFramework.Axum,
                "blitzjs" => CreateProjectRequestFramework.Blitzjs,
                "brunch" => CreateProjectRequestFramework.Brunch,
                "bun" => CreateProjectRequestFramework.Bun,
                "container" => CreateProjectRequestFramework.Container,
                ...
                "eve" => CreateProjectRequestFramework.Eve,
                "express" => CreateProjectRequestFramework.Express,
                "factory-eve" => CreateProjectRequestFramework.FactoryEve,
                ...
                "mastra" => CreateProjectRequestFramework.Mastra,
                ...
                "sanity-v2" => CreateProjectRequestFramework.SanityV2,
                ...
                "tanstack-start-lovable" => CreateProjectRequestFramework.TanstackStartLovable,
