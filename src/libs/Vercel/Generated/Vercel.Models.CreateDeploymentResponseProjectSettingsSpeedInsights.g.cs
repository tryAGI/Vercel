...
namespace Vercel
{
    ...
    public sealed partial class CreateDeploymentResponseProjectSettingsSpeedInsights
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateDeploymentResponseProjectSettingsSpeedInsights" /> class.
        /// </summary>
        /// <param name="id"></param>
...
#endif
        public CreateDeploymentResponseProjectSettingsSpeedInsights(
            string id,
            double? enabledAt,
            double? disabledAt,
            double? canceledAt,
