...
namespace Vercel
{
    ...
    public sealed partial class CreateSandboxesSessionsBySessionIdNetworkPolicyRequestVariant1InjectionRuleMatchPath
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateSandboxesSessionsBySessionIdNetworkPolicyRequestVariant1InjectionRuleMatchPath" /> class.
        /// </summary>
        /// <param name="exact">
        /// Match the value exactly. Case-sensitive for paths, header values, and methods; case-insensitive for domains and header keys.
        /// </param>
...
#endif
        public CreateSandboxesSessionsBySessionIdNetworkPolicyRequestVariant1InjectionRuleMatchPath(
            string? exact,
            string? startsWith)
        {
            this.Exact = exact;
