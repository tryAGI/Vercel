...
namespace Vercel
{
    ...
    public sealed partial class GetDeploymentsResponseDeploymentAttributionVercelUser
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetDeploymentsResponseDeploymentAttributionVercelUser" /> class.
        /// </summary>
        /// <param name="id">
        /// Vercel user ID
        /// </param>
...
#endif
        public GetDeploymentsResponseDeploymentAttributionVercelUser(
            string id,
            string username,
