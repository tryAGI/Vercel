...
namespace Vercel
{
    public partial class DomainsClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_GetDomainProjectDomainsSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_GetDomainProjectDomainsSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_GetDomainProjectDomainsSecurityRequirement0,
            };
        partial void PrepareGetDomainProjectDomainsArguments(
            ...
            ref string? teamId,
            ref string? slug);
        partial void PrepareGetDomainProjectDomainsRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? teamId,
            string? slug);
        partial void ProcessGetDomainProjectDomainsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetDomainProjectDomainsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.GetDomainProjectDomainsResponse> GetDomainProjectDomainsAsync(
            string domain,
        ...
        {
            var __response = await GetDomainProjectDomainsAsResponseAsync(
                domain: domain,
                limit: limit,
                since: since,
                until: until,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.GetDomainProjectDomainsResponse>> GetDomainProjectDomainsAsResponseAsync(
            string domain,
            double? limit = default,
            double? since = default,
            double? until = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetDomainProjectDomainsArguments(
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetDomainProjectDomainsSecurityRequirements,
                operationName: "GetDomainProjectDomainsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetDomainProjectDomainsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetDomainProjectDomainsAsync",
                                pathTemplate: "$\"/v1/domains/{domain}/project-domains\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetDomainProjectDomainsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetDomainProjectDomainsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vercel.GetDomainProjectDomainsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vercel.AutoSDKHttpResponse<global::Vercel.GetDomainProjectDomainsResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vercel.GetDomainProjectDomainsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
