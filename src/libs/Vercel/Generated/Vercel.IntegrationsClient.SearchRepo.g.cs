...
namespace Vercel
{
    public partial class IntegrationsClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_SearchRepoSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_SearchRepoSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_SearchRepoSecurityRequirement0,
            };
        partial void PrepareSearchRepoArguments(
            ...
            ref string? teamId,
            ref string? slug);
        partial void PrepareSearchRepoRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? teamId,
            string? slug);
        partial void ProcessSearchRepoResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessSearchRepoResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.OneOf<object, global::Vercel.SearchRepoResponseVariant2>> SearchRepoAsync(
        ...
        {
            var __response = await SearchRepoAsResponseAsync(
                query: query,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.OneOf<object, global::Vercel.SearchRepoResponseVariant2>>> SearchRepoAsResponseAsync(
            string? query = default,
            global::Vercel.OneOf<string, double?>? namespaceId = default,
            global::Vercel.SearchRepoProvider? provider = default,
            string? installationId = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_SearchRepoSecurityRequirements,
                operationName: "SearchRepoAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            __pathBuilder
                                ...
                                .AddOptionalParameter("namespaceId", namespaceId?.ToString())
                                .AddOptionalParameter("provider", provider?.ToValueString())
                                .AddOptionalParameter("installationId", installationId)
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "SearchRepoAsync",
                                pathTemplate: "\"/v1/integrations/search-repo\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessSearchRepoResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vercel.OneOf<object, global::Vercel.SearchRepoResponseVariant2>.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vercel.AutoSDKHttpResponse<global::Vercel.OneOf<object, global::Vercel.SearchRepoResponseVariant2>>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vercel.OneOf<object, global::Vercel.SearchRepoResponseVariant2>.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
