...
namespace Vercel
{
    public partial class KmsClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_CreateKmsSigningKeySecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_CreateKmsSigningKeySecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_CreateKmsSigningKeySecurityRequirement0,
            };
        partial void PrepareCreateKmsSigningKeyArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string issuerId,
            ref string? teamId,
            ref string? slug,
            global::Vercel.CreateKmsSigningKeyRequest request);
        partial void PrepareCreateKmsSigningKeyRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? slug,
            global::Vercel.CreateKmsSigningKeyRequest request);
        partial void ProcessCreateKmsSigningKeyResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateKmsSigningKeyResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.CreateKmsSigningKeyResponse> CreateKmsSigningKeyAsync(
            string issuerId,
        ...
        {
            var __response = await CreateKmsSigningKeyAsResponseAsync(
                issuerId: issuerId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.CreateKmsSigningKeyResponse>> CreateKmsSigningKeyAsResponseAsync(
            string issuerId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateKmsSigningKeyArguments(
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateKmsSigningKeySecurityRequirements,
                operationName: "CreateKmsSigningKeyAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Vercel.PathBuilder(
                                path: $"/v1/kms/issuers/{issuerId}/keys",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateKmsSigningKeyRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "CreateKmsSigningKeyAsync",
                                pathTemplate: "$\"/v1/kms/issuers/{issuerId}/keys\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateKmsSigningKeyResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateKmsSigningKeyResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vercel.CreateKmsSigningKeyResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vercel.AutoSDKHttpResponse<global::Vercel.CreateKmsSigningKeyResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vercel.CreateKmsSigningKeyResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.CreateKmsSigningKeyResponse> CreateKmsSigningKeyAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Vercel.CreateKmsSigningKeyRequest
            {
            ...
            return await CreateKmsSigningKeyAsync(
                issuerId: issuerId,
                teamId: teamId,
                slug: slug,
                request: __request,
