...
namespace Vercel
{
    ...
    public sealed partial class CreateProjectResponseGitProviderOptionsConsolidatedGitCommitStatus
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateProjectResponseGitProviderOptionsConsolidatedGitCommitStatus" /> class.
        /// </summary>
        /// <param name="enabled">
        /// Whether consolidated commit status is enabled.
        /// </param>
...
#endif
        public CreateProjectResponseGitProviderOptionsConsolidatedGitCommitStatus(
            bool enabled,
