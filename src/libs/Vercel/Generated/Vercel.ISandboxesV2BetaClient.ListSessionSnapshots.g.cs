...
namespace Vercel
{
    public partial interface ISandboxesV2BetaClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.OneOf<object, global::Vercel.ListSessionSnapshotsResponseVariant2>>> ListSessionSnapshotsAsResponseAsync(
            string? project = default,
            string? name = default,
            double? limit = default,
            string? cursor = default,
