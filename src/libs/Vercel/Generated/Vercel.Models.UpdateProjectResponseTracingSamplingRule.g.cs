...
namespace Vercel
{
    ...
    public sealed partial class UpdateProjectResponseTracingSamplingRule
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Vercel.JsonConverters.UpdateProjectResponseTracingSamplingRuleDestinationJsonConverter))]
        public global::Vercel.UpdateProjectResponseTracingSamplingRuleDestination? Destination { get; set; }
        ...
        public UpdateProjectResponseTracingSamplingRule(
            ...
            string? requestPath,
            global::Vercel.UpdateProjectResponseTracingSamplingRuleDestination? destination)
        {
            this.Rate = rate;
            this.Env = env;
