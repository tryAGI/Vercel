...
namespace Vercel
{
    public partial class AliasesClient
    {
        ...
        partial void PrepareListAliasesArguments(
            ...
            ref double? since,
            ref double? until,
            ref string? rollbackDeploymentId,
            ref string? teamId,
            ref string? slug);
        partial void PrepareListAliasesRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Vercel.OneOf<global::System.Collections.Generic.IList<string>, string>? domain,
            double? from,
            double? limit,
            string? projectId,
            double? since,
            ...
            string? teamId,
            string? slug);
        partial void ProcessListAliasesResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessListAliasesResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.ListAliasesResponse> ListAliasesAsync(
        ...
        {
            var __response = await ListAliasesAsResponseAsync(
                domain: domain,
                from: from,
                limit: limit,
                projectId: projectId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.ListAliasesResponse>> ListAliasesAsResponseAsync(
            global::Vercel.OneOf<global::System.Collections.Generic.IList<string>, string>? domain = default,
            double? from = default,
            double? limit = default,
            string? projectId = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareListAliasesArguments(
                ...
                since: ref since,
                until: ref until,
                rollbackDeploymentId: ref rollbackDeploymentId,
                teamId: ref teamId,
                slug: ref slug);
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "ListAliasesAsync",
                                pathTemplate: "\"/v4/aliases\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListAliasesResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vercel.ListAliasesResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vercel.AutoSDKHttpResponse<global::Vercel.ListAliasesResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vercel.ListAliasesResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
