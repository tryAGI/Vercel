...
namespace Vercel
{
    public partial class ConnectClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_GetConnectorProjectConnectionSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_GetConnectorProjectConnectionSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_GetConnectorProjectConnectionSecurityRequirement0,
            };
        partial void PrepareGetConnectorProjectConnectionArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string connector,
            ref string projectId,
            ref string? teamId,
            ref string? slug);
        partial void PrepareGetConnectorProjectConnectionRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? teamId,
            string? slug);
        partial void ProcessGetConnectorProjectConnectionResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetConnectorProjectConnectionResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.ConnectProjectConnection> GetConnectorProjectConnectionAsync(
            string connector,
            string projectId,
        ...
        {
            var __response = await GetConnectorProjectConnectionAsResponseAsync(
                connector: connector,
                projectId: projectId,
                teamId: teamId,
                slug: slug,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.ConnectProjectConnection>> GetConnectorProjectConnectionAsResponseAsync(
            string connector,
            string projectId,
            string? teamId = default,
            string? slug = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetConnectorProjectConnectionArguments(
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetConnectorProjectConnectionSecurityRequirements,
                operationName: "GetConnectorProjectConnectionAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetConnectorProjectConnectionRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetConnectorProjectConnectionAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetConnectorProjectConnectionResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetConnectorProjectConnectionResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
