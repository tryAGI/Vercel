...
namespace Vercel
{
    ...
    public sealed partial class GetProjectsResponseVariant3ProjectAbuseHistoryItem
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetProjectsResponseVariant3ProjectAbuseHistoryItem" /> class.
        /// </summary>
...
#endif
        public GetProjectsResponseVariant3ProjectAbuseHistoryItem(
            string scanner,
            string reason,
            string by,
            string byId,
