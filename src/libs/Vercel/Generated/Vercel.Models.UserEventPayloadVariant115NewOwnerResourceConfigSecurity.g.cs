...
namespace Vercel
{
    ...
    public sealed partial class UserEventPayloadVariant115NewOwnerResourceConfigSecurity
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UserEventPayloadVariant115NewOwnerResourceConfigSecurity" /> class.
        /// </summary>
...
#endif
        public UserEventPayloadVariant115NewOwnerResourceConfigSecurity(
            double? customRules,
            double? ipBlocks,
            double? ipBypass,
            double? rateLimit)
