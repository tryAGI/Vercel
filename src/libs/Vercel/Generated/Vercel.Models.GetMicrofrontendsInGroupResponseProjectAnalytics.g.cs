...
namespace Vercel
{
    ...
    public sealed partial class GetMicrofrontendsInGroupResponseProjectAnalytics
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetMicrofrontendsInGroupResponseProjectAnalytics" /> class.
        /// </summary>
        /// <param name="id"></param>
...
#endif
        public GetMicrofrontendsInGroupResponseProjectAnalytics(
            string id,
            double disabledAt,
            double enabledAt,
            double? canceledAt,
