...
namespace Vercel
{
    ...
    public sealed partial class GetDeploymentsResponseDeploymentProjectSettingsWebAnalytics
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetDeploymentsResponseDeploymentProjectSettingsWebAnalytics" /> class.
        /// </summary>
        /// <param name="id"></param>
...
#endif
        public GetDeploymentsResponseDeploymentProjectSettingsWebAnalytics(
            string id,
            double? disabledAt,
            double? canceledAt,
            double? enabledAt,
