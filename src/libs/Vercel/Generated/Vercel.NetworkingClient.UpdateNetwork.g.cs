...
namespace Vercel
{
    public partial class NetworkingClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_UpdateNetworkSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_UpdateNetworkSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_UpdateNetworkSecurityRequirement0,
            };
        partial void PrepareUpdateNetworkArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string networkId,
            ref string? teamId,
            ref string? slug,
            global::Vercel.UpdateNetworkRequest request);
        partial void PrepareUpdateNetworkRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? slug,
            global::Vercel.UpdateNetworkRequest request);
        partial void ProcessUpdateNetworkResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUpdateNetworkResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.Network> UpdateNetworkAsync(
            string networkId,
        ...
        {
            var __response = await UpdateNetworkAsResponseAsync(
                networkId: networkId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<global::Vercel.Network>> UpdateNetworkAsResponseAsync(
            string networkId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UpdateNetworkSecurityRequirements,
                operationName: "UpdateNetworkAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "UpdateNetworkAsync",
                                pathTemplate: "$\"/v1/connect/networks/{networkId}\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUpdateNetworkResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vercel.Network> UpdateNetworkAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Vercel.UpdateNetworkRequest
            {
                Name = name,
            };

            return await UpdateNetworkAsync(
                networkId: networkId,
                teamId: teamId,
                slug: slug,
                request: __request,
