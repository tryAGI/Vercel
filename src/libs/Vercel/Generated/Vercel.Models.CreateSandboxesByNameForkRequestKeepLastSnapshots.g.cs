...
namespace Vercel
{
    ...
    public sealed partial class CreateSandboxesByNameForkRequestKeepLastSnapshots
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateSandboxesByNameForkRequestKeepLastSnapshots" /> class.
        /// </summary>
        /// <param name="count">
        /// Number of most recent snapshots to keep.
        /// </param>
...
#endif
        public CreateSandboxesByNameForkRequestKeepLastSnapshots(
            int count,
