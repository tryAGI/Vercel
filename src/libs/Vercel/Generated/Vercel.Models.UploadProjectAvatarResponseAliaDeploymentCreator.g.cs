...
namespace Vercel
{
    ...
    public sealed partial class UploadProjectAvatarResponseAliaDeploymentCreator
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UploadProjectAvatarResponseAliaDeploymentCreator" /> class.
        /// </summary>
...
#endif
        public UploadProjectAvatarResponseAliaDeploymentCreator(
            string email,
            string uid,
            string username,
            string? githubLogin,
