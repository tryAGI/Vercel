...
namespace Vercel
{
    ...
    public static class CreateDeploymentResponseProjectSettingsFrameworkExtensions
    {
        ...
        public static string ToValueString(this CreateDeploymentResponseProjectSettingsFramework value)
        {
            return value switch
            {
                CreateDeploymentResponseProjectSettingsFramework.ActixWeb => "actix-web",
                CreateDeploymentResponseProjectSettingsFramework.Angular => "angular",
                CreateDeploymentResponseProjectSettingsFramework.Ash => "ash",
                ...
                CreateDeploymentResponseProjectSettingsFramework.Container => "container",
                ...
                CreateDeploymentResponseProjectSettingsFramework.Mastra => "mastra",
                ...
                CreateDeploymentResponseProjectSettingsFramework.TanstackStartLovable => "tanstack-start-lovable",
        ...
        public static CreateDeploymentResponseProjectSettingsFramework? ToEnum(string value)
        {
            return value switch
            {
                "actix-web" => CreateDeploymentResponseProjectSettingsFramework.ActixWeb,
                "angular" => CreateDeploymentResponseProjectSettingsFramework.Angular,
                "ash" => CreateDeploymentResponseProjectSettingsFramework.Ash,
                ...
                "container" => CreateDeploymentResponseProjectSettingsFramework.Container,
                ...
                "mastra" => CreateDeploymentResponseProjectSettingsFramework.Mastra,
                ...
                "tanstack-start-lovable" => CreateDeploymentResponseProjectSettingsFramework.TanstackStartLovable,
