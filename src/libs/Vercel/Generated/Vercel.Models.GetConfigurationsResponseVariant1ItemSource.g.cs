    ...
    public static class GetConfigurationsResponseVariant1ItemSourceExtensions
    {
        ...
        public static string ToValueString(this GetConfigurationsResponseVariant1ItemSource value)
        {
            return value switch
            {
                ...
                GetConfigurationsResponseVariant1ItemSource.ImportRecommendedIntegrations => "import-recommended-integrations",
                ...
                GetConfigurationsResponseVariant1ItemSource.Organization => "organization",
        ...
        public static GetConfigurationsResponseVariant1ItemSource? ToEnum(string value)
        {
            return value switch
            {
                ...
                "import-recommended-integrations" => GetConfigurationsResponseVariant1ItemSource.ImportRecommendedIntegrations,
                ...
                "organization" => GetConfigurationsResponseVariant1ItemSource.Organization,
