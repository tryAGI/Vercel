...
namespace Vercel
{
    public partial class ProjectsClient
    {
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement s_RemoveProjectDomainSecurityRequirement0 =
        ...
        private static readonly global::Vercel.EndPointSecurityRequirement[] s_RemoveProjectDomainSecurityRequirements =
            new global::Vercel.EndPointSecurityRequirement[]
            {                s_RemoveProjectDomainSecurityRequirement0,
            };
        partial void PrepareRemoveProjectDomainArguments(
        ...
        partial void PrepareRemoveProjectDomainRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? slug,
            global::Vercel.RemoveProjectDomainRequest request);
        partial void ProcessRemoveProjectDomainResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessRemoveProjectDomainResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> RemoveProjectDomainAsync(
            string idOrName,
            string domain,
        ...
        {
            var __response = await RemoveProjectDomainAsResponseAsync(
                idOrName: idOrName,
                domain: domain,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vercel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vercel.AutoSDKHttpResponse<string>> RemoveProjectDomainAsResponseAsync(
            string idOrName,
            string domain,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareRemoveProjectDomainArguments(
            ...
            var __authorizations = global::Vercel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_RemoveProjectDomainSecurityRequirements,
                operationName: "RemoveProjectDomainAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareRemoveProjectDomainRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vercel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "RemoveProjectDomainAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessRemoveProjectDomainResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vercel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessRemoveProjectDomainResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<string> RemoveProjectDomainAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Vercel.RemoveProjectDomainRequest
            {
                RemoveRedirects = removeRedirects,
            };

            return await RemoveProjectDomainAsync(
                idOrName: idOrName,
                domain: domain,
                teamId: teamId,
                slug: slug,
