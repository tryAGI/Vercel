...
namespace Vercel
{
    ...
    public static class UpdateProjectRequestFrameworkExtensions
    {
        ...
        public static string ToValueString(this UpdateProjectRequestFramework value)
        {
            return value switch
            {
                UpdateProjectRequestFramework.ActixWeb => "actix-web",
                UpdateProjectRequestFramework.Angular => "angular",
                UpdateProjectRequestFramework.Ash => "ash",
                ...
                UpdateProjectRequestFramework.Container => "container",
                ...
                UpdateProjectRequestFramework.FactoryEve => "factory-eve",
                ...
                UpdateProjectRequestFramework.TanstackStartLovable => "tanstack-start-lovable",
        ...
        public static UpdateProjectRequestFramework? ToEnum(string value)
        {
            return value switch
            {
                "actix-web" => UpdateProjectRequestFramework.ActixWeb,
                "angular" => UpdateProjectRequestFramework.Angular,
                "ash" => UpdateProjectRequestFramework.Ash,
                ...
                "container" => UpdateProjectRequestFramework.Container,
                ...
                "factory-eve" => UpdateProjectRequestFramework.FactoryEve,
                ...
                "tanstack-start-lovable" => UpdateProjectRequestFramework.TanstackStartLovable,
