...
namespace Vercel
{
    ...
    public sealed partial class CreateSandboxesByNameForkV3RequestKeepLastSnapshots
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateSandboxesByNameForkV3RequestKeepLastSnapshots" /> class.
        /// </summary>
        /// <param name="count">
        /// Number of most recent snapshots to keep.
        /// </param>
...
#endif
        public CreateSandboxesByNameForkV3RequestKeepLastSnapshots(
            int count,
