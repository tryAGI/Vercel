    ...
    public static class RequestAccessToTeamResponseJoinedFromOriginExtensions
    {
        ...
        public static string ToValueString(this RequestAccessToTeamResponseJoinedFromOrigin value)
        {
            return value switch
            {
                ...
                RequestAccessToTeamResponseJoinedFromOrigin.NsnbRedeployAttributionCard => "nsnb-redeploy-attribution-card",
        ...
        public static RequestAccessToTeamResponseJoinedFromOrigin? ToEnum(string value)
        {
            return value switch
            {
                ...
                "nsnb-redeploy-attribution-card" => RequestAccessToTeamResponseJoinedFromOrigin.NsnbRedeployAttributionCard,
